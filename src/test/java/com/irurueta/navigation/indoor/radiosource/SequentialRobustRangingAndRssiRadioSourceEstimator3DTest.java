...
class SequentialRobustRangingAndRssiRadioSourceEstimator3DTest implements
    ...
    void testConstructor() throws LockedException {
        ...
        var estimator = new SequentialRobustRangingAndRssiRadioSourceEstimator3D<WifiAccessPoint>();
        ...
        assertThrows(IllegalArgumentException.class, () -> new SequentialRobustRangingAndRssiRadioSourceEstimator3D<>(
        ...
        estimator = new SequentialRobustRangingAndRssiRadioSourceEstimator3D<>(readings, initialPosition, this);
        ...
        estimator = new SequentialRobustRangingAndRssiRadioSourceEstimator3D<>(initialPosition, MAX_RSSI, this);
        ...
        estimator = new SequentialRobustRangingAndRssiRadioSourceEstimator3D<>(qualityScores, readings, initialPosition,
                this);
        ...
        estimator = new SequentialRobustRangingAndRssiRadioSourceEstimator3D<>(qualityScores, initialPosition, MAX_RSSI,
                this);
    ...
    void testGetSetProgressDelta() throws LockedException {
        final var estimator = new SequentialRobustRangingAndRssiRadioSourceEstimator3D<WifiAccessPoint>();
    ...
    void testEstimateNoInlierErrorNoRefinement() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new SequentialRobustRangingAndRssiRadioSourceEstimator3D<>(qualityScores, readings,
                    this);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
