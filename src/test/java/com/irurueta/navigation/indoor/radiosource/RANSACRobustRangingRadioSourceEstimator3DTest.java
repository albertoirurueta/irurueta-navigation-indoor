...
public class RANSACRobustRangingRadioSourceEstimator3DTest implements
    ...
    public void testConstructor() {
        ...
        // check default values
        assertEquals(RANSACRobustRangingRadioSourceEstimator3D.DEFAULT_THRESHOLD,
        ...
        estimator = null;
        try {
            estimator = new RANSACRobustRangingRadioSourceEstimator3D<>(null, initialPosition);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = null;
        try {
            estimator = new RANSACRobustRangingRadioSourceEstimator3D<>(null, initialPosition, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
    ...
    public void testEstimateNoInlierErrorNoRefinement() throws LockedException, NotReadyException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final RANSACRobustRangingRadioSourceEstimator3D<WifiAccessPoint> estimator =
                    new RANSACRobustRangingRadioSourceEstimator3D<>(readings, this);
    ...
    public void testEstimateNoInlierErrorWithInitialPositionAndRefinement() throws LockedException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final RANSACRobustRangingRadioSourceEstimator3D<WifiAccessPoint> estimator =
                    new RANSACRobustRangingRadioSourceEstimator3D<>(readings, accessPointPosition, this);
    ...
    public void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            assertEquals(TRANSMITTED_POWER_DBM,
    ...
    private void checkLocked(final RANSACRobustRangingRadioSourceEstimator3D<WifiAccessPoint> estimator) {
        try {
