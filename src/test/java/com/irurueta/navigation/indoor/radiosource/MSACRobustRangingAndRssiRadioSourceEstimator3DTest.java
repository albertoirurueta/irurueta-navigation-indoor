...
public class MSACRobustRangingAndRssiRadioSourceEstimator3DTest implements
    ...
    public void testConstructor() {
        ...
        estimator = null;
        try {
            estimator = new MSACRobustRangingAndRssiRadioSourceEstimator3D<>(
        ...
        estimator = null;
        try {
            estimator = new MSACRobustRangingAndRssiRadioSourceEstimator3D<>(null, initialPosition);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = null;
        try {
            estimator = new MSACRobustRangingAndRssiRadioSourceEstimator3D<>(null, initialPosition, MAX_RSSI);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
    ...
    public void testEstimateNoInlierErrorNoRefinement()
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final MSACRobustRangingAndRssiRadioSourceEstimator3D<WifiAccessPoint> estimator =
                    new MSACRobustRangingAndRssiRadioSourceEstimator3D<>(readings, this);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    public void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final MSACRobustRangingAndRssiRadioSourceEstimator3D<Beacon> estimator =
                    new MSACRobustRangingAndRssiRadioSourceEstimator3D<>(readings);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    private void checkLocked(final MSACRobustRangingAndRssiRadioSourceEstimator3D<WifiAccessPoint> estimator) {
        try {
