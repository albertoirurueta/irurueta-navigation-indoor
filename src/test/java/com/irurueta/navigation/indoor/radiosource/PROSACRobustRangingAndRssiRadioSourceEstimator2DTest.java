...
class PROSACRobustRangingAndRssiRadioSourceEstimator2DTest implements
    ...
    void testConstructor() {
        ...
        var estimator = new PROSACRobustRangingAndRssiRadioSourceEstimator2D<WifiAccessPoint>();
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustRangingAndRssiRadioSourceEstimator2D<>(
    ...
    void testEstimateNoInlierErrorNoRefinementNoInlierDataAndNoResiduals() throws LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new PROSACRobustRangingAndRssiRadioSourceEstimator2D<>(qualityScores, readings,
                    this);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    void testEstimateNoInlierErrorWithRefinementWithInlierDataAndWithResiduals() throws LockedException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            assertEquals(Math.sqrt(estimator.getEstimatedTransmittedPowerVariance()),
                    estimatedAccessPoint.getTransmittedPowerStandardDeviation(), 0.0);
            assertEquals(estimatedAccessPoint.getPositionCovariance(), estimator.getEstimatedPositionCovariance());
            assertNull(estimatedAccessPoint.getPathLossExponentStandardDeviation());
    ...
    void testEstimatePositionOnlyRepeated() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        var positionAccuracyConfidence = 0.0;
        for (var t = 0; t < TIMES; t++) {
            var pathLossExponent = randomizer.nextDouble(MIN_PATH_LOSS_EXPONENT, MAX_PATH_LOSS_EXPONENT);
    ...
    void testEstimateWithStandardDeviationsAndPositionCovariance() throws LockedException, NotReadyException,
        ...
        // force NotReadyException
        final var estimator = new MSACRobustRangingAndRssiRadioSourceEstimator2D<WifiAccessPoint>();
        assertThrows(NotReadyException.class, estimator::estimate);
    }
    ...
    private static void checkLocked(final PROSACRobustRangingAndRssiRadioSourceEstimator2D<WifiAccessPoint> estimator) {
