...
public class PROMedSRobustRangingRadioSourceEstimator2DTest implements
    ...
    public void testConstructor() {
        ...
        assertEquals(PROMedSRobustRangingRadioSourceEstimator2D.DEFAULT_STOP_THRESHOLD,
        ...
        try {
            estimator = new PROMedSRobustRangingRadioSourceEstimator2D<>(new double[1], readings);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
        ...
        try {
            estimator = new PROMedSRobustRangingRadioSourceEstimator2D<>(new double[1], readings, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
        ...
        estimator = null;
        try {
            estimator = new PROMedSRobustRangingRadioSourceEstimator2D<>(qualityScores, null, initialPosition);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        try {
            estimator = new PROMedSRobustRangingRadioSourceEstimator2D<>(new double[1], readings, initialPosition);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
    ...
    public void testEstimateNoInlierErrorNoRefinement() throws LockedException, NotReadyException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final PROMedSRobustRangingRadioSourceEstimator2D<WifiAccessPoint> estimator =
                    new PROMedSRobustRangingRadioSourceEstimator2D<>(qualityScores, readings, this);
    ...
    public void testEstimateNoInlierErrorWithInitialPositionAndRefinement() throws LockedException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final PROMedSRobustRangingRadioSourceEstimator2D<WifiAccessPoint> estimator =
                    new PROMedSRobustRangingRadioSourceEstimator2D<>(qualityScores, readings, accessPointPosition,
                            this);
    ...
    public void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final PROMedSRobustRangingRadioSourceEstimator2D<Beacon> estimator =
                    new PROMedSRobustRangingRadioSourceEstimator2D<>(qualityScores, readings);
    ...
    private void checkLocked(final PROMedSRobustRangingRadioSourceEstimator2D<WifiAccessPoint> estimator) {
        try {
