...
class RANSACRobustRangingAndRssiRadioSourceEstimator3DTest implements
    ...
    void testConstructor() {
        ...
        var estimator = new RANSACRobustRangingAndRssiRadioSourceEstimator3D<WifiAccessPoint>();
        ...
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustRangingAndRssiRadioSourceEstimator3D<>(
    ...
    void testGetSetThreshold() throws LockedException {
        final var estimator = new RANSACRobustRangingAndRssiRadioSourceEstimator3D<WifiAccessPoint>();
    ...
    void testEstimateNoInlierErrorNoRefinementNoInlierDataAndNoResiduals() throws LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new RANSACRobustRangingAndRssiRadioSourceEstimator3D<>(readings, this);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException, AlgebraException {
        ...
        for (var t = 0; t < 10 * TIMES; t++) {
            ...
            final var estimator = new RANSACRobustRangingAndRssiRadioSourceEstimator3D<>(readings);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    private static void checkLocked(final RANSACRobustRangingAndRssiRadioSourceEstimator3D<WifiAccessPoint> estimator) {
