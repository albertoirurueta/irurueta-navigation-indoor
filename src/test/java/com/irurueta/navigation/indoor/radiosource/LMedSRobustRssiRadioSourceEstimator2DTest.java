...
class LMedSRobustRssiRadioSourceEstimator2DTest implements
        RobustRssiRadioSourceEstimatorListener<WifiAccessPoint, Point2D> {

    private static final Logger LOGGER = Logger.getLogger(LMedSRobustRssiRadioSourceEstimator2DTest.class.getName());
    ...
    void testConstructor() {
        ...
        var estimator = new LMedSRobustRssiRadioSourceEstimator2D<WifiAccessPoint>();
        ...
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustRssiRadioSourceEstimator2D<>(
                (List<RssiReadingLocated2D<WifiAccessPoint>>) null));
        final var wrongReadings = new ArrayList<RssiReadingLocated2D<WifiAccessPoint>>();
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustRssiRadioSourceEstimator2D<>(wrongReadings));
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustRssiRadioSourceEstimator2D<>(null,
                initialPosition));
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustRssiRadioSourceEstimator2D<>(wrongReadings,
                initialPosition));
    ...
    void testGetSetStopThreshold() throws LockedException {
        final var estimator = new LMedSRobustRssiRadioSourceEstimator2D<WifiAccessPoint>();
    ...
    void testEstimateNoInlierErrorNoRefinement() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new LMedSRobustRssiRadioSourceEstimator2D<>(readings, this);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException, AlgebraException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new LMedSRobustRssiRadioSourceEstimator2D<>(readings);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    void testEstimatePositionOnlyWithInitialPosition() throws LockedException, NotReadyException,
        ...
        LOGGER.log(Level.INFO, "Percentage all valid: {0} %", (double) numValid / (double) TIMES * 100.0);
    ...
    void testEstimateLargerPreliminarySubsetSize() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new LMedSRobustRssiRadioSourceEstimator2D<WifiAccessPoint>(readings, this);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    private static void checkLocked(final LMedSRobustRssiRadioSourceEstimator2D<WifiAccessPoint> estimator) {
