...
class RobustRssiRadioSourceEstimator2DTest implements RobustRssiRadioSourceEstimatorListener<WifiAccessPoint, Point2D> {
    ...
    void testCreate() {
        ...
        // RANSAC
        var estimator = RobustRssiRadioSourceEstimator2D.<WifiAccessPoint>create(RobustEstimatorMethod.RANSAC);

        // check
        assertInstanceOf(RANSACRobustRssiRadioSourceEstimator2D.class, estimator);

        // LMedS
        estimator = RobustRssiRadioSourceEstimator2D.create(RobustEstimatorMethod.LMEDS);

        // check
        assertInstanceOf(LMedSRobustRssiRadioSourceEstimator2D.class, estimator);

        // MSAC
        estimator = RobustRssiRadioSourceEstimator2D.create(RobustEstimatorMethod.MSAC);

        // check
        assertInstanceOf(MSACRobustRssiRadioSourceEstimator2D.class, estimator);

        // PROSAC
        estimator = RobustRssiRadioSourceEstimator2D.create(RobustEstimatorMethod.PROSAC);

        // check
        assertInstanceOf(PROSACRobustRssiRadioSourceEstimator2D.class, estimator);

        // PROMedS
        estimator = RobustRssiRadioSourceEstimator2D.create(RobustEstimatorMethod.PROMEDS);

        // check
        assertInstanceOf(PROMedSRobustRssiRadioSourceEstimator2D.class, estimator);
        ...
        // LMedS
        estimator = RobustRssiRadioSourceEstimator2D.create(initialPosition, this, RobustEstimatorMethod.LMEDS);
        ...
        // MSAC
        estimator = RobustRssiRadioSourceEstimator2D.create(initialPosition, this, RobustEstimatorMethod.MSAC);
        ...
        // RANSAC
        estimator = RobustRssiRadioSourceEstimator2D.create(readings, initialPosition, MAX_RSSI, MIN_PATH_LOSS_EXPONENT,
                RobustEstimatorMethod.RANSAC);
        ...
        // LMedS
        estimator = RobustRssiRadioSourceEstimator2D.create(qualityScores, readings, RobustEstimatorMethod.LMEDS);
        ...
        // LMedS
        estimator = RobustRssiRadioSourceEstimator2D.create(qualityScores, this, RobustEstimatorMethod.LMEDS);
        ...
        // MSAC
        estimator = RobustRssiRadioSourceEstimator2D.create(qualityScores, this, RobustEstimatorMethod.MSAC);
        ...
        // PROSAC
        estimator = RobustRssiRadioSourceEstimator2D.create(qualityScores, this, RobustEstimatorMethod.PROSAC);
        ...
        // PROMedS
        estimator = RobustRssiRadioSourceEstimator2D.create(qualityScores, this, RobustEstimatorMethod.PROMEDS);
        ...
        // MSAC
        estimator = RobustRssiRadioSourceEstimator2D.create(qualityScores, initialPosition, RobustEstimatorMethod.MSAC);
