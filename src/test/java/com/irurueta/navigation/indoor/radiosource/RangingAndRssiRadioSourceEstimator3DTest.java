...
public class RangingAndRssiRadioSourceEstimator3DTest implements
    ...
    public void testConstructor() {
        ...
        estimator = new RangingAndRssiRadioSourceEstimator3D<>(readings, this);
        ...
        estimator = new RangingAndRssiRadioSourceEstimator3D<>(readings, initialPosition);
        ...
        estimator = new RangingAndRssiRadioSourceEstimator3D<>(readings, initialPosition, this);
        ...
        estimator = new RangingAndRssiRadioSourceEstimator3D<>(readings, MAX_RSSI);
        ...
        estimator = new RangingAndRssiRadioSourceEstimator3D<>(readings, MAX_RSSI, this);
        ...
        estimator = new RangingAndRssiRadioSourceEstimator3D<>(readings, initialPosition, MAX_RSSI);
        ...
        // listener
        estimator = new RangingAndRssiRadioSourceEstimator3D<>(initialPosition, MAX_RSSI, this);
        ...
        estimator = new RangingAndRssiRadioSourceEstimator3D<>(readings, initialPosition, MAX_RSSI, this);
    ...
    @Override
    public void onEstimateStart(final RangingAndRssiRadioSourceEstimator<WifiAccessPoint, Point3D> estimator) {
        estimateStart++;
        checkLocked(estimator);
    }

    @Override
    public void onEstimateEnd(final RangingAndRssiRadioSourceEstimator<WifiAccessPoint, Point3D> estimator) {
        estimateEnd++;
        checkLocked(estimator);
    }
