...
class PROMedSRobustRangingAndRssiRadioSourceEstimator3DTest implements
    ...
    void testConstructor() {
        ...
        var estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator3D<WifiAccessPoint>();
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustRangingAndRssiRadioSourceEstimator3D<>(
        ...
        estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator3D<>(qualityScores, readings);
    ...
    void testGetSetStopThreshold() throws LockedException {
        final var estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator3D<WifiAccessPoint>();
    ...
    void testAreValidReadings() throws LockedException {
        ...
        final var readings = new ArrayList<RangingAndRssiReadingLocated3D<WifiAccessPoint>>();
        var accessPoint = new WifiAccessPoint("bssid", FREQUENCY);
        for (var i = 0; i < 5; i++) {
            final var position = new InhomogeneousPoint3D(
                    randomizer.nextDouble(MIN_POS, MAX_POS),
                    randomizer.nextDouble(MIN_POS, MAX_POS),
    ...
    void testEstimateNoInlierErrorNoRefinement() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator3D<>(qualityScores, readings,
                    this);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    void testEstimateWithInlierErrorWithInitialPositionAndPower() throws LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator3D<WifiAccessPoint>(qualityScores,
                    readings, this);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException, AlgebraException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            assertEquals(estimatedBeacon.getTransmittedPower(), estimator.getEstimatedTransmittedPowerdBm(), 0.0);
    ...
    void testEstimatePositionOnly() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        // force NotReadyException
        final var estimator = new PROMedSRobustRssiRadioSourceEstimator3D<WifiAccessPoint>();
        assertThrows(NotReadyException.class, estimator::estimate);
    }
