...
public class LMedSRobustRangingAndRssiRadioSourceEstimator2DTest implements
        RobustRangingAndRssiRadioSourceEstimatorListener<WifiAccessPoint, Point2D> {

    private static final Logger LOGGER = Logger.getLogger(
            LMedSRobustRangingAndRssiRadioSourceEstimator2DTest.class.getName());
    ...
    public void testConstructor() {
        ...
        LMedSRobustRangingAndRssiRadioSourceEstimator2D<WifiAccessPoint> estimator =
                new LMedSRobustRangingAndRssiRadioSourceEstimator2D<>();

        // check
        assertEquals(LMedSRobustRangingAndRssiRadioSourceEstimator2D.DEFAULT_STOP_THRESHOLD,
        ...
        estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator2D<>(readings);
        ...
        estimator = null;
        try {
            estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator2D<>(
        ...
        estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator2D<>(this);
        ...
        estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator2D<>(readings, this);
        ...
        final InhomogeneousPoint2D initialPosition = new InhomogeneousPoint2D(
                randomizer.nextDouble(MIN_POS, MAX_POS),
                randomizer.nextDouble(MIN_POS, MAX_POS));
        estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator2D<>(readings, initialPosition);
        ...
        estimator = null;
        try {
            estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator2D<>(null, initialPosition);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator2D<>(initialPosition);
        ...
        estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator2D<>(initialPosition, this);
        ...
        estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator2D<>(readings, initialPosition, this);
        ...
        estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator2D<>(MAX_RSSI);
        ...
        estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator2D<>(readings, MAX_RSSI);
        ...
        estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator2D<>(MAX_RSSI, this);
        ...
        estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator2D<>(readings, MAX_RSSI, this);
        ...
        estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator2D<>(readings, initialPosition, MAX_RSSI);
        ...
        estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator2D<>(initialPosition, MAX_RSSI);
        ...
        estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator2D<>(initialPosition, MAX_RSSI, this);
        ...
        estimator = null;
        try {
            estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator2D<>(null, initialPosition, MAX_RSSI,
                    MIN_PATH_LOSS_EXPONENT, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
    ...
    public void testGetSetStopThreshold() throws LockedException {
        final LMedSRobustRangingAndRssiRadioSourceEstimator2D<WifiAccessPoint> estimator =
                new LMedSRobustRangingAndRssiRadioSourceEstimator2D<>();
    ...
    public void testEstimateNoInlierErrorNoRefinement()
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final LMedSRobustRangingAndRssiRadioSourceEstimator2D<WifiAccessPoint> estimator =
                    new LMedSRobustRangingAndRssiRadioSourceEstimator2D<>(readings, this);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    public void testEstimateNoInlierErrorWithRefinement() throws LockedException, NotReadyException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            for (int i = 0; i < numReadings; i++) {
                ...
                readings.add(new RangingAndRssiReadingLocated2D<>(accessPoint, distance,
                        rssi + error, readingsPositions[i]));
            }
    ...
    public void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final LMedSRobustRangingAndRssiRadioSourceEstimator2D<Beacon> estimator =
                    new LMedSRobustRangingAndRssiRadioSourceEstimator2D<>(readings);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    public void testEstimatePositionOnly() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        String formattedConfidence = format.format(positionStdConfidence);
        LOGGER.log(Level.INFO, MessageFormat.format(
                "Position standard deviation {0} meters ({1} confidence)", positionStd, formattedConfidence));
    ...
    public void onEstimateStart(final RobustRangingAndRssiRadioSourceEstimator<WifiAccessPoint, Point2D> estimator) {
        estimateStart++;
        checkLocked((LMedSRobustRangingAndRssiRadioSourceEstimator2D<WifiAccessPoint>) estimator);
    }
    ...
    private void checkLocked(final LMedSRobustRangingAndRssiRadioSourceEstimator2D<WifiAccessPoint> estimator) {
        try {
            estimator.setPreliminarySubsetSize(3);
