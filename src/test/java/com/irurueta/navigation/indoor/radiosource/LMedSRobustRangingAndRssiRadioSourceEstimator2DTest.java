...
class LMedSRobustRangingAndRssiRadioSourceEstimator2DTest implements
    ...
    void testConstructor() {
        ...
        var estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator2D<WifiAccessPoint>();
        ...
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustRangingAndRssiRadioSourceEstimator2D<>(
    ...
    void testGetSetStopThreshold() throws LockedException {
        final var estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator2D<WifiAccessPoint>();
    ...
    void testEstimateNoInlierErrorNoRefinement() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator2D<>(readings, this);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    void testEstimateWithInlierErrorWithRefinement() throws LockedException, NotReadyException,
        ...
        // force NotReadyException
        final var estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator2D<>();
        assertThrows(NotReadyException.class, estimator::estimate);
    }
    ...
    void testEstimatePositionTransmittedPowerAndPathLossEstimationEnabled() throws LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            var estimatedAccessPoint = (WifiAccessPointWithPowerAndLocated2D) estimator.getEstimatedRadioSource();
    ...
    void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException, AlgebraException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator2D<>(readings);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    void testEstimatePositionOnlyWithInitialPosition() throws LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            var numReadings = randomizer.nextInt(MIN_READINGS, MAX_READINGS);
            final var readingsPositions = new Point2D[numReadings];
            final var readings = new ArrayList<RangingAndRssiReadingLocated2D<WifiAccessPoint>>();
            for (var i = 0; i < numReadings; i++) {
                readingsPositions[i] = new InhomogeneousPoint2D(
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            for (var i = 0; i < numReadings; i++) {
                ...
                final var positionCovariance = Matrix.diagonal(new double[]{
                        INLIER_ERROR_STD * INLIER_ERROR_STD, INLIER_ERROR_STD * INLIER_ERROR_STD});
    ...
    void testEstimateInhomogeneousRangingLinearSolverUsed() throws LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var readings = new ArrayList<RangingAndRssiReadingLocated2D<WifiAccessPoint>>();
            for (var i = 0; i < numReadings; i++) {
                readingsPositions[i] = new InhomogeneousPoint2D(randomizer.nextDouble(MIN_POS, MAX_POS),
    ...
    private static void checkLocked(final LMedSRobustRangingAndRssiRadioSourceEstimator2D<WifiAccessPoint> estimator) {
