...
public class PROMedSRobustRangingRadioSourceEstimator3DTest implements
        RobustRangingRadioSourceEstimatorListener<WifiAccessPoint, Point3D> {

    private static final Logger LOGGER = Logger.getLogger(
            PROMedSRobustRangingRadioSourceEstimator3DTest.class.getName());
    ...
    public void testConstructor() {
        ...
        assertEquals(PROMedSRobustRangingRadioSourceEstimator3D.DEFAULT_STOP_THRESHOLD,
        ...
        estimator = new PROMedSRobustRangingRadioSourceEstimator3D<>(readings);
        ...
        estimator = null;
        try {
            estimator = new PROMedSRobustRangingRadioSourceEstimator3D<>(
        ...
        estimator = new PROMedSRobustRangingRadioSourceEstimator3D<>(this);
        ...
        estimator = new PROMedSRobustRangingRadioSourceEstimator3D<>(readings, this);
        ...
        final InhomogeneousPoint3D initialPosition = new InhomogeneousPoint3D(
                ...
                randomizer.nextDouble(MIN_POS, MAX_POS),
                randomizer.nextDouble(MIN_POS, MAX_POS));
        estimator = new PROMedSRobustRangingRadioSourceEstimator3D<>(initialPosition);
        ...
        estimator = new PROMedSRobustRangingRadioSourceEstimator3D<>(readings, initialPosition);

        // check default values
        assertEquals(PROMedSRobustRangingRadioSourceEstimator3D.DEFAULT_STOP_THRESHOLD, estimator.getStopThreshold(),
                0.0);
        assertEquals(RobustEstimatorMethod.PROMEDS, estimator.getMethod());
        assertEquals(4, estimator.getMinReadings());
        assertEquals(4, estimator.getPreliminarySubsetSize());
        ...
        estimator = new PROMedSRobustRangingRadioSourceEstimator3D<>(initialPosition, this);
        ...
        estimator = new PROMedSRobustRangingRadioSourceEstimator3D<>(readings, initialPosition, this);
        ...
        estimator = new PROMedSRobustRangingRadioSourceEstimator3D<>(qualityScores);
        ...
        estimator = new PROMedSRobustRangingRadioSourceEstimator3D<>(qualityScores, readings);
        ...
        try {
            estimator = new PROMedSRobustRangingRadioSourceEstimator3D<>(new double[1], readings);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
        ...
        estimator = new PROMedSRobustRangingRadioSourceEstimator3D<>(qualityScores, this);
        ...
        estimator = new PROMedSRobustRangingRadioSourceEstimator3D<>(qualityScores, readings, this);
        ...
        try {
            estimator = new PROMedSRobustRangingRadioSourceEstimator3D<>(new double[1], readings, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
        ...
        estimator = new PROMedSRobustRangingRadioSourceEstimator3D<>(qualityScores, initialPosition);
        ...
        estimator = new PROMedSRobustRangingRadioSourceEstimator3D<>(qualityScores, readings, initialPosition);
        ...
        estimator = null;
        try {
            estimator = new PROMedSRobustRangingRadioSourceEstimator3D<>(qualityScores, null,
                    initialPosition);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        ...
        try {
            estimator = new PROMedSRobustRangingRadioSourceEstimator3D<>(new double[1], readings, initialPosition);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
        ...
        estimator = new PROMedSRobustRangingRadioSourceEstimator3D<>(qualityScores, initialPosition, this);
        ...
        try {
            estimator = new PROMedSRobustRangingRadioSourceEstimator3D<>(new double[1],
                    readings, initialPosition, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
    ...
    public void testGetSetStopThreshold() throws LockedException {
        final PROMedSRobustRangingRadioSourceEstimator3D<WifiAccessPoint> estimator =
                new PROMedSRobustRangingRadioSourceEstimator3D<>();
    ...
    public void testEstimateNoInlierErrorNoRefinement() throws LockedException, NotReadyException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final PROMedSRobustRangingRadioSourceEstimator3D<WifiAccessPoint> estimator =
                    new PROMedSRobustRangingRadioSourceEstimator3D<>(qualityScores, readings, this);
    ...
    public void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final PROMedSRobustRangingRadioSourceEstimator3D<Beacon> estimator =
                    new PROMedSRobustRangingRadioSourceEstimator3D<>(qualityScores, readings);
    ...
    public void testEstimateWithStandardDeviationsAndPositionCovariance() throws LockedException, NotReadyException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            for (int i = 0; i < numReadings; i++) {
                ...
                readings.add(new RangingReadingLocated3D<>(accessPoint,
                        distance + error, readingsPositions[i], INLIER_ERROR_STD, positionCovariance));
            }
    ...
    public void onEstimateStart(final RobustRangingRadioSourceEstimator<WifiAccessPoint, Point3D> estimator) {
        estimateStart++;
        checkLocked((PROMedSRobustRangingRadioSourceEstimator3D<WifiAccessPoint>) estimator);
    }
    ...
    private void checkLocked(final PROMedSRobustRangingRadioSourceEstimator3D<WifiAccessPoint> estimator) {
        try {
            estimator.setPreliminarySubsetSize(3);
