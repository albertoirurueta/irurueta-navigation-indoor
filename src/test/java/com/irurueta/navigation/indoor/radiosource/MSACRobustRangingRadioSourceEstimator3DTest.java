...
class MSACRobustRangingRadioSourceEstimator3DTest implements
        RobustRangingRadioSourceEstimatorListener<WifiAccessPoint, Point3D> {

    private static final Logger LOGGER = Logger.getLogger(MSACRobustRangingRadioSourceEstimator3DTest.class.getName());
    ...
    void testConstructor() {
        ...
        var estimator = new MSACRobustRangingRadioSourceEstimator3D<WifiAccessPoint>();
        ...
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustRangingRadioSourceEstimator3D<>(
        ...
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustRangingRadioSourceEstimator3D<>(wrongReadings,
                this));
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustRangingRadioSourceEstimator3D<>(null,
                initialPosition));
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustRangingRadioSourceEstimator3D<>(
    ...
    void testGetSetThreshold() throws LockedException {
        final var estimator = new MSACRobustRangingRadioSourceEstimator3D<WifiAccessPoint>();
    ...
    void testEstimateNoInlierErrorNoRefinement() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new MSACRobustRangingRadioSourceEstimator3D<>(readings, this);
    ...
    void testEstimateNoInlierErrorWithInitialPositionAndRefinement() throws LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new MSACRobustRangingRadioSourceEstimator3D<>(readings, accessPointPosition,
                    this);
    ...
    void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new MSACRobustRangingRadioSourceEstimator3D<>(readings);
    ...
    private static void checkLocked(final MSACRobustRangingRadioSourceEstimator3D<WifiAccessPoint> estimator) {
