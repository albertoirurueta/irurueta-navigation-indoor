...
public class MSACRobustRssiRadioSourceEstimator2DTest implements
    ...
    public void testConstructor() {
        ...
        MSACRobustRssiRadioSourceEstimator2D<WifiAccessPoint> estimator =
                new MSACRobustRssiRadioSourceEstimator2D<>();
        ...
        estimator = null;
        try {
            estimator = new MSACRobustRssiRadioSourceEstimator2D<>((List<RssiReadingLocated2D<WifiAccessPoint>>) null);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new MSACRobustRssiRadioSourceEstimator2D<>(
        ...
        // check
        assertEquals(MSACRobustRssiRadioSourceEstimator2D.DEFAULT_THRESHOLD, estimator.getThreshold(),
                0.0);
        assertEquals(RobustEstimatorMethod.MSAC, estimator.getMethod());
        assertEquals(4, estimator.getMinReadings());
        assertEquals(4, estimator.getPreliminarySubsetSize());
        ...
        estimator = null;
        try {
            estimator = new MSACRobustRssiRadioSourceEstimator2D<>(null, initialPosition);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = null;
        try {
            estimator = new MSACRobustRssiRadioSourceEstimator2D<>(null, initialPosition, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = null;
        try {
            estimator = new MSACRobustRssiRadioSourceEstimator2D<>(null, initialPosition, MAX_RSSI);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
    ...
    public void testGetSetStopThreshold() throws LockedException {
        final MSACRobustRssiRadioSourceEstimator2D<WifiAccessPoint> estimator =
                new MSACRobustRssiRadioSourceEstimator2D<>();
    ...
    public void testEstimateNoInlierErrorNoRefinement() throws LockedException, NotReadyException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final MSACRobustRssiRadioSourceEstimator2D<WifiAccessPoint> estimator =
                    new MSACRobustRssiRadioSourceEstimator2D<>(readings, this);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    public void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final MSACRobustRssiRadioSourceEstimator2D<Beacon> estimator =
                    new MSACRobustRssiRadioSourceEstimator2D<>(readings);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    private void checkLocked(final MSACRobustRssiRadioSourceEstimator2D<WifiAccessPoint> estimator) {
        try {
            estimator.setPreliminarySubsetSize(3);
