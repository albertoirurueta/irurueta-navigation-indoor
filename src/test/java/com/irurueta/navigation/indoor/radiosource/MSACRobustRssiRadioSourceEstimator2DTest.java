...
class MSACRobustRssiRadioSourceEstimator2DTest implements
        RobustRssiRadioSourceEstimatorListener<WifiAccessPoint, Point2D> {

    private static final Logger LOGGER = Logger.getLogger(MSACRobustRssiRadioSourceEstimator2DTest.class.getName());
    ...
    private static final double LARGE_POSITION_ERROR = 4.0;
    ...
    void testConstructor() {
        ...
        var estimator = new MSACRobustRssiRadioSourceEstimator2D<WifiAccessPoint>();
        ...
        estimator = new MSACRobustRssiRadioSourceEstimator2D<>(readings);
        ...
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustRssiRadioSourceEstimator2D<>(
                (List<RssiReadingLocated2D<WifiAccessPoint>>) null));
        final var wrongReadings = new ArrayList<RssiReadingLocated2D<WifiAccessPoint>>();
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustRssiRadioSourceEstimator2D<>(wrongReadings));

        // test constructor with listener
        estimator = new MSACRobustRssiRadioSourceEstimator2D<>(this);
        ...
        estimator = new MSACRobustRssiRadioSourceEstimator2D<>(readings, this);
        ...
        estimator = new MSACRobustRssiRadioSourceEstimator2D<>(readings, initialPosition);
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustRssiRadioSourceEstimator2D<>(null,
                initialPosition));
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustRssiRadioSourceEstimator2D<>(wrongReadings,
                initialPosition));

        // test constructor with initial position
        estimator = new MSACRobustRssiRadioSourceEstimator2D<>(initialPosition);
        ...
        estimator = new MSACRobustRssiRadioSourceEstimator2D<>(initialPosition, this);
        ...
        estimator = new MSACRobustRssiRadioSourceEstimator2D<>(readings, initialPosition, this);
        ...
        estimator = new MSACRobustRssiRadioSourceEstimator2D<>(MAX_RSSI);
        ...
        estimator = new MSACRobustRssiRadioSourceEstimator2D<>(readings, MAX_RSSI);
        ...
        estimator = new MSACRobustRssiRadioSourceEstimator2D<>(MAX_RSSI, this);
        ...
        estimator = new MSACRobustRssiRadioSourceEstimator2D<>(readings, MAX_RSSI, this);
        ...
        estimator = new MSACRobustRssiRadioSourceEstimator2D<>(readings, initialPosition, MAX_RSSI);
        ...
        estimator = new MSACRobustRssiRadioSourceEstimator2D<>(initialPosition, MAX_RSSI);
        ...
        estimator = new MSACRobustRssiRadioSourceEstimator2D<>(initialPosition, MAX_RSSI, this);
        ...
        // and listener
        estimator = new MSACRobustRssiRadioSourceEstimator2D<>(readings, initialPosition, MAX_RSSI, this);
        ...
        // test constructor with initial position and initial transmitted power
        estimator = new MSACRobustRssiRadioSourceEstimator2D<>(initialPosition, MAX_RSSI, MIN_PATH_LOSS_EXPONENT);
    ...
    void testGetSetStopThreshold() throws LockedException {
        final var estimator = new MSACRobustRssiRadioSourceEstimator2D<WifiAccessPoint>();
    ...
    void testEstimateNoInlierErrorNoRefinement() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new MSACRobustRssiRadioSourceEstimator2D<WifiAccessPoint>(readings, this);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    void testEstimateNoInlierErrorWithRefinement() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new MSACRobustRssiRadioSourceEstimator2D<>(readings, this);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    @Test
    void testEstimateWithInlierErrorNoRefinement() throws LockedException, NotReadyException, RobustEstimatorException {
        final var randomizer = new UniformRandomizer();
        final var errorRandomizer = new GaussianRandomizer(0.0, STD_OUTLIER_ERROR);
    ...
    void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException, AlgebraException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new MSACRobustRssiRadioSourceEstimator2D<>(readings);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    public void onEstimateStart(final RobustRssiRadioSourceEstimator<WifiAccessPoint, Point2D> estimator) {
        estimateStart++;
        checkLocked((MSACRobustRssiRadioSourceEstimator2D<WifiAccessPoint>) estimator);
    }
    ...
    private static void checkLocked(final MSACRobustRssiRadioSourceEstimator2D<WifiAccessPoint> estimator) {
