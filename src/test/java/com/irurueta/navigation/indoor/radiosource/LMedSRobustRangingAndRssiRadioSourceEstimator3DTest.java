...
public class LMedSRobustRangingAndRssiRadioSourceEstimator3DTest implements
        RobustRangingAndRssiRadioSourceEstimatorListener<WifiAccessPoint, Point3D> {

    private static final Logger LOGGER = Logger.getLogger(
            LMedSRobustRangingAndRssiRadioSourceEstimator3DTest.class.getName());
    ...
    public void testConstructor() {
        ...
        LMedSRobustRangingAndRssiRadioSourceEstimator3D<WifiAccessPoint> estimator =
                new LMedSRobustRangingAndRssiRadioSourceEstimator3D<>();

        // check
        assertEquals(LMedSRobustRangingAndRssiRadioSourceEstimator3D.DEFAULT_STOP_THRESHOLD,
        ...
        estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator3D<>(readings);
        ...
        estimator = null;
        try {
            estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator3D<>(
        ...
        estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator3D<>(this);
        ...
        estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator3D<>(readings, this);
        ...
        final InhomogeneousPoint3D initialPosition = new InhomogeneousPoint3D(
                ...
                randomizer.nextDouble(MIN_POS, MAX_POS),
                randomizer.nextDouble(MIN_POS, MAX_POS));
        estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator3D<>(readings, initialPosition);
        ...
        estimator = null;
        try {
            estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator3D<>(null, initialPosition);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator3D<>(initialPosition);
        ...
        estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator3D<>(initialPosition, this);
        ...
        estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator3D<>(readings, initialPosition, this);
        ...
        estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator3D<>(MAX_RSSI);
        ...
        estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator3D<>(readings, MAX_RSSI);
        ...
        estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator3D<>(MAX_RSSI, this);
        ...
        estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator3D<>(readings, MAX_RSSI, this);
        ...
        estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator3D<>(readings, initialPosition, MAX_RSSI);
        ...
        estimator = null;
        try {
            estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator3D<>(null, initialPosition, MAX_RSSI);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator3D<>(initialPosition, MAX_RSSI);
        ...
        estimator = new LMedSRobustRangingAndRssiRadioSourceEstimator3D<>(initialPosition, MAX_RSSI, this);
    ...
    public void testGetSetStopThreshold() throws LockedException {
        final LMedSRobustRangingAndRssiRadioSourceEstimator3D<WifiAccessPoint> estimator =
                new LMedSRobustRangingAndRssiRadioSourceEstimator3D<>();
    ...
    public void testEstimateNoInlierErrorNoRefinement() throws LockedException, NotReadyException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final LMedSRobustRangingAndRssiRadioSourceEstimator3D<WifiAccessPoint> estimator =
                    new LMedSRobustRangingAndRssiRadioSourceEstimator3D<>(readings, this);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    public void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final LMedSRobustRangingAndRssiRadioSourceEstimator3D<Beacon> estimator =
                    new LMedSRobustRangingAndRssiRadioSourceEstimator3D<>(readings);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    public void onEstimateStart(final RobustRangingAndRssiRadioSourceEstimator<WifiAccessPoint, Point3D> estimator) {
        estimateStart++;
        checkLocked((LMedSRobustRangingAndRssiRadioSourceEstimator3D<WifiAccessPoint>) estimator);
    }
    ...
    private void checkLocked(final LMedSRobustRangingAndRssiRadioSourceEstimator3D<WifiAccessPoint> estimator) {
        try {
