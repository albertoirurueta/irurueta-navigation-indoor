...
public class RANSACRobustRangingRadioSourceEstimator2DTest implements
    ...
    public void testConstructor() {
        ...
        estimator = null;
        try {
            estimator = new RANSACRobustRangingRadioSourceEstimator2D<>(null, initialPosition);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = null;
        try {
            estimator = new RANSACRobustRangingRadioSourceEstimator2D<>(null, initialPosition, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
    ...
    public void testGetSetThreshold() throws LockedException {
        final RANSACRobustRangingRadioSourceEstimator2D<WifiAccessPoint> estimator =
                new RANSACRobustRangingRadioSourceEstimator2D<>();
    ...
    public void testEstimateNoInlierErrorNoRefinement() throws LockedException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final RANSACRobustRangingRadioSourceEstimator2D<WifiAccessPoint> estimator =
                    new RANSACRobustRangingRadioSourceEstimator2D<>(readings, this);
    ...
    public void testEstimateNoInlierErrorWithInitialPositionAndRefinement() throws LockedException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final RANSACRobustRangingRadioSourceEstimator2D<WifiAccessPoint> estimator =
                    new RANSACRobustRangingRadioSourceEstimator2D<>(readings, accessPointPosition, this);
    ...
    public void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final RANSACRobustRangingRadioSourceEstimator2D<Beacon> estimator =
    ...
    private void checkLocked(final RANSACRobustRangingRadioSourceEstimator2D<WifiAccessPoint> estimator) {
        try {
