...
class RANSACRobustRangingRadioSourceEstimator2DTest implements
        RobustRangingRadioSourceEstimatorListener<WifiAccessPoint, Point2D> {

    private static final Logger LOGGER = Logger.getLogger(
            RANSACRobustRangingRadioSourceEstimator2DTest.class.getName());
    ...
    void testConstructor() {
        ...
        var estimator = new RANSACRobustRangingRadioSourceEstimator2D<WifiAccessPoint>();

        // check default values
        assertEquals(RANSACRobustRangingRadioSourceEstimator2D.DEFAULT_THRESHOLD, estimator.getThreshold(), 0.0);
        assertEquals(RANSACRobustRangingRadioSourceEstimator2D.DEFAULT_COMPUTE_AND_KEEP_INLIERS,
                estimator.isComputeAndKeepInliersEnabled());
        assertEquals(RANSACRobustRangingRadioSourceEstimator2D.DEFAULT_COMPUTE_AND_KEEP_RESIDUALS,
        ...
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustRangingRadioSourceEstimator2D<>(
        ...
        // check default values
        assertEquals(RANSACRobustRangingRadioSourceEstimator2D.DEFAULT_THRESHOLD, estimator.getThreshold(),
                0.0);
        assertEquals(RANSACRobustRangingRadioSourceEstimator2D.DEFAULT_COMPUTE_AND_KEEP_INLIERS,
                estimator.isComputeAndKeepInliersEnabled());
        assertEquals(RANSACRobustRangingRadioSourceEstimator2D.DEFAULT_COMPUTE_AND_KEEP_RESIDUALS,
        ...
        estimator = new RANSACRobustRangingRadioSourceEstimator2D<>(initialPosition, this);
        ...
        estimator = new RANSACRobustRangingRadioSourceEstimator2D<>(readings, initialPosition, this);
    ...
    void testGetSetThreshold() throws LockedException {
        final var estimator = new RANSACRobustRangingRadioSourceEstimator2D<WifiAccessPoint>();
    ...
    void testEstimateNoInlierErrorNoRefinement() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new RANSACRobustRangingRadioSourceEstimator2D<>(readings, this);
    ...
    void testEstimateNoInlierErrorWithInitialPositionAndRefinement() throws LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new RANSACRobustRangingRadioSourceEstimator2D<>(readings, accessPointPosition,
                    this);
    ...
    void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new RANSACRobustRangingRadioSourceEstimator2D<>(readings);
    ...
    void testEstimateWithStandardDeviationsAndPositionCovariance() throws LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new RANSACRobustRangingRadioSourceEstimator2D<WifiAccessPoint>(readings, this);
    ...
    public void onEstimateStart(final RobustRangingRadioSourceEstimator<WifiAccessPoint, Point2D> estimator) {
        estimateStart++;
        checkLocked((RANSACRobustRangingRadioSourceEstimator2D<WifiAccessPoint>) estimator);
    }
    ...
    private static void checkLocked(final RANSACRobustRangingRadioSourceEstimator2D<WifiAccessPoint> estimator) {
