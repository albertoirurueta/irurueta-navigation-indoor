...
class PROSACRobustRangingRadioSourceEstimator2DTest implements
    ...
    void testConstructor() {
        ...
        var estimator = new PROSACRobustRangingRadioSourceEstimator2D<WifiAccessPoint>();
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustRangingRadioSourceEstimator2D<>(
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustRangingRadioSourceEstimator2D<>(
                qualityScores, (List<RangingReadingLocated2D<WifiAccessPoint>>) null));
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustRangingRadioSourceEstimator2D<>(
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustRangingRadioSourceEstimator2D<>(
                qualityScores, (List<RangingReadingLocated2D<WifiAccessPoint>>) null, this));
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustRangingRadioSourceEstimator2D<>(
    ...
    void testGetSetThreshold() throws LockedException {
        final var estimator = new PROSACRobustRangingRadioSourceEstimator2D<WifiAccessPoint>();
    ...
    void testGetSetQualityScores() throws LockedException {
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> estimator.setQualityScores(new double[2]));
    }
    ...
    void testEstimateNoInlierErrorNoRefinement() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new PROSACRobustRangingRadioSourceEstimator2D<>(qualityScores, readings,
                    this);
    ...
    void testEstimateWithInlierErrorWithRefinement() throws LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            for (var i = 0; i < numReadings; i++) {
                ...
                readings.add(new RangingReadingLocated2D<>(accessPoint, Math.abs(distance + error),
                        readingsPositions[i]));
            }
    ...
    private static void checkLocked(final PROSACRobustRangingRadioSourceEstimator2D<WifiAccessPoint> estimator) {
