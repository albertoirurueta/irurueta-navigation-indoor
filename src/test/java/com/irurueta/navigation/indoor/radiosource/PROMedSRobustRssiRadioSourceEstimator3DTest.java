...
public class PROMedSRobustRssiRadioSourceEstimator3DTest implements
    ...
    public void testConstructor() {
        ...
        PROMedSRobustRssiRadioSourceEstimator3D<WifiAccessPoint> estimator =
                new PROMedSRobustRssiRadioSourceEstimator3D<>();

        // check
        assertEquals(PROMedSRobustRssiRadioSourceEstimator3D.DEFAULT_STOP_THRESHOLD, estimator.getStopThreshold(),
                0.0);
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(readings);

        // check
        assertEquals(PROMedSRobustRssiRadioSourceEstimator3D.DEFAULT_STOP_THRESHOLD,
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(readings, this);
        ...
        InhomogeneousPoint3D initialPosition = new InhomogeneousPoint3D(
                ...
                randomizer.nextDouble(MIN_POS, MAX_POS),
                randomizer.nextDouble(MIN_POS, MAX_POS));
        estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(readings, initialPosition);
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(initialPosition, this);
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(readings, initialPosition, this);
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(MAX_RSSI);
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(readings, MAX_RSSI);
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(MAX_RSSI, this);
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(readings, MAX_RSSI, this);
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(readings, initialPosition, MAX_RSSI);
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(initialPosition, MAX_RSSI);
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(initialPosition, MAX_RSSI, this);
        ...
        // power and listener
        estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(readings, initialPosition, MAX_RSSI, this);
        ...
        // test constructor with initial position and initial transmitted power
        estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(initialPosition, MAX_RSSI, MIN_PATH_LOSS_EXPONENT);
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(qualityScores);
        ...
        estimator = null;
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>((double[]) null);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(new double[1]);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(qualityScores, readings);
        ...
        estimator = null;
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(null, readings);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(new double[1], readings);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(qualityScores, this);

        // check
        assertEquals(PROMedSRobustRssiRadioSourceEstimator3D.DEFAULT_STOP_THRESHOLD,
                estimator.getStopThreshold(),
                0.0);
        assertEquals(RobustEstimatorMethod.PROMEDS, estimator.getMethod());
        assertEquals(5, estimator.getMinReadings());
        assertEquals(5, estimator.getPreliminarySubsetSize());
        ...
        estimator = null;
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>((double[]) null, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(new double[1], this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(qualityScores, readings, this);
        ...
        estimator = null;
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(null, readings, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(new double[1], readings, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(qualityScores, readings, initialPosition);
        ...
        estimator = null;
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(null, readings, initialPosition);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(new double[1], readings, initialPosition);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(qualityScores, null, initialPosition);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(qualityScores, initialPosition);
        ...
        estimator = null;
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>((double[]) null, initialPosition);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(new double[1], initialPosition);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(qualityScores, initialPosition, this);
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(qualityScores, MAX_RSSI);
        ...
        estimator = null;
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>((double[]) null, MAX_RSSI);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(new double[1], MAX_RSSI);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(qualityScores, readings, MAX_RSSI);
        ...
        estimator = null;
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(null, readings, MAX_RSSI);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(new double[1], readings, MAX_RSSI);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(qualityScores, MAX_RSSI, this);
        ...
        estimator = null;
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>((double[]) null, MAX_RSSI, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(new double[1], MAX_RSSI, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(qualityScores, readings, MAX_RSSI, this);
        ...
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(new double[1], readings, MAX_RSSI, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(qualityScores, readings, initialPosition, MAX_RSSI);
        ...
        // power
        estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(qualityScores, initialPosition, MAX_RSSI);
        ...
        estimator = null;
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>((double[]) null, initialPosition, MAX_RSSI);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(new double[1], initialPosition, MAX_RSSI);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
    ...
    public void testGetSetStopThreshold() throws LockedException {
        final PROMedSRobustRssiRadioSourceEstimator3D<WifiAccessPoint> estimator =
                new PROMedSRobustRssiRadioSourceEstimator3D<>();
        ...
        // check
        assertEquals(50.0, estimator.getStopThreshold(), 0.0);
    ...
    public void testEstimateNoInlierErrorNoRefinement() throws LockedException, NotReadyException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final PROMedSRobustRssiRadioSourceEstimator3D<WifiAccessPoint> estimator =
                    new PROMedSRobustRssiRadioSourceEstimator3D<>(qualityScores, readings, this);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    public void testEstimateWithPathLossEstimationEnabled() throws LockedException, NotReadyException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            assertEquals(Math.sqrt(estimator.getEstimatedTransmittedPowerVariance()),
                    estimatedAccessPoint.getTransmittedPowerStandardDeviation(), 0.0);
            assertEquals(estimator.getEstimatedPositionCovariance(), estimatedAccessPoint.getPositionCovariance());
            assertNotNull(estimatedAccessPoint.getPathLossExponentStandardDeviation());
    ...
    public void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final PROMedSRobustRssiRadioSourceEstimator3D<Beacon> estimator =
                    new PROMedSRobustRssiRadioSourceEstimator3D<>(qualityScores, readings);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    public void onEstimateStart(final RobustRssiRadioSourceEstimator<WifiAccessPoint, Point3D> estimator) {
        estimateStart++;
        checkLocked((PROMedSRobustRssiRadioSourceEstimator3D<WifiAccessPoint>) estimator);
    }
    ...
    private void checkLocked(final PROMedSRobustRssiRadioSourceEstimator3D<WifiAccessPoint> estimator) {
        try {
