...
class PROMedSRobustRssiRadioSourceEstimator3DTest implements
        RobustRssiRadioSourceEstimatorListener<WifiAccessPoint, Point3D> {

    private static final Logger LOGGER = Logger.getLogger(PROMedSRobustRssiRadioSourceEstimator3DTest.class.getName());
    ...
    void testConstructor() {
        ...
        var estimator = new PROMedSRobustRssiRadioSourceEstimator3D<WifiAccessPoint>();
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustRssiRadioSourceEstimator3D<>(
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustRssiRadioSourceEstimator3D<>(wrongReadings,
                this));
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(initialPosition);
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustRssiRadioSourceEstimator3D<>(
                null, readings));
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustRssiRadioSourceEstimator3D<>(new double[1],
                readings));
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustRssiRadioSourceEstimator3D<>(qualityScores,
                (List<RssiReadingLocated3D<WifiAccessPoint>>) null));
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustRssiRadioSourceEstimator3D<>(qualityScores,
                wrongReadings));
    ...
    void testEstimateNoInlierErrorNoRefinement() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(qualityScores, readings, this);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException, AlgebraException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new PROMedSRobustRssiRadioSourceEstimator3D<>(qualityScores, readings);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    private static void checkLocked(final PROMedSRobustRssiRadioSourceEstimator3D<WifiAccessPoint> estimator) {
