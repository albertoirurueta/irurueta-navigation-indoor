...
public class PROMedSRobustRssiRadioSourceEstimator2DTest implements
    ...
    public void testConstructor() {
        ...
        // check
        assertEquals(PROMedSRobustRssiRadioSourceEstimator2D.DEFAULT_STOP_THRESHOLD,
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(readings);

        // check
        assertEquals(PROMedSRobustRssiRadioSourceEstimator2D.DEFAULT_STOP_THRESHOLD, estimator.getStopThreshold(),
                0.0);
        assertEquals(RobustEstimatorMethod.PROMEDS, estimator.getMethod());
        assertEquals(4, estimator.getMinReadings());
        assertEquals(4, estimator.getPreliminarySubsetSize());
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(readings, this);
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(initialPosition, this);
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(readings, initialPosition, this);
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(MAX_RSSI);
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(readings, MAX_RSSI);
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(MAX_RSSI, this);
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(readings, MAX_RSSI, this);
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(readings, initialPosition, MAX_RSSI);
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(initialPosition, MAX_RSSI);
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(initialPosition, MAX_RSSI, this);
        ...
        // power and listener
        estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(readings, initialPosition, MAX_RSSI, this);
        ...
        // test constructor with initial position and initial transmitted power
        estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(initialPosition, MAX_RSSI, MIN_PATH_LOSS_EXPONENT);
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(qualityScores);
        ...
        estimator = null;
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>((double[]) null);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(new double[1]);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(qualityScores, readings);
        ...
        estimator = null;
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(null, readings);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(new double[1], readings);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(qualityScores, this);
        ...
        estimator = null;
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>((double[]) null, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(new double[1], this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(qualityScores, readings, this);
        ...
        estimator = null;
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(null, readings, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(new double[1], readings, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(qualityScores, readings, initialPosition);
        ...
        estimator = null;
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(null, readings, initialPosition);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(new double[1], readings, initialPosition);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(qualityScores, null, initialPosition);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(qualityScores, initialPosition);
        ...
        estimator = null;
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>((double[]) null, initialPosition);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(new double[1], initialPosition);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(qualityScores, initialPosition, this);
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(qualityScores, MAX_RSSI);
        ...
        estimator = null;
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>((double[]) null, MAX_RSSI);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(new double[1], MAX_RSSI);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(qualityScores, readings, MAX_RSSI);
        ...
        estimator = null;
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(null, readings, MAX_RSSI);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(new double[1], readings, MAX_RSSI);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(qualityScores, MAX_RSSI, this);
        ...
        estimator = null;
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>((double[]) null, MAX_RSSI, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(new double[1], MAX_RSSI, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(qualityScores, readings, MAX_RSSI, this);
        ...
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(new double[1], readings, MAX_RSSI, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(qualityScores, readings, initialPosition, MAX_RSSI);
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(qualityScores, initialPosition, MAX_RSSI);
        ...
        estimator = null;
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>((double[]) null, initialPosition, MAX_RSSI);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(new double[1], initialPosition, MAX_RSSI);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
        ...
        assertNull(estimator.getEstimatedPosition());
        assertNull(estimator.getEstimatedRadioSource());
        assertEquals(RssiRadioSourceEstimator.DEFAULT_PATH_LOSS_EXPONENT, estimator.getEstimatedPathLossExponent(), 0.0);
        assertNull(estimator.getEstimatedPathLossExponentVariance());
    ...
    public void testEstimateNoInlierErrorNoRefinement() throws LockedException, NotReadyException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final PROMedSRobustRssiRadioSourceEstimator2D<WifiAccessPoint> estimator =
                    new PROMedSRobustRssiRadioSourceEstimator2D<>(qualityScores, readings, this);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    public void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final PROMedSRobustRssiRadioSourceEstimator2D<Beacon> estimator =
                    new PROMedSRobustRssiRadioSourceEstimator2D<>(qualityScores, readings);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    private void checkLocked(final PROMedSRobustRssiRadioSourceEstimator2D<WifiAccessPoint> estimator) {
        try {
            estimator.setPreliminarySubsetSize(3);
