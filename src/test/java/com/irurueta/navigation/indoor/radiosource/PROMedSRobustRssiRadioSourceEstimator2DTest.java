...
class PROMedSRobustRssiRadioSourceEstimator2DTest implements
        RobustRssiRadioSourceEstimatorListener<WifiAccessPoint, Point2D> {

    private static final Logger LOGGER = Logger.getLogger(PROMedSRobustRssiRadioSourceEstimator2DTest.class.getName());
    ...
    void testConstructor() {
        ...
        var estimator = new PROMedSRobustRssiRadioSourceEstimator2D<WifiAccessPoint>();
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustRssiRadioSourceEstimator2D<>(
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustRssiRadioSourceEstimator2D<>(wrongReadings,
                this));

        // test constructor with readings and initial position
        final var initialPosition = new InhomogeneousPoint2D(
                randomizer.nextDouble(MIN_POS, MAX_POS), randomizer.nextDouble(MIN_POS, MAX_POS));
        estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(readings, initialPosition);
        ...
        estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(initialPosition);
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustRssiRadioSourceEstimator2D<>(
                null, readings));
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustRssiRadioSourceEstimator2D<>(new double[1],
                readings));
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustRssiRadioSourceEstimator2D<>(
                qualityScores, (List<RssiReadingLocated2D<WifiAccessPoint>>) null));
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustRssiRadioSourceEstimator2D<>(qualityScores,
                wrongReadings));
        ...
        // check
        assertEquals(PROMedSRobustRssiRadioSourceEstimator2D.DEFAULT_STOP_THRESHOLD, estimator.getStopThreshold(), 0.0);
        assertEquals(RobustEstimatorMethod.PROMEDS, estimator.getMethod());
        assertEquals(4, estimator.getMinReadings());
        assertEquals(4, estimator.getPreliminarySubsetSize());
        assertEquals(2, estimator.getNumberOfDimensions());
    ...
    void testGetSetStopThreshold() throws LockedException {
        final var estimator = new PROMedSRobustRssiRadioSourceEstimator2D<WifiAccessPoint>();
    ...
    void testEstimateNoInlierErrorNoRefinement() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(qualityScores, readings, this);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException, AlgebraException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new PROMedSRobustRssiRadioSourceEstimator2D<>(qualityScores, readings);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    private static void checkLocked(final PROMedSRobustRssiRadioSourceEstimator2D<WifiAccessPoint> estimator) {
