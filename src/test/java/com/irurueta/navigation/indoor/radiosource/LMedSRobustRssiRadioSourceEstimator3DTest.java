...
public class LMedSRobustRssiRadioSourceEstimator3DTest implements
    ...
    public void testConstructor() {
        ...
        // check
        assertEquals(LMedSRobustRssiRadioSourceEstimator3D.DEFAULT_STOP_THRESHOLD,
        ...
        estimator = null;
        try {
            estimator = new LMedSRobustRssiRadioSourceEstimator3D<>(null, initialPosition);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = null;
        try {
            estimator = new LMedSRobustRssiRadioSourceEstimator3D<>(null, initialPosition, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = null;
        try {
            estimator = new LMedSRobustRssiRadioSourceEstimator3D<>(null, initialPosition, MAX_RSSI);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
    ...
    public void testEstimateNoInlierErrorNoRefinement() throws LockedException, NotReadyException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final LMedSRobustRssiRadioSourceEstimator3D<WifiAccessPoint> estimator =
                    new LMedSRobustRssiRadioSourceEstimator3D<>(readings, this);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    public void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final LMedSRobustRssiRadioSourceEstimator3D<Beacon> estimator =
                    new LMedSRobustRssiRadioSourceEstimator3D<>(readings);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
