...
class RssiRadioSourceEstimator2DTest implements RssiRadioSourceEstimatorListener<WifiAccessPoint, Point2D> {
    ...
    void testConstructor() {
        ...
        var estimator = new RssiRadioSourceEstimator2D<WifiAccessPoint>();
        ...
        assertThrows(IllegalArgumentException.class, () -> new RssiRadioSourceEstimator2D<>(
                (List<RssiReadingLocated2D<WifiAccessPoint>>) null));
        final var wrongReadings = new ArrayList<RssiReadingLocated2D<WifiAccessPoint>>();
        assertThrows(IllegalArgumentException.class, () -> new RssiRadioSourceEstimator2D<>(wrongReadings));
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new RssiRadioSourceEstimator2D<>(null,
        ...
        assertThrows(IllegalArgumentException.class, () -> new RssiRadioSourceEstimator2D<>(wrongReadings, MAX_RSSI));
    ...
    void testEstimateWithoutInitialPositionAndInitialTransmittedPowerAndWithoutError() throws LockedException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new RssiRadioSourceEstimator2D<>(readings, this);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    void testEstimateWithInitialPositionWithoutError() throws LockedException, NotReadyException, IndoorException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new RssiRadioSourceEstimator2D<>(readings, initialPosition, this);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    void testEstimateWithInitialTransmittedPowerWithoutError() throws LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new RssiRadioSourceEstimator2D<>(readings, initialTransmittedPowerdBm, this);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    void testEstimateWithInitialPositionAndInitialTransmittedPowerWithoutError() throws LockedException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new RssiRadioSourceEstimator2D<>(readings, initialPosition,
    ...
    void testEstimateWithoutInitialPositionAndInitialTransmittedPowerAndWithError() throws LockedException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new RssiRadioSourceEstimator2D<WifiAccessPoint>(readings, this);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    void testEstimateBeacon() throws LockedException, NotReadyException, IndoorException, AlgebraException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new RssiRadioSourceEstimator2D<>(readings);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
        ...
        // force NotReadyException
        final var estimator = new RssiRadioSourceEstimator2D<Beacon>();
        assertThrows(NotReadyException.class, estimator::estimate);
    }
    ...
    private static void checkLocked(final RssiRadioSourceEstimator<WifiAccessPoint, Point2D> estimator) {
        ...
        assertThrows(LockedException.class, () -> estimator.setPositionEstimationEnabled(true));
