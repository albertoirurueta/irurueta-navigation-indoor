...
public class RssiRadioSourceEstimator2DTest implements RssiRadioSourceEstimatorListener<WifiAccessPoint, Point2D> {

    private static final Logger LOGGER = Logger.getLogger(RssiRadioSourceEstimator2DTest.class.getName());
    ...
    public void testConstructor() {
        ...
        RssiRadioSourceEstimator2D<WifiAccessPoint> estimator = new RssiRadioSourceEstimator2D<>();
        ...
        estimator = new RssiRadioSourceEstimator2D<>(readings, this);
        ...
        estimator = new RssiRadioSourceEstimator2D<>(readings, initialPosition);
        ...
        estimator = new RssiRadioSourceEstimator2D<>(initialPosition, this);
        ...
        estimator = new RssiRadioSourceEstimator2D<>(readings, initialPosition, this);
        ...
        estimator = null;
        try {
            estimator = new RssiRadioSourceEstimator2D<>(null, initialPosition, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = new RssiRadioSourceEstimator2D<>(readings, MAX_RSSI);
        ...
        estimator = new RssiRadioSourceEstimator2D<>(MAX_RSSI, this);
        ...
        estimator = new RssiRadioSourceEstimator2D<>(readings, MAX_RSSI, this);
        ...
        estimator = null;
        try {
            estimator = new RssiRadioSourceEstimator2D<>((List<RssiReadingLocated2D<WifiAccessPoint>>) null, MAX_RSSI,
                    this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        ...
        estimator = new RssiRadioSourceEstimator2D<>(readings, initialPosition, MAX_RSSI);
        ...
        estimator = null;
        try {
            estimator = new RssiRadioSourceEstimator2D<>(null, initialPosition, MAX_RSSI);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = new RssiRadioSourceEstimator2D<>(initialPosition, MAX_RSSI);
        ...
        // listener
        estimator = new RssiRadioSourceEstimator2D<>(initialPosition, MAX_RSSI, this);
        ...
        estimator = new RssiRadioSourceEstimator2D<>(readings, initialPosition, MAX_RSSI, this);
        ...
        estimator = null;
        try {
            estimator = new RssiRadioSourceEstimator2D<>(null, initialPosition, MAX_RSSI, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = new RssiRadioSourceEstimator2D<>(readings, initialPosition, MAX_RSSI, MIN_PATH_LOSS_EXPONENT);
        ...
        // test constructor with initial position and initial transmitted power
        estimator = new RssiRadioSourceEstimator2D<>(initialPosition, MAX_RSSI, MIN_PATH_LOSS_EXPONENT);
        ...
        assertNull(estimator.getEstimatedRadioSource());
        assertEquals(MAX_RSSI, estimator.getInitialTransmittedPowerdBm(), 0.0);
        assertEquals(0.0, Utils.dBmToPower(MAX_RSSI), estimator.getInitialTransmittedPower());
        assertTrue(estimator.isTransmittedPowerEstimationEnabled());
        assertSame(estimator.getInitialPosition(), initialPosition);
        assertTrue(estimator.isPositionEstimationEnabled());
        assertEquals(MIN_PATH_LOSS_EXPONENT, estimator.getInitialPathLossExponent(), 0.0);
        ...
        // test constructor with initial position, initial transmitted power and
        // listener
        estimator = new RssiRadioSourceEstimator2D<>(initialPosition, MAX_RSSI, MIN_PATH_LOSS_EXPONENT, this);
    ...
    public void testGetMinReadings() throws LockedException {
        final RssiRadioSourceEstimator2D<WifiAccessPoint> estimator = new RssiRadioSourceEstimator2D<>();
    ...
    public void testEstimateWithoutInitialPositionAndInitialTransmittedPowerAndWithoutError() throws LockedException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final RssiRadioSourceEstimator2D<WifiAccessPoint> estimator = new RssiRadioSourceEstimator2D<>(readings,
                    this);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    public void testEstimateWithInitialPositionWithoutError() throws LockedException, NotReadyException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final RssiRadioSourceEstimator2D<WifiAccessPoint> estimator =
                    new RssiRadioSourceEstimator2D<>(readings, initialPosition, this);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    public void testEstimateWithoutInitialPositionAndInitialTransmittedPowerAndWithError() throws LockedException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            for (int i = 0; i < numReadings; i++) {
                ...
                readings.add(new RssiReadingLocated2D<>(accessPoint, rssi, readingsPositions[i], ERROR_STD));
            }

            final RssiRadioSourceEstimator2D<WifiAccessPoint> estimator =
                    new RssiRadioSourceEstimator2D<>(readings, this);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    public void testEstimateBeacon() throws LockedException, NotReadyException, IndoorException, AlgebraException {
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            for (int i = 0; i < numReadings; i++) {
                ...
                readings.add(new RssiReadingLocated2D<>(beacon, rssi, readingsPositions[i]));
            }

            final RssiRadioSourceEstimator2D<Beacon> estimator = new RssiRadioSourceEstimator2D<>(readings);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
        ...
        // force NotReadyException
        final RssiRadioSourceEstimator2D<Beacon> estimator = new RssiRadioSourceEstimator2D<>();
        try {
            estimator.estimate();
            fail("NotReadyException expected but not thrown");
        } catch (final NotReadyException ignore) {
    ...
    @Test
    public void testEstimateTransmittedPowerOnly() throws LockedException, NotReadyException, IndoorException {
        int numValidPower = 0;
        double powerError = 0.0;
        double powerStd = 0.0;
        for (int t = 0; t < TIMES; t++) {
    ...
    @Test
    public void testEstimatePathlossOnly() throws LockedException, NotReadyException, IndoorException {
    ...
    @Test
    public void testEstimateTransmittedPowerAndPathLoss() throws LockedException, NotReadyException, IndoorException {
    ...
    @Test
    public void testEstimateFingerprintingException() throws LockedException, NotReadyException {
        ...
        final List<RssiReadingLocated2D<WifiAccessPoint>> readings = new ArrayList<>();
        for (int i = 0; i < numReadings; i++) {
            readingsPositions[i] = new InhomogeneousPoint2D(0.0, 0.0);

            readings.add(new RssiReadingLocated2D<>(accessPoint, 0.0, readingsPositions[i]));
        }
    ...
    @Override
    public void onEstimateStart(final RssiRadioSourceEstimator<WifiAccessPoint, Point2D> estimator) {
        estimateStart++;
        checkLocked(estimator);
    }

    @Override
    public void onEstimateEnd(final RssiRadioSourceEstimator<WifiAccessPoint, Point2D> estimator) {
        estimateEnd++;
        checkLocked(estimator);
    }
    ...
    private void checkLocked(final RssiRadioSourceEstimator<WifiAccessPoint, Point2D> estimator) {
        try {
