...
class MSACRobustRangingAndRssiRadioSourceEstimator2DTest implements
    ...
    void testConstructor() {
        ...
        var estimator = new MSACRobustRangingAndRssiRadioSourceEstimator2D<WifiAccessPoint>();
        ...
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustRangingAndRssiRadioSourceEstimator2D<>(
    ...
    void testAreValidReadings() throws LockedException {
        ...
        final var wrongReadings = new ArrayList<RangingAndRssiReadingLocated<WifiAccessPoint, Point2D>>();
    ...
    void testEstimateNoInlierErrorNoRefinement() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new MSACRobustRangingAndRssiRadioSourceEstimator2D<>(readings, this);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    void testEstimatePositionTransmittedPowerAndPathLossEstimationEnabled() throws LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            var powerVariance = estimator.getEstimatedTransmittedPowerVariance();
    ...
    void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException, AlgebraException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new MSACRobustRangingAndRssiRadioSourceEstimator2D<>(readings);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    private static void checkLocked(final MSACRobustRangingAndRssiRadioSourceEstimator2D<WifiAccessPoint> estimator) {
