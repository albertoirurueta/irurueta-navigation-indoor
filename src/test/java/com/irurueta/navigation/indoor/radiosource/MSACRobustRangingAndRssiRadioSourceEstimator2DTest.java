...
public class MSACRobustRangingAndRssiRadioSourceEstimator2DTest implements
        RobustRangingAndRssiRadioSourceEstimatorListener<WifiAccessPoint, Point2D> {

    private static final Logger LOGGER = Logger.getLogger(
            MSACRobustRangingAndRssiRadioSourceEstimator2DTest.class.getName());
    ...
    public void testConstructor() {
        ...
        // check
        assertEquals(MSACRobustRangingAndRssiRadioSourceEstimator2D.DEFAULT_THRESHOLD,
        ...
        estimator = new MSACRobustRangingAndRssiRadioSourceEstimator2D<>(readings);

        // check
        assertEquals(MSACRobustRangingAndRssiRadioSourceEstimator2D.DEFAULT_THRESHOLD, estimator.getThreshold(),
                0.0);
        assertEquals(RobustEstimatorMethod.MSAC, estimator.getMethod());
        assertEquals(4, estimator.getMinReadings());
        assertEquals(4, estimator.getPreliminarySubsetSize());
        ...
        estimator = null;
        try {
            estimator = new MSACRobustRangingAndRssiRadioSourceEstimator2D<>(
        ...
        estimator = new MSACRobustRangingAndRssiRadioSourceEstimator2D<>(this);
        ...
        estimator = new MSACRobustRangingAndRssiRadioSourceEstimator2D<>(readings, this);

        // check
        assertEquals(MSACRobustRangingAndRssiRadioSourceEstimator2D.DEFAULT_THRESHOLD,
                estimator.getThreshold(),
                0.0);
        assertEquals(RobustEstimatorMethod.MSAC, estimator.getMethod());
        assertEquals(4, estimator.getMinReadings());
        assertEquals(4, estimator.getPreliminarySubsetSize());
        ...
        final InhomogeneousPoint2D initialPosition = new InhomogeneousPoint2D(
                randomizer.nextDouble(MIN_POS, MAX_POS),
                randomizer.nextDouble(MIN_POS, MAX_POS));
        estimator = new MSACRobustRangingAndRssiRadioSourceEstimator2D<>(readings, initialPosition);
        ...
        estimator = null;
        try {
            estimator = new MSACRobustRangingAndRssiRadioSourceEstimator2D<>(null, initialPosition);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = new MSACRobustRangingAndRssiRadioSourceEstimator2D<>(initialPosition);
        ...
        estimator = new MSACRobustRangingAndRssiRadioSourceEstimator2D<>(initialPosition, this);
        ...
        estimator = new MSACRobustRangingAndRssiRadioSourceEstimator2D<>(readings, initialPosition, this);
        ...
        estimator = new MSACRobustRangingAndRssiRadioSourceEstimator2D<>(MAX_RSSI);

        // check
        assertEquals(MSACRobustRssiRadioSourceEstimator2D.DEFAULT_THRESHOLD, estimator.getThreshold(), 0.0);
        assertEquals(RobustEstimatorMethod.MSAC, estimator.getMethod());
        assertEquals(4, estimator.getMinReadings());
        assertEquals(4, estimator.getPreliminarySubsetSize());
        assertEquals(2, estimator.getNumberOfDimensions());
        ...
        estimator = new MSACRobustRangingAndRssiRadioSourceEstimator2D<>(readings, MAX_RSSI);
        ...
        estimator = new MSACRobustRangingAndRssiRadioSourceEstimator2D<>(MAX_RSSI, this);
        ...
        estimator = new MSACRobustRangingAndRssiRadioSourceEstimator2D<>(readings, MAX_RSSI, this);
        ...
        estimator = new MSACRobustRangingAndRssiRadioSourceEstimator2D<>(readings, initialPosition, MAX_RSSI);
        ...
        estimator = null;
        try {
            estimator = new MSACRobustRangingAndRssiRadioSourceEstimator2D<>(null, initialPosition, MAX_RSSI);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = new MSACRobustRangingAndRssiRadioSourceEstimator2D<>(initialPosition, MAX_RSSI);
        ...
        estimator = new MSACRobustRangingAndRssiRadioSourceEstimator2D<>(initialPosition, MAX_RSSI, this);
    ...
    public void testEstimateNoInlierErrorNoRefinement() throws LockedException, NotReadyException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final MSACRobustRangingAndRssiRadioSourceEstimator2D<WifiAccessPoint> estimator =
                    new MSACRobustRangingAndRssiRadioSourceEstimator2D<>(readings, this);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    @Test
    public void testEstimateWithInlierErrorWithoutRefinement() throws LockedException, NotReadyException,
            RobustEstimatorException {
        final UniformRandomizer randomizer = new UniformRandomizer(new Random());
        final GaussianRandomizer errorRandomizer = new GaussianRandomizer(new Random(), 0.0, STD_OUTLIER_ERROR);
    ...
    public void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final MSACRobustRangingAndRssiRadioSourceEstimator2D<Beacon> estimator =
                    new MSACRobustRangingAndRssiRadioSourceEstimator2D<>(readings);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    public void onEstimateStart(final RobustRangingAndRssiRadioSourceEstimator<WifiAccessPoint, Point2D> estimator) {
        estimateStart++;
        checkLocked((MSACRobustRangingAndRssiRadioSourceEstimator2D<WifiAccessPoint>) estimator);
    }
    ...
    private void checkLocked(final MSACRobustRangingAndRssiRadioSourceEstimator2D<WifiAccessPoint> estimator) {
        try {
