...
public class MSACRobustRssiRadioSourceEstimator3DTest implements
        RobustRssiRadioSourceEstimatorListener<WifiAccessPoint, Point3D> {

    private static final Logger LOGGER = Logger.getLogger(MSACRobustRssiRadioSourceEstimator3DTest.class.getName());
    ...
    private static final double LARGE_POWER_ERROR = 2.0;
    ...
    public void testConstructor() {
        ...
        MSACRobustRssiRadioSourceEstimator3D<WifiAccessPoint> estimator = new MSACRobustRssiRadioSourceEstimator3D<>();
        ...
        estimator = new MSACRobustRssiRadioSourceEstimator3D<>(readings);
        ...
        estimator = null;
        try {
            estimator = new MSACRobustRssiRadioSourceEstimator3D<>((List<RssiReadingLocated3D<WifiAccessPoint>>) null);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new MSACRobustRssiRadioSourceEstimator3D<>(
        ...
        estimator = new MSACRobustRssiRadioSourceEstimator3D<>(this);
        ...
        estimator = new MSACRobustRssiRadioSourceEstimator3D<>(readings, this);
        ...
        final InhomogeneousPoint3D initialPosition = new InhomogeneousPoint3D(
                ...
                randomizer.nextDouble(MIN_POS, MAX_POS),
                randomizer.nextDouble(MIN_POS, MAX_POS));
        estimator = new MSACRobustRssiRadioSourceEstimator3D<>(readings, initialPosition);
        ...
        estimator = null;
        try {
            estimator = new MSACRobustRssiRadioSourceEstimator3D<>(null, initialPosition);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = new MSACRobustRssiRadioSourceEstimator3D<>(initialPosition);
        ...
        estimator = new MSACRobustRssiRadioSourceEstimator3D<>(initialPosition, this);
        ...
        estimator = new MSACRobustRssiRadioSourceEstimator3D<>(readings, initialPosition, this);
        ...
        estimator = null;
        try {
            estimator = new MSACRobustRssiRadioSourceEstimator3D<>(null, initialPosition, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = new MSACRobustRssiRadioSourceEstimator3D<>(MAX_RSSI);
        ...
        estimator = new MSACRobustRssiRadioSourceEstimator3D<>(readings, MAX_RSSI);
        ...
        estimator = new MSACRobustRssiRadioSourceEstimator3D<>(MAX_RSSI, this);
        ...
        estimator = new MSACRobustRssiRadioSourceEstimator3D<>(readings, MAX_RSSI, this);
        ...
        estimator = new MSACRobustRssiRadioSourceEstimator3D<>(readings, initialPosition, MAX_RSSI);
        ...
        estimator = null;
        try {
            estimator = new MSACRobustRssiRadioSourceEstimator3D<>(null, initialPosition, MAX_RSSI);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = new MSACRobustRssiRadioSourceEstimator3D<>(initialPosition, MAX_RSSI);
        ...
        estimator = new MSACRobustRssiRadioSourceEstimator3D<>(initialPosition, MAX_RSSI, this);
        ...
        // and listener
        estimator = new MSACRobustRssiRadioSourceEstimator3D<>(readings, initialPosition, MAX_RSSI, this);
        ...
        // test constructor with initial position and initial transmitted power
        estimator = new MSACRobustRssiRadioSourceEstimator3D<>(initialPosition, MAX_RSSI, MIN_PATH_LOSS_EXPONENT);
    ...
    public void testGetSetStopThreshold() throws LockedException {
        final MSACRobustRssiRadioSourceEstimator3D<WifiAccessPoint> estimator =
                new MSACRobustRssiRadioSourceEstimator3D<>();
    ...
    public void testEstimateNoInlierErrorNoRefinement() throws LockedException, NotReadyException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final MSACRobustRssiRadioSourceEstimator3D<WifiAccessPoint> estimator =
                    new MSACRobustRssiRadioSourceEstimator3D<>(readings, this);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    public void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (int t = 0; t < 10 * TIMES; t++) {
            ...
            final MSACRobustRssiRadioSourceEstimator3D<Beacon> estimator =
                    new MSACRobustRssiRadioSourceEstimator3D<>(readings);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
            ...
            assertEquals(estimator.getEstimatedTransmittedPowerdBm(),
                    estimatedBeacon.getTransmittedPower(), 0.0);
    ...
    public void onEstimateStart(final RobustRssiRadioSourceEstimator<WifiAccessPoint, Point3D> estimator) {
        estimateStart++;
        checkLocked((MSACRobustRssiRadioSourceEstimator3D<WifiAccessPoint>) estimator);
    }
    ...
    private void checkLocked(final MSACRobustRssiRadioSourceEstimator3D<WifiAccessPoint> estimator) {
        try {
