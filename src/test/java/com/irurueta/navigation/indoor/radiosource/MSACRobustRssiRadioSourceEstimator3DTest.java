...
class MSACRobustRssiRadioSourceEstimator3DTest implements
    ...
    void testConstructor() {
        ...
        var estimator = new MSACRobustRssiRadioSourceEstimator3D<WifiAccessPoint>();
        ...
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustRssiRadioSourceEstimator3D<>(
                (List<RssiReadingLocated3D<WifiAccessPoint>>) null));
        final var wrongReadings = new ArrayList<RssiReadingLocated3D<WifiAccessPoint>>();
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustRssiRadioSourceEstimator3D<>(wrongReadings));
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustRssiRadioSourceEstimator3D<>(null,
                initialPosition));
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustRssiRadioSourceEstimator3D<>(wrongReadings,
                initialPosition));
    ...
    void testGetSetStopThreshold() throws LockedException {
        final var estimator = new MSACRobustRssiRadioSourceEstimator3D<WifiAccessPoint>();
    ...
    void testEstimateNoInlierErrorNoRefinement() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new MSACRobustRssiRadioSourceEstimator3D<>(readings, this);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException, AlgebraException {
        ...
        for (var t = 0; t < 10 * TIMES; t++) {
            ...
            final var estimator = new MSACRobustRssiRadioSourceEstimator3D<>(readings);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    private static void checkLocked(final MSACRobustRssiRadioSourceEstimator3D<WifiAccessPoint> estimator) {
