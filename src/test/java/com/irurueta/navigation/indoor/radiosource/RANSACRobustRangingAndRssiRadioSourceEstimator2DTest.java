...
public class RANSACRobustRangingAndRssiRadioSourceEstimator2DTest implements
    ...
    public void testConstructor() {
        ...
        // check
        assertEquals(RANSACRobustRangingAndRssiRadioSourceEstimator2D.DEFAULT_THRESHOLD, estimator.getThreshold(),
                0.0);
        assertEquals(RANSACRobustRangingAndRssiRadioSourceEstimator2D.DEFAULT_COMPUTE_AND_KEEP_INLIERS,
                estimator.isComputeAndKeepInliersEnabled());
        assertEquals(RANSACRobustRangingAndRssiRadioSourceEstimator2D.DEFAULT_COMPUTE_AND_KEEP_RESIDUALS,
        ...
        estimator = new RANSACRobustRangingAndRssiRadioSourceEstimator2D<>(readings);
        ...
        estimator = new RANSACRobustRangingAndRssiRadioSourceEstimator2D<>(readings, this);
        ...
        final InhomogeneousPoint2D initialPosition = new InhomogeneousPoint2D(
                randomizer.nextDouble(MIN_POS, MAX_POS),
                randomizer.nextDouble(MIN_POS, MAX_POS));
        estimator = new RANSACRobustRangingAndRssiRadioSourceEstimator2D<>(readings, initialPosition);
        ...
        estimator = null;
        try {
            estimator = new RANSACRobustRangingAndRssiRadioSourceEstimator2D<>(null, initialPosition);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = new RANSACRobustRangingAndRssiRadioSourceEstimator2D<>(initialPosition);
        ...
        estimator = new RANSACRobustRangingAndRssiRadioSourceEstimator2D<>(initialPosition, this);
        ...
        estimator = new RANSACRobustRangingAndRssiRadioSourceEstimator2D<>(readings, initialPosition, this);
        ...
        estimator = new RANSACRobustRangingAndRssiRadioSourceEstimator2D<>(MAX_RSSI);
        ...
        estimator = new RANSACRobustRangingAndRssiRadioSourceEstimator2D<>(readings, MAX_RSSI);
        ...
        estimator = new RANSACRobustRangingAndRssiRadioSourceEstimator2D<>(MAX_RSSI, this);
        ...
        estimator = new RANSACRobustRangingAndRssiRadioSourceEstimator2D<>(readings, MAX_RSSI, this);
        ...
        estimator = new RANSACRobustRangingAndRssiRadioSourceEstimator2D<>(readings, initialPosition, MAX_RSSI);
        ...
        estimator = new RANSACRobustRangingAndRssiRadioSourceEstimator2D<>(initialPosition, MAX_RSSI);
        ...
        estimator = new RANSACRobustRangingAndRssiRadioSourceEstimator2D<>(initialPosition, MAX_RSSI, this);
        ...
        // check
        assertEquals(RANSACRobustRangingAndRssiRadioSourceEstimator2D.DEFAULT_THRESHOLD,
    ...
    public void testEstimateNoInlierErrorNoRefinementNoInlierDataAndNoResiduals() throws LockedException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final RANSACRobustRangingAndRssiRadioSourceEstimator2D<WifiAccessPoint> estimator =
                    new RANSACRobustRangingAndRssiRadioSourceEstimator2D<>(readings, this);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    public void testEstimateWithInlierErrorWithRefinementWithInlierDataAndWithResiduals() throws LockedException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            for (int i = 0; i < numReadings; i++) {
                ...
                readings.add(new RangingAndRssiReadingLocated2D<>(accessPoint,
                        distance, rssi + error, readingsPositions[i], INLIER_ERROR_STD, INLIER_ERROR_STD));
            }
    ...
    public void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final RANSACRobustRangingAndRssiRadioSourceEstimator2D<Beacon> estimator =
                    new RANSACRobustRangingAndRssiRadioSourceEstimator2D<>(readings);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    private void checkLocked(final RANSACRobustRangingAndRssiRadioSourceEstimator2D<WifiAccessPoint> estimator) {
        try {
