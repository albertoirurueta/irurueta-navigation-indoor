...
public class LMedSRobustRangingRadioSourceEstimator3DTest implements
    ...
    public void testConstructor() {
        ...
        assertEquals(LMedSRobustRangingRadioSourceEstimator3D.DEFAULT_STOP_THRESHOLD,
        ...
        estimator = null;
        try {
            estimator = new LMedSRobustRangingRadioSourceEstimator3D<>(null, initialPosition);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = null;
        try {
            estimator = new LMedSRobustRangingRadioSourceEstimator3D<>(null, initialPosition, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
    ...
    public void testEstimateNoInlierErrorNoRefinement() throws LockedException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final LMedSRobustRangingRadioSourceEstimator3D<WifiAccessPoint> estimator =
                    new LMedSRobustRangingRadioSourceEstimator3D<>(readings, this);
    ...
    public void testEstimateNoInlierErrorWithInitialPositionAndRefinement() throws LockedException, NotReadyException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final LMedSRobustRangingRadioSourceEstimator3D<WifiAccessPoint> estimator =
                    new LMedSRobustRangingRadioSourceEstimator3D<>(readings, accessPointPosition, this);
    ...
    public void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final LMedSRobustRangingRadioSourceEstimator3D<Beacon> estimator =
    ...
    private void checkLocked(final LMedSRobustRangingRadioSourceEstimator3D<WifiAccessPoint> estimator) {
        try {
            estimator.setPreliminarySubsetSize(3);
