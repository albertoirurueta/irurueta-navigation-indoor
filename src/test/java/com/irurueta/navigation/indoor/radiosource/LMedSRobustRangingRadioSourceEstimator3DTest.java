...
class LMedSRobustRangingRadioSourceEstimator3DTest implements
        RobustRangingRadioSourceEstimatorListener<WifiAccessPoint, Point3D> {

    private static final Logger LOGGER = Logger.getLogger(LMedSRobustRangingRadioSourceEstimator3DTest.class.getName());
    ...
    void testConstructor() {
        ...
        var estimator = new LMedSRobustRangingRadioSourceEstimator3D<WifiAccessPoint>();

        // check default values
        assertEquals(LMedSRobustRangingRadioSourceEstimator3D.DEFAULT_STOP_THRESHOLD, estimator.getStopThreshold(),
                0.0);
        ...
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustRangingRadioSourceEstimator3D<>(
        ...
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustRangingRadioSourceEstimator3D<>(wrongReadings,
                this));
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustRangingRadioSourceEstimator3D<>(null,
                initialPosition));
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustRangingRadioSourceEstimator3D<>(wrongReadings,
                initialPosition));

        // test constructor with initial position and listener
        estimator = new LMedSRobustRangingRadioSourceEstimator3D<>(initialPosition, this);
        ...
        estimator = new LMedSRobustRangingRadioSourceEstimator3D<>(readings, initialPosition, this);
    ...
    void testEstimateNoInlierErrorNoRefinement() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new LMedSRobustRangingRadioSourceEstimator3D<>(readings, this);
    ...
    void testEstimateNoInlierErrorWithInitialPositionAndRefinement() throws LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new LMedSRobustRangingRadioSourceEstimator3D<>(readings, accessPointPosition,
                    this);
    ...
    void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new LMedSRobustRangingRadioSourceEstimator3D<Beacon>(readings);
    ...
    private static void checkLocked(final LMedSRobustRangingRadioSourceEstimator3D<WifiAccessPoint> estimator) {
