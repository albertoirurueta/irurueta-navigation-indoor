...
public class PROMedSRobustRangingAndRssiRadioSourceEstimator2DTest implements
    ...
    public void testConstructor() {
        ...
        PROMedSRobustRangingAndRssiRadioSourceEstimator2D<WifiAccessPoint> estimator =
                new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>();

        // check
        assertEquals(PROMedSRobustRangingAndRssiRadioSourceEstimator2D.DEFAULT_STOP_THRESHOLD,
        ...
        estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>(readings);
        ...
        estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>(readings, this);
        ...
        final InhomogeneousPoint2D initialPosition = new InhomogeneousPoint2D(
                randomizer.nextDouble(MIN_POS, MAX_POS),
                randomizer.nextDouble(MIN_POS, MAX_POS));
        estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>(readings, initialPosition);
        ...
        estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>(initialPosition);
        ...
        estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>(initialPosition, this);
        ...
        estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>(readings, initialPosition, this);
        ...
        estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>(MAX_RSSI);
        ...
        estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>(readings, MAX_RSSI);
        ...
        estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>(MAX_RSSI, this);
        ...
        estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>(readings, MAX_RSSI, this);
        ...
        estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>(readings, initialPosition, MAX_RSSI);
        ...
        estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>(initialPosition, MAX_RSSI);
        ...
        estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>(initialPosition, MAX_RSSI, this);
        ...
        estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>(qualityScores);
        ...
        estimator = null;
        try {
            estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>((double[]) null);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>(new double[1]);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
        ...
        estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>(qualityScores, readings);
        ...
        estimator = null;
        try {
            estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>(null, readings);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>(new double[1], readings);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>(qualityScores, this);
        ...
        estimator = null;
        try {
            estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>((double[]) null, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>(new double[1], this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
        ...
        estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>(qualityScores, readings, this);
        ...
        try {
            estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>(new double[1], readings, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>(qualityScores, readings, initialPosition);
        ...
        estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>(qualityScores, initialPosition);
        ...
        estimator = null;
        try {
            estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>((double[]) null, initialPosition);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>(new double[1], initialPosition);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
        ...
        estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>(qualityScores, MAX_RSSI);
        ...
        estimator = null;
        try {
            estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>((double[]) null, MAX_RSSI);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>(new double[1], MAX_RSSI);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
        ...
        estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>(qualityScores, readings, MAX_RSSI);
        ...
        estimator = null;
        try {
            estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>(null, readings, MAX_RSSI);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>(new double[1], readings, MAX_RSSI);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>(qualityScores, MAX_RSSI, this);
        ...
        estimator = new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>(qualityScores, initialPosition, MAX_RSSI);
    ...
    public void testGetSetStopThreshold() throws LockedException {
        final PROMedSRobustRangingAndRssiRadioSourceEstimator2D<WifiAccessPoint> estimator =
                new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>();
    ...
    public void testEstimateNoInlierErrorNoRefinement()
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final PROMedSRobustRangingAndRssiRadioSourceEstimator2D<WifiAccessPoint> estimator =
                    new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>(qualityScores, readings, this);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    public void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final PROMedSRobustRangingAndRssiRadioSourceEstimator2D<Beacon> estimator =
                    new PROMedSRobustRangingAndRssiRadioSourceEstimator2D<>(qualityScores, readings);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    public void onEstimateStart(final RobustRangingAndRssiRadioSourceEstimator<WifiAccessPoint, Point2D> estimator) {
        estimateStart++;
        checkLocked((PROMedSRobustRangingAndRssiRadioSourceEstimator2D<WifiAccessPoint>) estimator);
    }
    ...
    private void checkLocked(final PROMedSRobustRangingAndRssiRadioSourceEstimator2D<WifiAccessPoint> estimator) {
        try {
