...
class RANSACRobustRssiRadioSourceEstimator2DTest implements
        RobustRssiRadioSourceEstimatorListener<WifiAccessPoint, Point2D> {

    private static final Logger LOGGER = Logger.getLogger(RANSACRobustRssiRadioSourceEstimator2DTest.class.getName());
    ...
    void testConstructor() {
        ...
        var estimator = new RANSACRobustRssiRadioSourceEstimator2D<WifiAccessPoint>();

        // check
        assertEquals(RANSACRobustRssiRadioSourceEstimator2D.DEFAULT_THRESHOLD, estimator.getThreshold(), 0.0);
        assertEquals(RANSACRobustRssiRadioSourceEstimator2D.DEFAULT_COMPUTE_AND_KEEP_INLIERS,
                estimator.isComputeAndKeepInliersEnabled());
        assertEquals(RANSACRobustRssiRadioSourceEstimator2D.DEFAULT_COMPUTE_AND_KEEP_RESIDUALS,
        ...
        estimator = new RANSACRobustRssiRadioSourceEstimator2D<>(readings);
        ...
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustRssiRadioSourceEstimator2D<>(
                (List<RssiReadingLocated2D<WifiAccessPoint>>) null));
        final var wrongReadings = new ArrayList<RssiReadingLocated2D<WifiAccessPoint>>();
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustRssiRadioSourceEstimator2D<>(wrongReadings));
        ...
        estimator = new RANSACRobustRssiRadioSourceEstimator2D<>(readings, this);
        ...
        estimator = new RANSACRobustRssiRadioSourceEstimator2D<>(readings, initialPosition);
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustRssiRadioSourceEstimator2D<>(null,
                initialPosition));
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustRssiRadioSourceEstimator2D<>(wrongReadings,
                initialPosition));

        // test constructor with initial position
        estimator = new RANSACRobustRssiRadioSourceEstimator2D<>(initialPosition);
        ...
        estimator = new RANSACRobustRssiRadioSourceEstimator2D<>(initialPosition, this);
        ...
        estimator = new RANSACRobustRssiRadioSourceEstimator2D<>(readings, initialPosition, this);
        ...
        estimator = new RANSACRobustRssiRadioSourceEstimator2D<>(MAX_RSSI);
        ...
        estimator = new RANSACRobustRssiRadioSourceEstimator2D<>(readings, MAX_RSSI);
        ...
        estimator = new RANSACRobustRssiRadioSourceEstimator2D<>(MAX_RSSI, this);
        ...
        estimator = new RANSACRobustRssiRadioSourceEstimator2D<>(readings, MAX_RSSI, this);
        ...
        estimator = new RANSACRobustRssiRadioSourceEstimator2D<>(readings, initialPosition, MAX_RSSI);
        ...
        estimator = new RANSACRobustRssiRadioSourceEstimator2D<>(initialPosition, MAX_RSSI);
        ...
        estimator = new RANSACRobustRssiRadioSourceEstimator2D<>(initialPosition, MAX_RSSI, this);
        ...
        // power and listener
        estimator = new RANSACRobustRssiRadioSourceEstimator2D<>(readings, initialPosition, MAX_RSSI, this);
        ...
        estimator = new RANSACRobustRssiRadioSourceEstimator2D<>(initialPosition, MAX_RSSI, MIN_PATH_LOSS_EXPONENT);
    ...
    void testGetSetThreshold() throws LockedException {
        final var estimator = new RANSACRobustRssiRadioSourceEstimator2D<WifiAccessPoint>();
    ...
    void testEstimateNoInlierErrorNoRefinementNoInlierDataAndNoResiduals() throws LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new RANSACRobustRssiRadioSourceEstimator2D<>(readings, this);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    void testEstimateNoInlierErrorNoRefinementWithInlierDataAndWithResiduals() throws LockedException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new RANSACRobustRssiRadioSourceEstimator2D<WifiAccessPoint>(readings, this);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    void testEstimateWithInlierErrorWithInitialPositionAndPower() throws LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            positionError = estimator.getEstimatedPosition().distanceTo(accessPointPosition);
            if (positionError > LARGE_POWER_ERROR) {
                continue;
            }
    ...
    void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException, AlgebraException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new RANSACRobustRssiRadioSourceEstimator2D<>(readings);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    private static void checkLocked(final RANSACRobustRssiRadioSourceEstimator2D<WifiAccessPoint> estimator) {
