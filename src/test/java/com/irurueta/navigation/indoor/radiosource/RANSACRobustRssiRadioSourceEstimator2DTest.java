...
public class RANSACRobustRssiRadioSourceEstimator2DTest implements
    ...
    public void testConstructor() {
        ...
        estimator = null;
        try {
            estimator = new RANSACRobustRssiRadioSourceEstimator2D<>(null, initialPosition);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = null;
        try {
            estimator = new RANSACRobustRssiRadioSourceEstimator2D<>(null, initialPosition, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = null;
        try {
            estimator = new RANSACRobustRssiRadioSourceEstimator2D<>(null, initialPosition, MAX_RSSI);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
    ...
    public void testGetSetThreshold() throws LockedException {
        final RANSACRobustRssiRadioSourceEstimator2D<WifiAccessPoint> estimator =
                new RANSACRobustRssiRadioSourceEstimator2D<>();

        // check default value
        assertEquals(RANSACRobustRssiRadioSourceEstimator2D.DEFAULT_THRESHOLD, estimator.getThreshold(),
                0.0);
    ...
    public void testEstimateNoInlierErrorNoRefinementNoInlierDataAndNoResiduals() throws LockedException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final RANSACRobustRssiRadioSourceEstimator2D<WifiAccessPoint> estimator =
                    new RANSACRobustRssiRadioSourceEstimator2D<>(readings, this);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    public void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final RANSACRobustRssiRadioSourceEstimator2D<Beacon> estimator =
                    new RANSACRobustRssiRadioSourceEstimator2D<>(readings);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    private void checkLocked(final RANSACRobustRssiRadioSourceEstimator2D<WifiAccessPoint> estimator) {
        try {
