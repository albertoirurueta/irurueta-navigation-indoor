...
class MSACRobustRangingRadioSourceEstimator2DTest implements
        RobustRangingRadioSourceEstimatorListener<WifiAccessPoint, Point2D> {

    private static final Logger LOGGER = Logger.getLogger(MSACRobustRangingRadioSourceEstimator2DTest.class.getName());
    ...
    void testConstructor() {
        ...
        var estimator = new MSACRobustRangingRadioSourceEstimator2D<WifiAccessPoint>();

        // check default values
        assertEquals(MSACRobustRangingRadioSourceEstimator2D.DEFAULT_THRESHOLD, estimator.getThreshold(), 0.0);
        ...
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustRangingRadioSourceEstimator2D<>(
        ...
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustRangingRadioSourceEstimator2D<>(wrongReadings,
                this));
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustRangingRadioSourceEstimator2D<>(null,
                initialPosition));
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustRangingRadioSourceEstimator2D<>(wrongReadings,
                initialPosition));

        // test constructor with initial position and listener
        estimator = new MSACRobustRangingRadioSourceEstimator2D<>(initialPosition, this);
        ...
        estimator = new MSACRobustRangingRadioSourceEstimator2D<>(readings, initialPosition, this);
    ...
    void testGetSetThreshold() throws LockedException {
        final var estimator = new MSACRobustRangingRadioSourceEstimator2D<WifiAccessPoint>();
    ...
    void testAreValidReadings() {
        ...
        final var wrongReadings = new ArrayList<RangingReadingLocated<WifiAccessPoint, Point2D>>();
    ...
    void testEstimateNoInlierErrorNoRefinement() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new MSACRobustRangingRadioSourceEstimator2D<>(readings, this);
    ...
    void testEstimateNoInlierErrorWithInitialPositionAndRefinement() throws LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new MSACRobustRangingRadioSourceEstimator2D<>(readings, accessPointPosition,
                    this);
    ...
    void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new MSACRobustRangingRadioSourceEstimator2D<>(readings);
    ...
    void testEstimateWithStandardDeviationsAndPositionCovariance() throws LockedException, NotReadyException,
        ...
        // force NotReadyException
        final var estimator = new LMedSRobustRangingRadioSourceEstimator2D<WifiAccessPoint>();
        assertThrows(NotReadyException.class, estimator::estimate);
    }
    ...
    void testEstimateLargerPreliminarySubsetSize() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        // force NotReadyException
        final var estimator = new MSACRobustRangingRadioSourceEstimator2D<>();
        assertThrows(NotReadyException.class, estimator::estimate);
    }
    ...
    private static void checkLocked(final MSACRobustRangingRadioSourceEstimator2D<WifiAccessPoint> estimator) {
