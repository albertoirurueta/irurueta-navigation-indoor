...
public class MSACRobustRangingRadioSourceEstimator2DTest implements
    ...
    public void testConstructor() {
        ...
        estimator = null;
        try {
            estimator = new MSACRobustRangingRadioSourceEstimator2D<>(null, initialPosition);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        // check default values
        assertEquals(MSACRobustRangingRadioSourceEstimator2D.DEFAULT_THRESHOLD,
        ...
        estimator = null;
        try {
            estimator = new MSACRobustRangingRadioSourceEstimator2D<>(null, initialPosition, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
    ...
    public void testEstimateNoInlierErrorNoRefinement() throws LockedException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final MSACRobustRangingRadioSourceEstimator2D<WifiAccessPoint> estimator =
                    new MSACRobustRangingRadioSourceEstimator2D<>(readings, this);
    ...
    public void testEstimateNoInlierErrorWithInitialPositionAndRefinement() throws LockedException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final MSACRobustRangingRadioSourceEstimator2D<WifiAccessPoint> estimator =
                    new MSACRobustRangingRadioSourceEstimator2D<>(readings, accessPointPosition, this);
