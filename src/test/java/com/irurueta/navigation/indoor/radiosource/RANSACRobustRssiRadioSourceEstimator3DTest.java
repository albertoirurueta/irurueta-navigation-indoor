...
class RANSACRobustRssiRadioSourceEstimator3DTest implements
    ...
    void testConstructor() {
        ...
        var estimator = new RANSACRobustRssiRadioSourceEstimator3D<WifiAccessPoint>();
        ...
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustRssiRadioSourceEstimator3D<>(
        ...
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustRssiRadioSourceEstimator3D<>(wrongReadings,
                this));
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustRssiRadioSourceEstimator3D<>(null,
                initialPosition));
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustRssiRadioSourceEstimator3D<>(wrongReadings,
                initialPosition));
    ...
    void testGetSetThreshold() throws LockedException {
        final var estimator = new RANSACRobustRssiRadioSourceEstimator3D<WifiAccessPoint>();
    ...
    void testEstimateNoInlierErrorNoRefinementNoInlierDataAndNoResiduals() throws LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new RANSACRobustRssiRadioSourceEstimator3D<>(readings, this);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException, AlgebraException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new RANSACRobustRssiRadioSourceEstimator3D<>(readings);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    private static void checkLocked(final RANSACRobustRssiRadioSourceEstimator3D<WifiAccessPoint> estimator) {
