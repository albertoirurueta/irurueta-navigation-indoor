...
public class RANSACRobustRssiRadioSourceEstimator3DTest implements
        RobustRssiRadioSourceEstimatorListener<WifiAccessPoint, Point3D> {

    private static final Logger LOGGER = Logger.getLogger(RANSACRobustRssiRadioSourceEstimator3DTest.class.getName());
    ...
    public void testConstructor() {
        ...
        RANSACRobustRssiRadioSourceEstimator3D<WifiAccessPoint> estimator =
                new RANSACRobustRssiRadioSourceEstimator3D<>();

        // check
        assertEquals(RANSACRobustRssiRadioSourceEstimator3D.DEFAULT_THRESHOLD, estimator.getThreshold(), 0.0);
        assertEquals(RANSACRobustRssiRadioSourceEstimator3D.DEFAULT_COMPUTE_AND_KEEP_INLIERS,
                estimator.isComputeAndKeepInliersEnabled());
        assertEquals(RANSACRobustRssiRadioSourceEstimator3D.DEFAULT_COMPUTE_AND_KEEP_RESIDUALS,
        ...
        estimator = new RANSACRobustRssiRadioSourceEstimator3D<>(readings);
        ...
        estimator = null;
        try {
            estimator = new RANSACRobustRssiRadioSourceEstimator3D<>(
        ...
        estimator = new RANSACRobustRssiRadioSourceEstimator3D<>(this);
        ...
        estimator = new RANSACRobustRssiRadioSourceEstimator3D<>(readings, this);
        ...
        final InhomogeneousPoint3D initialPosition = new InhomogeneousPoint3D(
                ...
                randomizer.nextDouble(MIN_POS, MAX_POS),
                randomizer.nextDouble(MIN_POS, MAX_POS));
        estimator = new RANSACRobustRssiRadioSourceEstimator3D<>(readings, initialPosition);
        ...
        estimator = null;
        try {
            estimator = new RANSACRobustRssiRadioSourceEstimator3D<>(null, initialPosition);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = new RANSACRobustRssiRadioSourceEstimator3D<>(initialPosition);
        ...
        estimator = new RANSACRobustRssiRadioSourceEstimator3D<>(initialPosition, this);
        ...
        estimator = new RANSACRobustRssiRadioSourceEstimator3D<>(readings, initialPosition, this);
        ...
        estimator = null;
        try {
            estimator = new RANSACRobustRssiRadioSourceEstimator3D<>(null, initialPosition, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = new RANSACRobustRssiRadioSourceEstimator3D<>(MAX_RSSI);
        ...
        estimator = new RANSACRobustRssiRadioSourceEstimator3D<>(readings, MAX_RSSI);
        ...
        estimator = new RANSACRobustRssiRadioSourceEstimator3D<>(MAX_RSSI, this);
        ...
        estimator = new RANSACRobustRssiRadioSourceEstimator3D<>(readings, MAX_RSSI, this);
        ...
        estimator = new RANSACRobustRssiRadioSourceEstimator3D<>(readings, initialPosition, MAX_RSSI);
        ...
        estimator = null;
        try {
            estimator = new RANSACRobustRssiRadioSourceEstimator3D<>(null, initialPosition, MAX_RSSI);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = new RANSACRobustRssiRadioSourceEstimator3D<>(initialPosition, MAX_RSSI);
        ...
        estimator = new RANSACRobustRssiRadioSourceEstimator3D<>(initialPosition, MAX_RSSI, this);
        ...
        // power and listener
        estimator = new RANSACRobustRssiRadioSourceEstimator3D<>(readings, initialPosition, MAX_RSSI, this);
        ...
        estimator = new RANSACRobustRssiRadioSourceEstimator3D<>(initialPosition, MAX_RSSI, MIN_PATH_LOSS_EXPONENT);
    ...
    public void testGetSetThreshold() throws LockedException {
        final RANSACRobustRssiRadioSourceEstimator3D<WifiAccessPoint> estimator =
                new RANSACRobustRssiRadioSourceEstimator3D<>();
    ...
    public void testIsSetComputeAndKeepInliersEnabled() throws LockedException {
        ...
        estimator.setComputeAndKeepInliersEnabled(
                !RANSACRobustRssiRadioSourceEstimator3D.DEFAULT_COMPUTE_AND_KEEP_INLIERS);
    ...
    public void testIsSetComputeAndKeepResidualsEnabled() throws LockedException {
        ...
        estimator.setComputeAndKeepResidualsEnabled(
                !RANSACRobustRssiRadioSourceEstimator3D.DEFAULT_COMPUTE_AND_KEEP_RESIDUALS);
    ...
    public void testGetSetConfidence() throws LockedException {
        ...
        // check default value
        assertEquals(RobustRssiRadioSourceEstimator.DEFAULT_CONFIDENCE, estimator.getConfidence(),
                0.0);
    ...
    public void testEstimateNoInlierErrorNoRefinementNoInlierDataAndNoResiduals()
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final RANSACRobustRssiRadioSourceEstimator3D<WifiAccessPoint> estimator =
                    new RANSACRobustRssiRadioSourceEstimator3D<>(readings, this);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    public void testEstimateBeacon() throws LockedException, NotReadyException, RobustEstimatorException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final RANSACRobustRssiRadioSourceEstimator3D<Beacon> estimator =
                    new RANSACRobustRssiRadioSourceEstimator3D<>(readings);
            estimator.setPositionEstimationEnabled(true);
            estimator.setTransmittedPowerEstimationEnabled(true);
            estimator.setPathLossEstimationEnabled(false);
    ...
    public void onEstimateStart(final RobustRssiRadioSourceEstimator<WifiAccessPoint, Point3D> estimator) {
        estimateStart++;
        checkLocked((RANSACRobustRssiRadioSourceEstimator3D<WifiAccessPoint>) estimator);
    }
    ...
    private void checkLocked(final RANSACRobustRssiRadioSourceEstimator3D<WifiAccessPoint> estimator) {
        try {
