...
public class RangingReadingLocated2DTest {
    ...
    public void testConstructor() throws AlgebraException {
        ...
        reading = null;
        try {
            reading = new RangingReadingLocated2D<>(null, 1.5, position, 0.1);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            reading = new RangingReadingLocated2D<>(ap, -1.0, position, 0.1);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            reading = new RangingReadingLocated2D<>(ap, 1.5, null, 0.1);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            reading = new RangingReadingLocated2D<>(ap, 1.5, position, 0.0);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(reading);
        ...
        reading = null;
        try {
            reading = new RangingReadingLocated2D<>(null, 2.0, position, cov);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            reading = new RangingReadingLocated2D<>(ap, -1.0, position, cov);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            reading = new RangingReadingLocated2D<>(ap, 2.0, null, cov);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            reading = new RangingReadingLocated2D<>(ap, 2.0, position, new Matrix(1, 1));
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            reading = new RangingReadingLocated2D<>(ap, 2.0, position, new Matrix(2, 1));
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(reading);
        ...
        reading = null;
        try {
            reading = new RangingReadingLocated2D<>(null, 2.5, position, 0.2,
                    cov);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            reading = new RangingReadingLocated2D<>(ap, -1.0, position, 0.2, cov);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            reading = new RangingReadingLocated2D<>(ap, 2.5, null, 0.2, cov);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            reading = new RangingReadingLocated2D<>(ap, 2.5, position, 0.0, cov);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
    ...
    public void testSerializeDeserialize() throws WrongSizeException, IOException, ClassNotFoundException {
        ...
        final RangingReadingLocated2D<WifiAccessPoint> reading1 =
                new RangingReadingLocated2D<>(ap, 2.5, position, 0.2, cov,
                        8, 7);
        ...
        final RangingReadingLocated2D<WifiAccessPoint> reading2 = SerializationHelper.deserialize(bytes);
