...
class RangingReadingLocated2DTest {
    ...
    void testConstructor() throws AlgebraException {
        ...
        var reading = new RangingReadingLocated2D<WifiAccessPoint>();
        ...
        assertThrows(IllegalArgumentException.class, () -> new RangingReadingLocated2D<>(null, 1.2,
                position));
        assertThrows(IllegalArgumentException.class, () -> new RangingReadingLocated2D<>(ap, -1.0, position));
        assertThrows(IllegalArgumentException.class, () -> new RangingReadingLocated2D<>(ap, 1.2,
                null));

        // test constructor with access point, distance, position and number of measurements.
        reading = new RangingReadingLocated2D<>(ap, 1.2, position, 8,
                7);
        ...
        assertThrows(IllegalArgumentException.class, () -> new RangingReadingLocated2D<>(ap, -1.0, position,
                8, 7));
        assertThrows(IllegalArgumentException.class, () -> new RangingReadingLocated2D<>(ap, 1.2, null,
                8, 7));
        assertThrows(IllegalArgumentException.class, () -> new RangingReadingLocated2D<>(ap, 1.2, position,
                0, 7));
        assertThrows(IllegalArgumentException.class, () -> new RangingReadingLocated2D<>(ap, 1.2, position,
                8, -1));

        // test constructor with access point, distance, position and distance standard deviation
        reading = new RangingReadingLocated2D<>(ap, 1.5, position, 0.1);
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new RangingReadingLocated2D<>(null, 1.5,
                position, 0.1));
        assertThrows(IllegalArgumentException.class, () -> new RangingReadingLocated2D<>(ap, -1.0, position,
                0.1));
        assertThrows(IllegalArgumentException.class, () -> new RangingReadingLocated2D<>(ap, 1.5, null,
                0.1));
        assertThrows(IllegalArgumentException.class, () -> new RangingReadingLocated2D<>(ap, 1.5, position,
                0.0));
        ...
        reading = new RangingReadingLocated2D<>(ap, 2.0, position, (Matrix) null);
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new RangingReadingLocated2D<>(null, 2.0,
                position, cov));
        assertThrows(IllegalArgumentException.class, () -> new RangingReadingLocated2D<>(ap, -1.0, position,
                cov));
        assertThrows(IllegalArgumentException.class, () -> new RangingReadingLocated2D<>(ap, 2.0, null,
                cov));
        final var m1 = new Matrix(1, 1);
        assertThrows(IllegalArgumentException.class, () -> new RangingReadingLocated2D<>(ap, 2.0, position,
                m1));
        final var m2 = new Matrix(2, 1);
        assertThrows(IllegalArgumentException.class, () -> new RangingReadingLocated2D<>(ap, 2.0, position,
                m2));

        // test constructor with access point, distance, position, position covariance and number of measurements.
        reading = new RangingReadingLocated2D<>(ap, 2.0, position, cov, 8,
                7);
        ...
        assertThrows(IllegalArgumentException.class, () -> new RangingReadingLocated2D<>(ap, 2.0, position,
                m2, 8, 7));
        assertThrows(IllegalArgumentException.class, () -> new RangingReadingLocated2D<>(ap, 2.0, position, cov,
                0, 7));
        assertThrows(IllegalArgumentException.class, () -> new RangingReadingLocated2D<>(ap, 2.0, position, cov,
                8, -1));
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new RangingReadingLocated2D<>(null, 2.5,
                position, 0.2, cov));
        assertThrows(IllegalArgumentException.class, () -> new RangingReadingLocated2D<>(ap, -1.0, position,
                0.2, cov));
        assertThrows(IllegalArgumentException.class, () -> new RangingReadingLocated2D<>(ap, 2.5, null,
                0.2, cov));
        assertThrows(IllegalArgumentException.class, () -> new RangingReadingLocated2D<>(ap, 2.5, position,
                0.0, cov));
        assertThrows(IllegalArgumentException.class, () -> new RangingReadingLocated2D<>(ap, 2.5, position,
                0.2, m1));
        assertThrows(IllegalArgumentException.class, () -> new RangingReadingLocated2D<>(ap, 2.5, position,
    ...
    void testHasSameAccessPoint() {
        ...
        final var reading1 = new RangingReadingLocated2D<>(ap1, 50.0, position);
        final var reading2 = new RangingReadingLocated2D<>(ap1, 50.0, position);
        final var reading3 = new RangingReadingLocated2D<>(ap2, 50.0, position);
    ...
    void testSerializeDeserialize() throws WrongSizeException, IOException, ClassNotFoundException {
        ...
        final var position = new InhomogeneousPoint2D();
        final var cov = new Matrix(2, 2);
        final var reading1 = new RangingReadingLocated2D<>(ap, 2.5, position, 0.2, cov,
                8, 7);
        ...
        final var reading2 = SerializationHelper.<RangingReadingLocated2D<WifiAccessPoint>>deserialize(bytes);
