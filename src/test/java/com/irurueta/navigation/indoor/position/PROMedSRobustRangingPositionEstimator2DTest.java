...
class PROMedSRobustRangingPositionEstimator2DTest implements RobustRangingPositionEstimatorListener<Point2D> {

    private static final Logger LOGGER = Logger.getLogger(PROMedSRobustRangingPositionEstimator2DTest.class.getName());
    ...
    void testConstructor() {
        // empty constructor
        var estimator = new PROMedSRobustRangingPositionEstimator2D();
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustRangingPositionEstimator2D(
                (List<WifiAccessPointLocated2D>) null));
        final var wrongSources = new ArrayList<WifiAccessPointLocated2D>();
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustRangingPositionEstimator2D(wrongSources));
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustRangingPositionEstimator2D(null,
                fingerprint));
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustRangingPositionEstimator2D(wrongSources,
                fingerprint));
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustRangingPositionEstimator2D(sources,
                (RangingFingerprint<WifiAccessPoint, RangingReading<WifiAccessPoint>>) null));
        ...
        estimator = new PROMedSRobustRangingPositionEstimator2D(sourceQualityScores, fingerprintReadingsQualityScores);
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustRangingPositionEstimator2D(new double[1],
    ...
    void testGetSetStopThreshold() throws LockedException {
        final var estimator = new PROMedSRobustRangingPositionEstimator2D();
    ...
    void testGetSetInitialPosition() throws LockedException {
        final var solver = new PROMedSRobustRangingPositionEstimator2D();
    ...
    void testGetSetPreliminarySubsetSize() throws LockedException {
        final var estimator = spy(new PROMedSRobustRangingPositionEstimator2D());
    ...
    void testEstimate() throws LockedException, RobustEstimatorException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new PROMedSRobustRangingPositionEstimator2D(sourceQualityScores,
                    fingerprintReadingsQualityScores, sources, fingerprint, this);
    ...
    private static void checkLocked(final PROMedSRobustRangingPositionEstimator2D estimator) {
