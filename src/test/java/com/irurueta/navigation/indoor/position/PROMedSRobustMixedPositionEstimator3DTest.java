...
public class PROMedSRobustMixedPositionEstimator3DTest implements
    ...
    public void testConstructor() {
        // empty constructor
        PROMedSRobustMixedPositionEstimator3D estimator =
        ...
        estimator = null;
        try {
            estimator = new PROMedSRobustMixedPositionEstimator3D(null,
                    fingerprint);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
    ...
    public void testGetSetInitialPosition() throws LockedException {
        final PROMedSRobustMixedPositionEstimator3D solver =
                new PROMedSRobustMixedPositionEstimator3D();
    ...
    private double receivedPower(final double equivalentTransmittedPower,
        ...
        final double k = Math.pow(SPEED_OF_LIGHT / (4.0 * Math.PI *
                        PROMedSRobustMixedPositionEstimator3DTest.FREQUENCY),
                pathLossExponent);
