...
class LinearRssiPositionEstimator3DTest implements RssiPositionEstimatorListener<Point3D> {
    ...
    void testConstructor() {
        // empty constructor
        var estimator = new LinearRssiPositionEstimator3D();
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new LinearRssiPositionEstimator3D((List<WifiAccessPointLocated3D>) null));
        final var wrongSources = new ArrayList<WifiAccessPointLocated3D>();
        assertThrows(IllegalArgumentException.class, () -> new LinearRssiPositionEstimator3D(wrongSources));
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new LinearRssiPositionEstimator3D(
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new LinearRssiPositionEstimator3D(null,
                fingerprint));
        assertThrows(IllegalArgumentException.class, () -> new LinearRssiPositionEstimator3D(wrongSources,
                fingerprint));
        assertThrows(IllegalArgumentException.class, () -> new LinearRssiPositionEstimator3D(sources,
                (RssiFingerprint<WifiAccessPoint, RssiReading<WifiAccessPoint>>) null));
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new LinearRssiPositionEstimator3D(null, fingerprint,
                this));
        assertThrows(IllegalArgumentException.class, () -> new LinearRssiPositionEstimator3D(wrongSources, fingerprint,
                this));
        assertThrows(IllegalArgumentException.class, () -> new LinearRssiPositionEstimator3D(sources, null,
                this));
    }

    @Test
    void testGetSetSources() throws LockedException {
        final var estimator = new LinearRssiPositionEstimator3D();
    ...
    void testEstimateNoErrorHomogeneous() throws LockedException, NotReadyException, PositionEstimationException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new LinearRssiPositionEstimator3D(sources, fingerprint, this);
    ...
    private static void checkLocked(final LinearRssiPositionEstimator3D estimators) {
