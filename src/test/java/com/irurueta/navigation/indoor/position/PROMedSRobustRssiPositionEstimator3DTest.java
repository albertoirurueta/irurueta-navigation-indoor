...
public class PROMedSRobustRssiPositionEstimator3DTest implements
    ...
    public void testConstructor() {
        // empty constructor
        PROMedSRobustRssiPositionEstimator3D estimator = new PROMedSRobustRssiPositionEstimator3D();
        ...
        estimator = null;
        try {
            estimator = new PROMedSRobustRssiPositionEstimator3D((List<WifiAccessPointLocated3D>) null);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new PROMedSRobustRssiPositionEstimator3D(new ArrayList<WifiAccessPointLocated3D>());
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        ...
        estimator = null;
        try {
            estimator = new PROMedSRobustRssiPositionEstimator3D(
        ...
        estimator = null;
        try {
            estimator = new PROMedSRobustRssiPositionEstimator3D(null, fingerprint);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = null;
        try {
            estimator = new PROMedSRobustRssiPositionEstimator3D(null, fingerprint, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        try {
            estimator = new PROMedSRobustRssiPositionEstimator3D(sources, null, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
        ...
        try {
            estimator = new PROMedSRobustRssiPositionEstimator3D(new double[1],
                    fingerprintReadingsQualityScores);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        ...
        estimator = null;
        try {
            estimator = new PROMedSRobustRssiPositionEstimator3D(null,
                    fingerprintReadingsQualityScores, sources);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
    ...
    public void testGetSetStopThreshold() throws LockedException {
        final PROMedSRobustRssiPositionEstimator3D estimator = new PROMedSRobustRssiPositionEstimator3D();
    ...
    public void testGetSetPreliminarySubsetSize() throws LockedException {
        final PROMedSRobustRssiPositionEstimator3D estimator =
                spy(new PROMedSRobustRssiPositionEstimator3D());
    ...
    public void testEstimate() throws LockedException, RobustEstimatorException, NotReadyException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final PROMedSRobustRssiPositionEstimator3D estimator =
                    new PROMedSRobustRssiPositionEstimator3D(sourceQualityScores,
                            fingerprintReadingsQualityScores, sources, fingerprint, this);
    ...
    private void checkLocked(final PROMedSRobustRssiPositionEstimator3D estimator) {
        try {
