...
class PROMedSRobustRssiPositionEstimator3DTest implements RobustRssiPositionEstimatorListener<Point3D> {

    private static final Logger LOGGER = Logger.getLogger(PROMedSRobustRssiPositionEstimator3DTest.class.getName());
    ...
    void testConstructor() {
        // empty constructor
        var estimator = new PROMedSRobustRssiPositionEstimator3D();

        // check default values
        assertEquals(PROMedSRobustLateration3DSolver.DEFAULT_STOP_THRESHOLD, estimator.getStopThreshold(), 0.0);
        ...
        estimator = new PROMedSRobustRssiPositionEstimator3D(sources);
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustRssiPositionEstimator3D(
                (List<WifiAccessPointLocated3D>) null));
        final var wrongSources = new ArrayList<WifiAccessPointLocated3D>();
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustRssiPositionEstimator3D(wrongSources));

        // constructor with fingerprints
        final var fingerprint = new RssiFingerprint<WifiAccessPoint, RssiReading<WifiAccessPoint>>();
        estimator = new PROMedSRobustRssiPositionEstimator3D(fingerprint);
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustRssiPositionEstimator3D(null,
                fingerprint));
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustRssiPositionEstimator3D(wrongSources,
                fingerprint));
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustRssiPositionEstimator3D(sources,
                (RssiFingerprint<WifiAccessPoint, RssiReading<WifiAccessPoint>>) null));
        ...
        estimator = new PROMedSRobustRssiPositionEstimator3D(sources, fingerprint, this);
        ...
        estimator = new PROMedSRobustRssiPositionEstimator3D(sourceQualityScores, fingerprintReadingsQualityScores);
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustRssiPositionEstimator3D(sourceQualityScores,
                null));
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustRssiPositionEstimator3D(new double[1],
    ...
    void testGetSetStopThreshold() throws LockedException {
        final var estimator = new PROMedSRobustRssiPositionEstimator3D();
    ...
    void testGetSetPreliminarySubsetSize() throws LockedException {
        final var estimator = spy(new PROMedSRobustRssiPositionEstimator3D());
    ...
    void testEstimate() throws LockedException, RobustEstimatorException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new PROMedSRobustRssiPositionEstimator3D(sourceQualityScores,
                    fingerprintReadingsQualityScores, sources, fingerprint, this);
    ...
    public void onEstimateStart(final RobustRssiPositionEstimator<Point3D> estimator) {
        estimateStart++;
        checkLocked((PROMedSRobustRssiPositionEstimator3D) estimator);
    }
    ...
    private static void checkLocked(final PROMedSRobustRssiPositionEstimator3D estimator) {
