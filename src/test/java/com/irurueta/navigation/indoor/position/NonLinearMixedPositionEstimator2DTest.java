...
class NonLinearMixedPositionEstimator2DTest implements MixedPositionEstimatorListener<Point2D> {
    ...
    void testConstructor() {
        // empty constructor
        var estimator = new NonLinearMixedPositionEstimator2D();
        ...
        assertThrows(IllegalArgumentException.class, () -> new NonLinearMixedPositionEstimator2D(
                (List<WifiAccessPointLocated2D>) null));
        final var wrongSources = new ArrayList<WifiAccessPointLocated2D>();
        assertThrows(IllegalArgumentException.class, () -> new NonLinearMixedPositionEstimator2D(wrongSources));
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new NonLinearMixedPositionEstimator2D(null,
                fingerprint));
        assertThrows(IllegalArgumentException.class, () -> new NonLinearMixedPositionEstimator2D(wrongSources,
                fingerprint));
        assertThrows(IllegalArgumentException.class, () -> new NonLinearMixedPositionEstimator2D(sources,
                (Fingerprint<WifiAccessPoint, Reading<WifiAccessPoint>>) null));
        ...
        estimator = new NonLinearMixedPositionEstimator2D(sources, fingerprint, initialPosition, this);
    ...
    void testGetSetInitialPosition() throws LockedException {
        final var estimator = new NonLinearMixedPositionEstimator2D();
    ...
    void testEstimateRssidNoError() throws LockedException, NotReadyException, PositionEstimationException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new NonLinearMixedPositionEstimator2D(sources, fingerprint, this);
    ...
    void testEstimateRssidNoErrorWithInitialPosition() throws LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new NonLinearMixedPositionEstimator2D(sources, fingerprint, position, this);
    ...
    private static void checkLocked(final NonLinearMixedPositionEstimator2D estimator) {
