...
class PROSACRobustRangingAndRssiPositionEstimator3DTest implements
        RobustRangingAndRssiPositionEstimatorListener<Point3D> {

    private static final Logger LOGGER = Logger.getLogger(
            PROSACRobustRangingAndRssiPositionEstimator3DTest.class.getName());
    ...
    void testConstructor() {
        // empty constructor
        var estimator = new PROSACRobustRangingAndRssiPositionEstimator3D();
        ...
        estimator = new PROSACRobustRangingAndRssiPositionEstimator3D(sources);
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustRangingAndRssiPositionEstimator3D(
        ...
        estimator = new PROSACRobustRangingAndRssiPositionEstimator3D(fingerprint);
        ...
        estimator = new PROSACRobustRangingAndRssiPositionEstimator3D(sources, fingerprint);
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustRangingAndRssiPositionEstimator3D(sources,
                (RangingAndRssiFingerprint<WifiAccessPoint, RangingAndRssiReading<WifiAccessPoint>>) null));

        // constructor with listener
        estimator = new PROSACRobustRangingAndRssiPositionEstimator3D(this);
        ...
        estimator = new PROSACRobustRangingAndRssiPositionEstimator3D(sources, this);
        ...
        estimator = new PROSACRobustRangingAndRssiPositionEstimator3D(fingerprint, this);
        ...
        estimator = new PROSACRobustRangingAndRssiPositionEstimator3D(sources, fingerprint, this);
        ...
        estimator = new PROSACRobustRangingAndRssiPositionEstimator3D(sourceQualityScores,
    ...
    void testGetSetFingerprint() throws LockedException {
        ...
        // set new value
        final var fingerprint = new RangingAndRssiFingerprint<WifiAccessPoint, RangingAndRssiReading<WifiAccessPoint>>();
    ...
    void testGetSetInitialPosition() throws LockedException {
        final var solver = new PROSACRobustRangingAndRssiPositionEstimator3D();
    ...
    void testGetSetPreliminarySubsetSize() throws LockedException {
        final var estimator = spy(new PROSACRobustRangingAndRssiPositionEstimator3D());
    ...
    void testEstimate() throws LockedException, RobustEstimatorException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new PROSACRobustRangingAndRssiPositionEstimator3D(sourceQualityScores,
                    fingerprintReadingsQualityScores, sources, fingerprint, this);
    ...
    public void onEstimateStart(final RobustRangingAndRssiPositionEstimator<Point3D> estimator) {
        estimateStart++;
        checkLocked((PROSACRobustRangingAndRssiPositionEstimator3D) estimator);
    }
    ...
    private static double receivedPower(final double equivalentTransmittedPower, final double distance,
        ...
        final var k = Math.pow(SPEED_OF_LIGHT / (4.0 * Math.PI
                * PROSACRobustRangingAndRssiPositionEstimator3DTest.FREQUENCY), pathLossExponent);
        return equivalentTransmittedPower * k / Math.pow(distance, pathLossExponent);
    }

    private static void checkLocked(final PROSACRobustRangingAndRssiPositionEstimator3D estimator) {
