...
class LMedSRobustMixedPositionEstimator2DTest implements RobustMixedPositionEstimatorListener<Point2D> {

    private static final Logger LOGGER = Logger.getLogger(LMedSRobustMixedPositionEstimator2DTest.class.getName());
    ...
    void testConstructor() {
        // empty constructor
        var estimator = new LMedSRobustMixedPositionEstimator2D();

        // check default values
        assertEquals(LMedSRobustLateration2DSolver.DEFAULT_STOP_THRESHOLD, estimator.getStopThreshold(), 0.0);
        ...
        estimator = new LMedSRobustMixedPositionEstimator2D(sources);
        ...
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustMixedPositionEstimator2D(
                (List<WifiAccessPointLocated2D>) null));
        final var wrongSources = new ArrayList<WifiAccessPointLocated2D>();
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustMixedPositionEstimator2D(wrongSources));
        ...
        estimator = new LMedSRobustMixedPositionEstimator2D(fingerprint);
        ...
        estimator = new LMedSRobustMixedPositionEstimator2D(sources, fingerprint);
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustMixedPositionEstimator2D(null,
                fingerprint));
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustMixedPositionEstimator2D(wrongSources,
                fingerprint));
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustMixedPositionEstimator2D(sources,
                (RangingAndRssiFingerprint<WifiAccessPoint, RangingAndRssiReading<WifiAccessPoint>>) null));

        // constructor with listener
        estimator = new LMedSRobustMixedPositionEstimator2D(this);
        ...
        estimator = new LMedSRobustMixedPositionEstimator2D(sources, this);
        ...
        estimator = new LMedSRobustMixedPositionEstimator2D(fingerprint, this);
        ...
        estimator = new LMedSRobustMixedPositionEstimator2D(sources, fingerprint, this);
    ...
    void testGetSetStopThreshold() throws LockedException {
        final var estimator = new LMedSRobustMixedPositionEstimator2D();
    ...
    void testGetSetPreliminarySubsetSize() throws LockedException {
        final var estimator = spy(new LMedSRobustMixedPositionEstimator2D());
    ...
    void testEstimate() throws LockedException, RobustEstimatorException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new LMedSRobustMixedPositionEstimator2D(sources, fingerprint, this);
    ...
    public void onEstimateStart(final RobustMixedPositionEstimator<Point2D> estimator) {
        estimateStart++;
        checkLocked((LMedSRobustMixedPositionEstimator2D) estimator);
    }
    ...
    public void onEstimateNextIteration(
            final RobustMixedPositionEstimator<Point2D> estimator,
            final int iteration) {
    ...
    private static double receivedPower(final double equivalentTransmittedPower, final double distance,
        ...
        final var k = Math.pow(SPEED_OF_LIGHT / (4.0 * Math.PI * LMedSRobustMixedPositionEstimator2DTest.FREQUENCY),
                pathLossExponent);
        return equivalentTransmittedPower * k / Math.pow(distance, pathLossExponent);
    }

    private static void checkLocked(final LMedSRobustMixedPositionEstimator2D estimator) {
