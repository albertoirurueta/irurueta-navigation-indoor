...
class PROSACRobustRangingAndRssiPositionEstimator2DTest implements
    ...
    void testConstructor() {
        // empty constructor
        var estimator = new PROSACRobustRangingAndRssiPositionEstimator2D();
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustRangingAndRssiPositionEstimator2D(
        ...
        estimator = new PROSACRobustRangingAndRssiPositionEstimator2D(sources, fingerprint);
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustRangingAndRssiPositionEstimator2D(sources,
                (RangingAndRssiFingerprint<WifiAccessPoint, RangingAndRssiReading<WifiAccessPoint>>) null));
        ...
        estimator = new PROSACRobustRangingAndRssiPositionEstimator2D(sources, this);
        ...
        estimator = new PROSACRobustRangingAndRssiPositionEstimator2D(fingerprint, this);
        ...
        estimator = new PROSACRobustRangingAndRssiPositionEstimator2D(sources, fingerprint, this);
        ...
        estimator = new PROSACRobustRangingAndRssiPositionEstimator2D(sourceQualityScores,
    ...
    void testGetSetInitialPosition() throws LockedException {
        final var solver = new PROSACRobustRangingAndRssiPositionEstimator2D();
    ...
    void testGetSetPreliminarySubsetSize() throws LockedException {
        final var estimator = spy(new PROSACRobustRangingAndRssiPositionEstimator2D());
    ...
    void testEstimate() throws LockedException, RobustEstimatorException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new PROSACRobustRangingAndRssiPositionEstimator2D(sourceQualityScores,
                    fingerprintReadingsQualityScores, sources, fingerprint, this);
    ...
    private static double receivedPower(final double equivalentTransmittedPower, final double distance,
        ...
        final var k = Math.pow(SPEED_OF_LIGHT / (4.0 * Math.PI
                * PROSACRobustRangingAndRssiPositionEstimator2DTest.FREQUENCY), pathLossExponent);
        return equivalentTransmittedPower * k / Math.pow(distance, pathLossExponent);
    }

    private static void checkLocked(final PROSACRobustRangingAndRssiPositionEstimator2D estimator) {
