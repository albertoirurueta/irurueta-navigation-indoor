...
public class MSACRobustRssiPositionEstimator3DTest implements RobustRssiPositionEstimatorListener<Point3D> {

    private static final Logger LOGGER = Logger.getLogger(
            MSACRobustRssiPositionEstimator3DTest.class.getName());
    ...
    public void testConstructor() {
        // empty constructor
        MSACRobustRssiPositionEstimator3D estimator = new MSACRobustRssiPositionEstimator3D();
        ...
        estimator = new MSACRobustRssiPositionEstimator3D(sources);
        ...
        estimator = null;
        try {
            estimator = new MSACRobustRssiPositionEstimator3D((List<WifiAccessPointLocated3D>) null);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new MSACRobustRssiPositionEstimator3D(new ArrayList<WifiAccessPointLocated3D>());
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        ...
        final RssiFingerprint<WifiAccessPoint, RssiReading<WifiAccessPoint>> fingerprint =
                new RssiFingerprint<>();
        estimator = new MSACRobustRssiPositionEstimator3D(fingerprint);
        ...
        estimator = null;
        try {
            estimator = new MSACRobustRssiPositionEstimator3D(
        ...
        estimator = new MSACRobustRssiPositionEstimator3D(sources, fingerprint);
        ...
        estimator = null;
        try {
            estimator = new MSACRobustRssiPositionEstimator3D(null, fingerprint);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = new MSACRobustRssiPositionEstimator3D(this);
        ...
        estimator = new MSACRobustRssiPositionEstimator3D(sources, this);
        ...
        estimator = new MSACRobustRssiPositionEstimator3D(fingerprint, this);
        ...
        estimator = new MSACRobustRssiPositionEstimator3D(sources, fingerprint, this);
        ...
        estimator = null;
        try {
            estimator = new MSACRobustRssiPositionEstimator3D(null, fingerprint, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        try {
            estimator = new MSACRobustRssiPositionEstimator3D(sources, null, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
    ...
    public void testGetSetThreshold() throws LockedException {
        final MSACRobustRssiPositionEstimator3D estimator = new MSACRobustRssiPositionEstimator3D();
    ...
    public void testGetSetInitialPosition() throws LockedException {
        final MSACRobustRssiPositionEstimator3D solver = new MSACRobustRssiPositionEstimator3D();
    ...
    public void testGetSetPreliminarySubsetSize() throws LockedException {
        final MSACRobustRssiPositionEstimator3D estimator = spy(new MSACRobustRssiPositionEstimator3D());
    ...
    public void testEstimate() throws LockedException, RobustEstimatorException, NotReadyException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final MSACRobustRssiPositionEstimator3D estimator =
                    new MSACRobustRssiPositionEstimator3D(sources, fingerprint, this);
    ...
    public void testEstimateWithInlierError() throws LockedException, NotReadyException,
        ...
        // force NotReadyException
        final MSACRobustRssiPositionEstimator3D estimator =
                new MSACRobustRssiPositionEstimator3D();
        try {
            estimator.estimate();
            fail("NotReadyException expected but not thrown");
        } catch (final NotReadyException ignore) {
    ...
    public void onEstimateStart(final RobustRssiPositionEstimator<Point3D> estimator) {
        estimateStart++;
        checkLocked((MSACRobustRssiPositionEstimator3D) estimator);
    }
    ...
    public void onEstimateNextIteration(
            final RobustRssiPositionEstimator<Point3D> estimator, final int iteration) {
    ...
    public void onEstimateProgressChange(
            final RobustRssiPositionEstimator<Point3D> estimator, final float progress) {
    ...
    private double receivedPower(final double equivalentTransmittedPower,
        ...
        final double k = Math.pow(SPEED_OF_LIGHT / (4.0 * Math.PI * MSACRobustRssiPositionEstimator3DTest.FREQUENCY),
                pathLossExponent);
        return equivalentTransmittedPower * k / Math.pow(distance, pathLossExponent);
    }

    private void checkLocked(final MSACRobustRssiPositionEstimator3D estimator) {
        try {
