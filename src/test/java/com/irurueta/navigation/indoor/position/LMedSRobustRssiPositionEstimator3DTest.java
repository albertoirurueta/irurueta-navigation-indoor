...
public class LMedSRobustRssiPositionEstimator3DTest implements
        RobustRssiPositionEstimatorListener<Point3D> {

    private static final Logger LOGGER = Logger.getLogger(
            LMedSRobustRssiPositionEstimator3DTest.class.getName());
    ...
    public void testConstructor() {
        // empty constructor
        LMedSRobustRssiPositionEstimator3D estimator = new LMedSRobustRssiPositionEstimator3D();
        ...
        estimator = null;
        try {
            estimator = new LMedSRobustRssiPositionEstimator3D((List<WifiAccessPointLocated3D>) null);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new LMedSRobustRssiPositionEstimator3D(new ArrayList<WifiAccessPointLocated3D>());
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        ...
        estimator = null;
        try {
            estimator = new LMedSRobustRssiPositionEstimator3D(
        ...
        estimator = null;
        try {
            estimator = new LMedSRobustRssiPositionEstimator3D(null, fingerprint);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
    ...
    public void testGetSetStopThreshold() throws LockedException {
        final LMedSRobustRssiPositionEstimator3D estimator = new LMedSRobustRssiPositionEstimator3D();
    ...
    public void testGetSetMaxIterations() throws LockedException {
        final LMedSRobustRssiPositionEstimator3D estimator =
                new LMedSRobustRssiPositionEstimator3D();
    ...
    public void testGetSetPreliminarySubsetSize() throws LockedException {
        final LMedSRobustRssiPositionEstimator3D estimator = spy(new LMedSRobustRssiPositionEstimator3D());
    ...
    public void testEstimate() throws LockedException, RobustEstimatorException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final LMedSRobustRssiPositionEstimator3D estimator =
                    new LMedSRobustRssiPositionEstimator3D(sources, fingerprint, this);
    ...
    private double receivedPower(final double equivalentTransmittedPower,
        ...
        final double k = Math.pow(SPEED_OF_LIGHT / (4.0 * Math.PI * LMedSRobustRssiPositionEstimator3DTest.FREQUENCY),
                pathLossExponent);
        return equivalentTransmittedPower * k / Math.pow(distance, pathLossExponent);
    }

    private void checkLocked(final LMedSRobustRssiPositionEstimator3D estimator) {
        try {
