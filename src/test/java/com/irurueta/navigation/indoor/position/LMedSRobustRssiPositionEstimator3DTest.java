...
public class LMedSRobustRssiPositionEstimator3DTest implements
    ...
    public void testConstructor() {
        // empty constructor
        LMedSRobustRssiPositionEstimator3D estimator =
    ...
    public void testGetSetInitialPosition() throws LockedException {
        final LMedSRobustRssiPositionEstimator3D solver =
                new LMedSRobustRssiPositionEstimator3D();
    ...
    public void testGetSetPreliminarySubsetSize() throws LockedException {
        final LMedSRobustRssiPositionEstimator3D estimator =
                spy(new LMedSRobustRssiPositionEstimator3D());
    ...
    public void testEstimate() throws LockedException, RobustEstimatorException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final LMedSRobustRssiPositionEstimator3D estimator =
                    new LMedSRobustRssiPositionEstimator3D(sources, fingerprint,
                            this);
