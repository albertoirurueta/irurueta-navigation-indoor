...
class PROMedSRobustRangingPositionEstimator3DTest implements RobustRangingPositionEstimatorListener<Point3D> {

    private static final Logger LOGGER = Logger.getLogger(PROMedSRobustRangingPositionEstimator3DTest.class.getName());
    ...
    void testConstructor() {
        // empty constructor
        var estimator = new PROMedSRobustRangingPositionEstimator3D();
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustRangingPositionEstimator3D(
                (List<WifiAccessPointLocated3D>) null));
        final var wrongSources = new ArrayList<WifiAccessPointLocated3D>();
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustRangingPositionEstimator3D(wrongSources));

        // constructor with fingerprints
        RangingFingerprint<WifiAccessPoint, RangingReading<WifiAccessPoint>> fingerprint = new RangingFingerprint<>();
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustRangingPositionEstimator3D(null,
                fingerprint));
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustRangingPositionEstimator3D(wrongSources,
                fingerprint));
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustRangingPositionEstimator3D(sources,
                (RangingFingerprint<WifiAccessPoint, RangingReading<WifiAccessPoint>>) null));
        ...
        estimator = new PROMedSRobustRangingPositionEstimator3D(fingerprint, this);
        ...
        estimator = new PROMedSRobustRangingPositionEstimator3D(sources, fingerprint, this);
        ...
        estimator = new PROMedSRobustRangingPositionEstimator3D(sourceQualityScores, fingerprintReadingsQualityScores);
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustRangingPositionEstimator3D(new double[1],
    ...
    void testGetSetStopThreshold() throws LockedException {
        final var estimator = new PROMedSRobustRangingPositionEstimator3D();
    ...
    void testGetSetInitialPosition() throws LockedException {
        final var solver = new PROMedSRobustRangingPositionEstimator3D();
    ...
    void testGetSetPreliminarySubsetSize() throws LockedException {
        final var estimator = spy(new PROMedSRobustRangingPositionEstimator3D());
    ...
    void testEstimate() throws LockedException, RobustEstimatorException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new PROMedSRobustRangingPositionEstimator3D(sourceQualityScores,
                    fingerprintReadingsQualityScores, sources, fingerprint, this);
    ...
    private static void checkLocked(final PROMedSRobustRangingPositionEstimator3D estimator) {
