...
class MSACRobustRangingAndRssiPositionEstimator2DTest implements
        RobustRangingAndRssiPositionEstimatorListener<Point2D> {

    private static final Logger LOGGER = Logger.getLogger(
            MSACRobustRangingAndRssiPositionEstimator2DTest.class.getName());
    ...
    void testConstructor() {
        // empty constructor
        var estimator = new MSACRobustRangingAndRssiPositionEstimator2D();
        ...
        estimator = new MSACRobustRangingAndRssiPositionEstimator2D(sources);
        ...
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustRangingAndRssiPositionEstimator2D(
                (List<WifiAccessPointLocated2D>) null));
        final var wrongSource = new ArrayList<WifiAccessPointLocated2D>();
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustRangingAndRssiPositionEstimator2D(
                wrongSource));
        ...
        estimator = new MSACRobustRangingAndRssiPositionEstimator2D(fingerprint);
        ...
        estimator = new MSACRobustRangingAndRssiPositionEstimator2D(sources, fingerprint);
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustRangingAndRssiPositionEstimator2D(null,
                fingerprint));
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustRangingAndRssiPositionEstimator2D(wrongSource,
                fingerprint));
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustRangingAndRssiPositionEstimator2D(sources,
                (RangingAndRssiFingerprint<WifiAccessPoint, RangingAndRssiReading<WifiAccessPoint>>) null));

        // constructor with listener
        estimator = new MSACRobustRangingAndRssiPositionEstimator2D(this);
        ...
        estimator = new MSACRobustRangingAndRssiPositionEstimator2D(sources, this);
        ...
        estimator = new MSACRobustRangingAndRssiPositionEstimator2D(fingerprint, this);
        ...
        estimator = new MSACRobustRangingAndRssiPositionEstimator2D(sources, fingerprint, this);
    ...
    void testGetSetThreshold() throws LockedException {
        final var estimator = new MSACRobustRangingAndRssiPositionEstimator2D();
    ...
    void testGetSetPreliminarySubsetSize() throws LockedException {
        final var estimator = spy(new MSACRobustRangingAndRssiPositionEstimator2D());
    ...
    void testEstimate() throws LockedException, RobustEstimatorException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new MSACRobustRangingAndRssiPositionEstimator2D(sources, fingerprint, this);
    ...
    public void onEstimateStart(final RobustRangingAndRssiPositionEstimator<Point2D> estimator) {
        estimateStart++;
        checkLocked((MSACRobustRangingAndRssiPositionEstimator2D) estimator);
    }
    ...
    public void onEstimateNextIteration(
            final RobustRangingAndRssiPositionEstimator<Point2D> estimator, final int iteration) {
    ...
    public void onEstimateProgressChange(
            final RobustRangingAndRssiPositionEstimator<Point2D> estimator, final float progress) {
    ...
    private static double receivedPower(final double equivalentTransmittedPower, final double distance,
        ...
        final var k = Math.pow(SPEED_OF_LIGHT / (4.0 * Math.PI
                * MSACRobustRangingAndRssiPositionEstimator2DTest.FREQUENCY), pathLossExponent);
        return equivalentTransmittedPower * k / Math.pow(distance, pathLossExponent);
    }

    private static void checkLocked(final MSACRobustRangingAndRssiPositionEstimator2D estimator) {
