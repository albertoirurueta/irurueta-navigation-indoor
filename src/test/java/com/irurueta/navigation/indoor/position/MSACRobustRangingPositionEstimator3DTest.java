...
class MSACRobustRangingPositionEstimator3DTest implements RobustRangingPositionEstimatorListener<Point3D> {

    private static final Logger LOGGER = Logger.getLogger(MSACRobustRangingPositionEstimator3DTest.class.getName());
    ...
    void testConstructor() {
        // empty constructor
        var estimator = new MSACRobustRangingPositionEstimator3D();
        ...
        estimator = new MSACRobustRangingPositionEstimator3D(sources);
        ...
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustRangingPositionEstimator3D(
                (List<WifiAccessPointLocated3D>) null));
        final var wrongSources = new ArrayList<WifiAccessPointLocated3D>();
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustRangingPositionEstimator3D(wrongSources));

        // constructor with fingerprints
        final var fingerprint = new RangingFingerprint<WifiAccessPoint, RangingReading<WifiAccessPoint>>();
        estimator = new MSACRobustRangingPositionEstimator3D(fingerprint);
        ...
        estimator = new MSACRobustRangingPositionEstimator3D(sources, fingerprint);
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustRangingPositionEstimator3D(null,
                fingerprint));
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustRangingPositionEstimator3D(wrongSources,
                fingerprint));
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustRangingPositionEstimator3D(sources,
                (RangingFingerprint<WifiAccessPoint, RangingReading<WifiAccessPoint>>) null));

        // constructor with listener
        estimator = new MSACRobustRangingPositionEstimator3D(this);
        ...
        estimator = new MSACRobustRangingPositionEstimator3D(sources, this);
        ...
        estimator = new MSACRobustRangingPositionEstimator3D(fingerprint, this);
        ...
        estimator = new MSACRobustRangingPositionEstimator3D(sources, fingerprint, this);
    ...
    void testGetSetThreshold() throws LockedException {
        final var estimator = new MSACRobustRangingPositionEstimator3D();
    ...
    void testGetSetPreliminarySubsetSize() throws LockedException {
        final var estimator = spy(new MSACRobustRangingPositionEstimator3D());
    ...
    void testEstimate() throws LockedException, RobustEstimatorException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new MSACRobustRangingPositionEstimator3D(sources, fingerprint, this);
    ...
    public void onEstimateStart(final RobustRangingPositionEstimator<Point3D> estimator) {
        estimateStart++;
        checkLocked((MSACRobustRangingPositionEstimator3D) estimator);
    }
    ...
    private static void checkLocked(final MSACRobustRangingPositionEstimator3D estimator) {
