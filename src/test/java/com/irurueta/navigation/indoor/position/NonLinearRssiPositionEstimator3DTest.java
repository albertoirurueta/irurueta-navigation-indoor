...
class NonLinearRssiPositionEstimator3DTest implements RssiPositionEstimatorListener<Point3D> {
    ...
    void testConstructor() {
        // empty constructor
        var estimator = new NonLinearRssiPositionEstimator3D();
        ...
        assertThrows(IllegalArgumentException.class, () -> new NonLinearRssiPositionEstimator3D(
                (List<WifiAccessPointLocated3D>) null));
        final var wrongSources = new ArrayList<WifiAccessPointLocated3D>();
        assertThrows(IllegalArgumentException.class, () -> new NonLinearRssiPositionEstimator3D(wrongSources));
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new NonLinearRssiPositionEstimator3D(null,
                fingerprint));
        assertThrows(IllegalArgumentException.class, () -> new NonLinearRssiPositionEstimator3D(wrongSources,
                fingerprint));
        assertThrows(IllegalArgumentException.class, () -> new NonLinearRssiPositionEstimator3D(sources,
                (RssiFingerprint<WifiAccessPoint, RssiReading<WifiAccessPoint>>) null));
        ...
        var initialPosition = new InhomogeneousPoint3D();
        ...
        assertThrows(IllegalArgumentException.class, () -> new NonLinearRssiPositionEstimator3D(wrongSources,
                fingerprint, initialPosition));
        assertThrows(IllegalArgumentException.class, () -> new NonLinearRssiPositionEstimator3D(sources, null,
                initialPosition));
        ...
        estimator = new NonLinearRssiPositionEstimator3D(sources, fingerprint, initialPosition, this);
    ...
    void testGetSetInitialPosition() throws LockedException {
        final var estimator = new NonLinearRssiPositionEstimator3D();
    ...
    void testEstimateNoError() throws LockedException, NotReadyException, PositionEstimationException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new NonLinearRssiPositionEstimator3D(sources, fingerprint, this);
    ...
    void testEstimateNoErrorWithInitialPosition() throws LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new NonLinearRssiPositionEstimator3D(sources, fingerprint, position, this);
    ...
    private static void checkLocked(final NonLinearRssiPositionEstimator3D estimator) {
