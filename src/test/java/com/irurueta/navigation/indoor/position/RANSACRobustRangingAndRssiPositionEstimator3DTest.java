...
class RANSACRobustRangingAndRssiPositionEstimator3DTest implements
    ...
    void testConstructor() {
        // empty constructor
        var estimator = new RANSACRobustRangingAndRssiPositionEstimator3D();
        ...
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustRangingAndRssiPositionEstimator3D(
        ...
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustRangingAndRssiPositionEstimator3D(sources,
                (RangingAndRssiFingerprint<WifiAccessPoint, RangingAndRssiReading<WifiAccessPoint>>) null));
        ...
        estimator = new RANSACRobustRangingAndRssiPositionEstimator3D(sources, this);
        ...
        estimator = new RANSACRobustRangingAndRssiPositionEstimator3D(fingerprint, this);
        ...
        estimator = new RANSACRobustRangingAndRssiPositionEstimator3D(sources, fingerprint, this);
    ...
    void testGetSetThreshold() throws LockedException {
        final var estimator = new RANSACRobustRangingAndRssiPositionEstimator3D();
    ...
    void testGetSetInitialPosition() throws LockedException {
        final var solver = new RANSACRobustRangingAndRssiPositionEstimator3D();
    ...
    void testGetSetPreliminarySubsetSize() throws LockedException {
        final var estimator = spy(new RANSACRobustRangingAndRssiPositionEstimator3D());
    ...
    void testEstimate() throws LockedException, RobustEstimatorException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new RANSACRobustRangingAndRssiPositionEstimator3D(sources, fingerprint, this);
    ...
    private static double receivedPower(final double equivalentTransmittedPower, final double distance,
        ...
        final var k = Math.pow(SPEED_OF_LIGHT / (4.0 * Math.PI
                * RANSACRobustRangingAndRssiPositionEstimator3DTest.FREQUENCY), pathLossExponent);
        return equivalentTransmittedPower * k / Math.pow(distance, pathLossExponent);
    }

    private static void checkLocked(final RANSACRobustRangingAndRssiPositionEstimator3D estimator) {
