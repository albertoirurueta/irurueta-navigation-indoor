...
public class RANSACRobustRangingAndRssiPositionEstimator3DTest implements
    ...
    public void testConstructor() {
        ...
        estimator = null;
        try {
            estimator = new RANSACRobustRangingAndRssiPositionEstimator3D(null, fingerprint);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
    ...
    public void testGetSetThreshold() throws LockedException {
        final RANSACRobustRangingAndRssiPositionEstimator3D estimator =
                new RANSACRobustRangingAndRssiPositionEstimator3D();
    ...
    public void testGetSetInitialPosition() throws LockedException {
        final RANSACRobustRangingAndRssiPositionEstimator3D solver =
                new RANSACRobustRangingAndRssiPositionEstimator3D();
    ...
    public void testGetSetPreliminarySubsetSize() throws LockedException {
        final RANSACRobustRangingAndRssiPositionEstimator3D estimator =
                spy(new RANSACRobustRangingAndRssiPositionEstimator3D());
    ...
    public void testEstimate() throws LockedException, RobustEstimatorException, NotReadyException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final RANSACRobustRangingAndRssiPositionEstimator3D estimator =
                    new RANSACRobustRangingAndRssiPositionEstimator3D(sources, fingerprint, this);
    ...
    private void checkLocked(final RANSACRobustRangingAndRssiPositionEstimator3D estimator) {
        try {
