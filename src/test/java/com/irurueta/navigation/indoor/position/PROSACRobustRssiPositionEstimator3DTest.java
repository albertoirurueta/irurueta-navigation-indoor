...
class PROSACRobustRssiPositionEstimator3DTest implements RobustRssiPositionEstimatorListener<Point3D> {

    private static final Logger LOGGER = Logger.getLogger(PROSACRobustRssiPositionEstimator3DTest.class.getName());
    ...
    void testConstructor() {
        // empty constructor
        var estimator = new PROSACRobustRssiPositionEstimator3D();
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustRssiPositionEstimator3D(
                (List<WifiAccessPointLocated3D>) null));
        final var wrongSources = new ArrayList<WifiAccessPointLocated3D>();
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustRssiPositionEstimator3D(wrongSources));
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustRssiPositionEstimator3D(null,
                fingerprint));
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustRssiPositionEstimator3D(wrongSources,
                fingerprint));
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustRssiPositionEstimator3D(sources,
                (RssiFingerprint<WifiAccessPoint, RssiReading<WifiAccessPoint>>) null));
        ...
        estimator = new PROSACRobustRssiPositionEstimator3D(sources, fingerprint, this);
        ...
        estimator = new PROSACRobustRssiPositionEstimator3D(sourceQualityScores, fingerprintReadingsQualityScores);
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustRssiPositionEstimator3D(sourceQualityScores,
                null));
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustRssiPositionEstimator3D(new double[1],
    ...
    void testGetSetThreshold() throws LockedException {
        final var estimator = new PROSACRobustRssiPositionEstimator3D();
    ...
    void testGetSetInitialPosition() throws LockedException {
        final var solver = new PROSACRobustRssiPositionEstimator3D();
    ...
    void testGetSetPreliminarySubsetSize() throws LockedException {
        final var estimator = spy(new PROSACRobustRssiPositionEstimator3D());
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            for (var i = 0; i < numSources; i++) {
                ...
                final var locatedAccessPoint = new WifiAccessPointWithPowerAndLocated3D(bssid, FREQUENCY,
                        ...
                        Math.sqrt(PATHLOSS_EXPONENT_VARIANCE), accessPointPosition);
            ...
            final var estimator = new PROSACRobustRssiPositionEstimator3D(sourceQualityScores,
                    fingerprintReadingsQualityScores, sources, fingerprint, this);
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            for (var i = 0; i < numSources; i++) {
                ...
                for (var j = 0; j < NUM_READINGS; j++) {
                    var rssi = Utils.powerTodBm(receivedPower(transmittedPower, distance, pathLossExponent));
    ...
    private static void checkLocked(final PROSACRobustRssiPositionEstimator3D estimator) {
