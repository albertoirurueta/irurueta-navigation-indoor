...
public class RANSACRobustRangingPositionEstimator3DTest implements
        RobustRangingPositionEstimatorListener<Point3D> {

    private static final Logger LOGGER = Logger.getLogger(
            RANSACRobustRangingPositionEstimator3DTest.class.getName());
    ...
    public void testConstructor() {
        // empty constructor
        RANSACRobustRangingPositionEstimator3D estimator = new RANSACRobustRangingPositionEstimator3D();
        ...
        estimator = null;
        try {
            estimator = new RANSACRobustRangingPositionEstimator3D((List<WifiAccessPointLocated3D>) null);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new RANSACRobustRangingPositionEstimator3D(
        ...
        estimator = null;
        try {
            estimator = new RANSACRobustRangingPositionEstimator3D(null, fingerprint);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = null;
        try {
            estimator = new RANSACRobustRangingPositionEstimator3D(null, fingerprint, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        try {
            estimator = new RANSACRobustRangingPositionEstimator3D(sources, null, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
    ...
    public void testGetSetThreshold() throws LockedException {
        final RANSACRobustRangingPositionEstimator3D estimator =
                new RANSACRobustRangingPositionEstimator3D();
    ...
    public void testGetSetInitialPosition() throws LockedException {
        final RANSACRobustRangingPositionEstimator3D solver =
                new RANSACRobustRangingPositionEstimator3D();
    ...
    public void testGetSetPreliminarySubsetSize() throws LockedException {
        final RANSACRobustRangingPositionEstimator3D estimator =
                spy(new RANSACRobustRangingPositionEstimator3D());
    ...
    public void testEstimate() throws LockedException, RobustEstimatorException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final RANSACRobustRangingPositionEstimator3D estimator =
                    new RANSACRobustRangingPositionEstimator3D(sources, fingerprint, this);
    ...
    private void checkLocked(final RANSACRobustRangingPositionEstimator3D estimator) {
        try {
