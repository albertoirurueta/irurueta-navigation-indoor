...
class PROMedSRobustRangingAndRssiPositionEstimator3DTest implements
        RobustRangingAndRssiPositionEstimatorListener<Point3D> {

    private static final Logger LOGGER = Logger.getLogger(
            PROMedSRobustRangingAndRssiPositionEstimator3DTest.class.getName());
    ...
    void testConstructor() {
        // empty constructor
        var estimator = new PROMedSRobustRangingAndRssiPositionEstimator3D();
        ...
        estimator = new PROMedSRobustRangingAndRssiPositionEstimator3D(sources);
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustRangingAndRssiPositionEstimator3D(
        ...
        estimator = new PROMedSRobustRangingAndRssiPositionEstimator3D(fingerprint);
        ...
        estimator = new PROMedSRobustRangingAndRssiPositionEstimator3D(sources, fingerprint);
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROMedSRobustRangingAndRssiPositionEstimator3D(sources,
                (RangingAndRssiFingerprint<WifiAccessPoint, RangingAndRssiReading<WifiAccessPoint>>) null));

        // constructor with listener
        estimator = new PROMedSRobustRangingAndRssiPositionEstimator3D(this);
        ...
        estimator = new PROMedSRobustRangingAndRssiPositionEstimator3D(sources, this);
        ...
        estimator = new PROMedSRobustRangingAndRssiPositionEstimator3D(fingerprint, this);
        ...
        estimator = new PROMedSRobustRangingAndRssiPositionEstimator3D(sources, fingerprint, this);
        ...
        estimator = new PROMedSRobustRangingAndRssiPositionEstimator3D(sourceQualityScores,
    ...
    void testGetSetStopThreshold() throws LockedException {
        final var estimator = new PROMedSRobustRangingAndRssiPositionEstimator3D();
    ...
    void testGetSetInitialPosition() throws LockedException {
        final var solver = new PROMedSRobustRangingAndRssiPositionEstimator3D();
    ...
    void testGetSetPreliminarySubsetSize() throws LockedException {
        final var estimator = spy(new PROMedSRobustRangingAndRssiPositionEstimator3D());
    ...
    void testEstimate() throws LockedException, RobustEstimatorException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new PROMedSRobustRangingAndRssiPositionEstimator3D(sourceQualityScores,
                    fingerprintReadingsQualityScores, sources, fingerprint, this);
    ...
    public void onEstimateStart(final RobustRangingAndRssiPositionEstimator<Point3D> estimator) {
        estimateStart++;
        checkLocked((PROMedSRobustRangingAndRssiPositionEstimator3D) estimator);
    }
    ...
    private static double receivedPower(final double equivalentTransmittedPower, final double distance,
        ...
        final var k = Math.pow(SPEED_OF_LIGHT / (4.0 * Math.PI
                * PROMedSRobustRangingAndRssiPositionEstimator3DTest.FREQUENCY), pathLossExponent);
        return equivalentTransmittedPower * k / Math.pow(distance, pathLossExponent);
    }

    private static void checkLocked(final PROMedSRobustRangingAndRssiPositionEstimator3D estimator) {
