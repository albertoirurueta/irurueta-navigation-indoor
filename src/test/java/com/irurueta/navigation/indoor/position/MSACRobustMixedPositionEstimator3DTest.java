...
public class MSACRobustMixedPositionEstimator3DTest implements
    ...
    private static final Logger LOGGER = Logger.getLogger(
            MSACRobustMixedPositionEstimator3DTest.class.getName());
    ...
    public void testConstructor() {
        // empty constructor
        MSACRobustMixedPositionEstimator3D estimator = new MSACRobustMixedPositionEstimator3D();
        ...
        estimator = null;
        try {
            estimator = new MSACRobustMixedPositionEstimator3D(null, fingerprint);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = null;
        try {
            estimator = new MSACRobustMixedPositionEstimator3D(null, fingerprint, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        try {
            estimator = new MSACRobustMixedPositionEstimator3D(sources, null, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
    ...
    public void testGetSetThreshold() throws LockedException {
        final MSACRobustMixedPositionEstimator3D estimator = new MSACRobustMixedPositionEstimator3D();
    ...
    public void testGetSetPreliminarySubsetSize() throws LockedException {
        final MSACRobustMixedPositionEstimator3D estimator = spy(new MSACRobustMixedPositionEstimator3D());
    ...
    public void testEstimate() throws LockedException, RobustEstimatorException, NotReadyException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final MSACRobustMixedPositionEstimator3D estimator =
                    new MSACRobustMixedPositionEstimator3D(sources, fingerprint, this);
    ...
    private double receivedPower(final double equivalentTransmittedPower,
        ...
        final double k = Math.pow(SPEED_OF_LIGHT / (4.0 * Math.PI *
                        MSACRobustMixedPositionEstimator3DTest.FREQUENCY), pathLossExponent);
