...
public class RANSACRobustRssiPositionEstimator2DTest implements
    ...
    public void testConstructor() {
        // empty constructor
        RANSACRobustRssiPositionEstimator2D estimator = new RANSACRobustRssiPositionEstimator2D();
        ...
        estimator = null;
        try {
            estimator = new RANSACRobustRssiPositionEstimator2D((List<WifiAccessPointLocated2D>) null);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new RANSACRobustRssiPositionEstimator2D(new ArrayList<WifiAccessPointLocated2D>());
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        ...
        estimator = null;
        try {
            estimator = new RANSACRobustRssiPositionEstimator2D(null, fingerprint, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        try {
            estimator = new RANSACRobustRssiPositionEstimator2D(sources, null, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
    ...
    public void testGetSetThreshold() throws LockedException {
        final RANSACRobustRssiPositionEstimator2D estimator = new RANSACRobustRssiPositionEstimator2D();
    ...
    public void testGetSetInitialPosition() throws LockedException {
        final RANSACRobustRssiPositionEstimator2D solver = new RANSACRobustRssiPositionEstimator2D();
    ...
    public void testGetSetPreliminarySubsetSize() throws LockedException {
        final RANSACRobustRssiPositionEstimator2D estimator =
    ...
    public void testEstimate() throws LockedException, RobustEstimatorException, NotReadyException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final RANSACRobustRssiPositionEstimator2D estimator =
                    new RANSACRobustRssiPositionEstimator2D(sources, fingerprint, this);
    ...
    private double receivedPower(final double equivalentTransmittedPower,
        ...
        final double k = Math.pow(SPEED_OF_LIGHT / (4.0 * Math.PI * RANSACRobustRssiPositionEstimator2DTest.FREQUENCY),
                pathLossExponent);
        return equivalentTransmittedPower * k / Math.pow(distance, pathLossExponent);
    }

    private void checkLocked(final RANSACRobustRssiPositionEstimator2D estimator) {
        try {
