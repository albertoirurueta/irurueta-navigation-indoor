...
class NonLinearRangingPositionEstimator2DTest implements RangingPositionEstimatorListener<Point2D> {
    ...
    void testConstructor() {
        // empty constructor
        var estimator = new NonLinearRangingPositionEstimator2D();
        ...
        assertThrows(IllegalArgumentException.class, () -> new NonLinearRangingPositionEstimator2D(
                (List<WifiAccessPointLocated2D>) null));
        final var wrongSources = new ArrayList<WifiAccessPointLocated2D>();
        assertThrows(IllegalArgumentException.class, () -> new NonLinearRangingPositionEstimator2D(wrongSources));
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new NonLinearRangingPositionEstimator2D(null,
                fingerprint));
        assertThrows(IllegalArgumentException.class, () -> new NonLinearRangingPositionEstimator2D(wrongSources,
                fingerprint));
        assertThrows(IllegalArgumentException.class, () -> new NonLinearRangingPositionEstimator2D(sources,
                (RangingFingerprint<WifiAccessPoint, RangingReading<WifiAccessPoint>>) null));
        ...
        estimator = new NonLinearRangingPositionEstimator2D(sources, fingerprint, initialPosition, this);
    ...
    void testEstimateNoError() throws LockedException, NotReadyException, PositionEstimationException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new NonLinearRangingPositionEstimator2D(sources, fingerprint, this);
    ...
    void testEstimateNoErrorWithInitialPosition() throws LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new NonLinearRangingPositionEstimator2D(sources, fingerprint, position, this);
    ...
    private static void checkLocked(final NonLinearRangingPositionEstimator2D estimator) {
