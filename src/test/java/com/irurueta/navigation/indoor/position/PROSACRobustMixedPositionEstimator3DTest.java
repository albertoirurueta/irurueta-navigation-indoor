...
class PROSACRobustMixedPositionEstimator3DTest implements RobustMixedPositionEstimatorListener<Point3D> {

    private static final Logger LOGGER = Logger.getLogger(PROSACRobustMixedPositionEstimator3DTest.class.getName());
    ...
    void testConstructor() {
        // empty constructor
        var estimator = new PROSACRobustMixedPositionEstimator3D();
        ...
        estimator = new PROSACRobustMixedPositionEstimator3D(sources);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new PROSACRobustMixedPositionEstimator3D((List<WifiAccessPointLocated3D>) null));
        final var wrongSources = new ArrayList<WifiAccessPointLocated3D>();
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustMixedPositionEstimator3D(wrongSources));

        // constructor with fingerprints
        final var fingerprint = new Fingerprint<WifiAccessPoint, Reading<WifiAccessPoint>>();
        estimator = new PROSACRobustMixedPositionEstimator3D(fingerprint);
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustMixedPositionEstimator3D(
                (Fingerprint<WifiAccessPoint, Reading<WifiAccessPoint>>) null));

        // constructor with sources and fingerprint
        estimator = new PROSACRobustMixedPositionEstimator3D(sources, fingerprint);
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustMixedPositionEstimator3D(null,
                fingerprint));
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustMixedPositionEstimator3D(wrongSources,
                fingerprint));
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustMixedPositionEstimator3D(sources,
                (Fingerprint<WifiAccessPoint, Reading<WifiAccessPoint>>) null));

        // constructor with listener
        estimator = new PROSACRobustMixedPositionEstimator3D(this);
        ...
        estimator = new PROSACRobustMixedPositionEstimator3D(sources, this);
        ...
        estimator = new PROSACRobustMixedPositionEstimator3D(fingerprint, this);
        ...
        estimator = new PROSACRobustMixedPositionEstimator3D(sources, fingerprint, this);
        ...
        estimator = new PROSACRobustMixedPositionEstimator3D(sourceQualityScores, fingerprintReadingsQualityScores);
        ...
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustMixedPositionEstimator3D(sourceQualityScores,
                null));
        assertThrows(IllegalArgumentException.class, () -> new PROSACRobustMixedPositionEstimator3D(new double[1],
    ...
    void testGetSetThreshold() throws LockedException {
        final var estimator = new PROSACRobustMixedPositionEstimator3D();
    ...
    void testGetSetInitialPosition() throws LockedException {
        final var solver = new PROSACRobustMixedPositionEstimator3D();
    ...
    void testGetSetPreliminarySubsetSize() throws LockedException {
        final var estimator = spy(new PROSACRobustMixedPositionEstimator3D());
    ...
    void testEstimate() throws LockedException, RobustEstimatorException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new PROSACRobustMixedPositionEstimator3D(sourceQualityScores,
                    fingerprintReadingsQualityScores, sources, fingerprint, this);
        ...
        final var estimator = new PROSACRobustRangingAndRssiPositionEstimator3D();
    ...
    @Test
    void testEstimateMultipleReadingsPerSourceWithInlierError() throws LockedException,
    ...
    public void onEstimateStart(final RobustMixedPositionEstimator<Point3D> estimator) {
        estimateStart++;
        checkLocked((PROSACRobustMixedPositionEstimator3D) estimator);
    }
    ...
    private static double receivedPower(final double equivalentTransmittedPower, final double distance,
        ...
        final var k = Math.pow(SPEED_OF_LIGHT / (4.0 * Math.PI * PROSACRobustMixedPositionEstimator3DTest.FREQUENCY),
                pathLossExponent);
        return equivalentTransmittedPower * k / Math.pow(distance, pathLossExponent);
    }

    private static void checkLocked(final PROSACRobustMixedPositionEstimator3D estimator) {
