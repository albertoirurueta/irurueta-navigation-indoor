...
class MSACRobustMixedPositionEstimator2DTest implements RobustMixedPositionEstimatorListener<Point2D> {

    private static final Logger LOGGER = Logger.getLogger(MSACRobustMixedPositionEstimator2DTest.class.getName());
    ...
    void testConstructor() {
        // empty constructor
        var estimator = new MSACRobustMixedPositionEstimator2D();
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new MSACRobustMixedPositionEstimator2D((List<WifiAccessPointLocated2D>) null));
        final var wrongSources = new ArrayList<WifiAccessPointLocated2D>();
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustMixedPositionEstimator2D(wrongSources));
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustMixedPositionEstimator2D(
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustMixedPositionEstimator2D(null,
                fingerprint));
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustMixedPositionEstimator2D(wrongSources,
                fingerprint));
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustMixedPositionEstimator2D(sources,
                (Fingerprint<WifiAccessPoint, Reading<WifiAccessPoint>>) null));
        ...
        estimator = new MSACRobustMixedPositionEstimator2D(sources, this);
        ...
        estimator = new MSACRobustMixedPositionEstimator2D(fingerprint, this);
        ...
        estimator = new MSACRobustMixedPositionEstimator2D(sources, fingerprint, this);
    ...
    void testGetSetThreshold() throws LockedException {
        final var estimator = new MSACRobustMixedPositionEstimator2D();
    ...
    void testGetSetPreliminarySubsetSize() throws LockedException {
        final var estimator = spy(new MSACRobustMixedPositionEstimator2D());
    ...
    void testEstimate() throws LockedException, RobustEstimatorException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new MSACRobustMixedPositionEstimator2D(sources, fingerprint, this);
    ...
    public void onEstimateStart(final RobustMixedPositionEstimator<Point2D> estimator) {
        estimateStart++;
        checkLocked((MSACRobustMixedPositionEstimator2D) estimator);
    }
    ...
    private static double receivedPower(final double equivalentTransmittedPower, final double distance,
        ...
        final var k = Math.pow(SPEED_OF_LIGHT / (4.0 * Math.PI * MSACRobustMixedPositionEstimator2DTest.FREQUENCY),
                pathLossExponent);
        return equivalentTransmittedPower * k / Math.pow(distance, pathLossExponent);
    }

    private static void checkLocked(final MSACRobustMixedPositionEstimator2D estimator) {
