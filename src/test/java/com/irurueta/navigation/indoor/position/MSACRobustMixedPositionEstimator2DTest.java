...
public class MSACRobustMixedPositionEstimator2DTest implements
    ...
    public void testConstructor() {
        // empty constructor
        MSACRobustMixedPositionEstimator2D estimator =
                new MSACRobustMixedPositionEstimator2D();
        ...
        estimator = null;
        try {
            estimator = new MSACRobustMixedPositionEstimator2D((List<WifiAccessPointLocated2D>) null);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new MSACRobustMixedPositionEstimator2D(new ArrayList<WifiAccessPointLocated2D>());
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        ...
        estimator = null;
        try {
            estimator = new MSACRobustMixedPositionEstimator2D(
        ...
        assertEquals(RobustPositionEstimator.FALLBACK_DISTANCE_STANDARD_DEVIATION,
                estimator.getFallbackDistanceStandardDeviation(), 0.0);
        assertFalse(estimator.isLocked());
        assertEquals(RobustLaterationSolver.DEFAULT_PROGRESS_DELTA, estimator.getProgressDelta(),
                0.0);
        assertEquals(RobustLaterationSolver.DEFAULT_CONFIDENCE, estimator.getConfidence(), 0.0);
        assertEquals(RobustLaterationSolver.DEFAULT_MAX_ITERATIONS, estimator.getMaxIterations());
        assertEquals(RobustLaterationSolver.DEFAULT_REFINE_RESULT, estimator.isResultRefined());
        ...
        estimator = null;
        try {
            estimator = new MSACRobustMixedPositionEstimator2D(null,
                    fingerprint);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        ...
        try {
            estimator = new MSACRobustMixedPositionEstimator2D(sources, null, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
    ...
    public void testGetSetThreshold() throws LockedException {
        final MSACRobustMixedPositionEstimator2D estimator = new MSACRobustMixedPositionEstimator2D();
    ...
    public void testIsSetResultRefined() throws LockedException {
        final MSACRobustMixedPositionEstimator2D estimator =
                new MSACRobustMixedPositionEstimator2D();
    ...
    public void testGetSetPreliminarySubsetSize() throws LockedException {
        final MSACRobustMixedPositionEstimator2D estimator = spy(new MSACRobustMixedPositionEstimator2D());
    ...
    public void testEstimate() throws LockedException, RobustEstimatorException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final MSACRobustMixedPositionEstimator2D estimator =
                    new MSACRobustMixedPositionEstimator2D(sources, fingerprint, this);
    ...
    private double receivedPower(final double equivalentTransmittedPower,
        ...
        final double k = Math.pow(SPEED_OF_LIGHT / (4.0 * Math.PI *
                        MSACRobustMixedPositionEstimator2DTest.FREQUENCY), pathLossExponent);
        return equivalentTransmittedPower * k / Math.pow(distance, pathLossExponent);
    }

    private void checkLocked(final MSACRobustMixedPositionEstimator2D estimator) {
        try {
