...
public class LMedSRobustRangingPositionEstimator2DTest implements
    ...
    public void testConstructor() {
        // empty constructor
        LMedSRobustRangingPositionEstimator2D estimator = new LMedSRobustRangingPositionEstimator2D();
        ...
        estimator = null;
        try {
            estimator = new LMedSRobustRangingPositionEstimator2D((List<WifiAccessPointLocated2D>) null);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new LMedSRobustRangingPositionEstimator2D(
        ...
        estimator = null;
        try {
            estimator = new LMedSRobustRangingPositionEstimator2D(null, fingerprint);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = null;
        try {
            estimator = new LMedSRobustRangingPositionEstimator2D(null,
                    fingerprint, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        ...
        try {
            estimator = new LMedSRobustRangingPositionEstimator2D(sources, null, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
    ...
    public void testGetSetStopThreshold() throws LockedException {
        final LMedSRobustRangingPositionEstimator2D estimator = new LMedSRobustRangingPositionEstimator2D();
    ...
    public void testGetSetPreliminarySubsetSize() throws LockedException {
        final LMedSRobustRangingPositionEstimator2D estimator =
                spy(new LMedSRobustRangingPositionEstimator2D());
    ...
    public void testEstimate() throws LockedException, RobustEstimatorException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final LMedSRobustRangingPositionEstimator2D estimator =
                    new LMedSRobustRangingPositionEstimator2D(sources, fingerprint, this);
    ...
    private void checkLocked(final LMedSRobustRangingPositionEstimator2D estimator) {
        try {
