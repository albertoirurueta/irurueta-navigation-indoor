...
class LMedSRobustRangingPositionEstimator2DTest implements RobustRangingPositionEstimatorListener<Point2D> {

    private static final Logger LOGGER = Logger.getLogger(LMedSRobustRangingPositionEstimator2DTest.class.getName());
    ...
    void testConstructor() {
        // empty constructor
        var estimator = new LMedSRobustRangingPositionEstimator2D();
        ...
        estimator = new LMedSRobustRangingPositionEstimator2D(sources);
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new LMedSRobustRangingPositionEstimator2D((List<WifiAccessPointLocated2D>) null));
        final var wrongSources = new ArrayList<WifiAccessPointLocated2D>();
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustRangingPositionEstimator2D(wrongSources));

        // constructor with fingerprints
        final var fingerprint = new RangingFingerprint<>();
        estimator = new LMedSRobustRangingPositionEstimator2D(fingerprint);
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustRangingPositionEstimator2D(
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustRangingPositionEstimator2D(null,
                fingerprint));
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustRangingPositionEstimator2D(wrongSources,
                fingerprint));
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustRangingPositionEstimator2D(sources,
                (RangingFingerprint<WifiAccessPoint, RangingReading<WifiAccessPoint>>) null));
        ...
        estimator = new LMedSRobustRangingPositionEstimator2D(sources, fingerprint, this);
    ...
    void testGetSetStopThreshold() throws LockedException {
        final var estimator = new LMedSRobustRangingPositionEstimator2D();
    ...
    void testGetSetPreliminarySubsetSize() throws LockedException {
        final var estimator = spy(new LMedSRobustRangingPositionEstimator2D());
    ...
    void testEstimate() throws LockedException, RobustEstimatorException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new LMedSRobustRangingPositionEstimator2D(sources, fingerprint, this);
    ...
    public void onEstimateStart(final RobustRangingPositionEstimator<Point2D> estimator) {
        estimateStart++;
        checkLocked((LMedSRobustRangingPositionEstimator2D) estimator);
    }
    ...
    private static void checkLocked(final LMedSRobustRangingPositionEstimator2D estimator) {
