...
class LinearRssiPositionEstimator2DTest implements RssiPositionEstimatorListener<Point2D> {
    ...
    void testConstructor() {
        // empty constructor
        var estimator = new LinearRssiPositionEstimator2D();
        ...
        assertThrows(IllegalArgumentException.class, () -> new LinearRssiPositionEstimator2D(
                (List<WifiAccessPointLocated2D>) null));
        final var wrongSources = new ArrayList<WifiAccessPointLocated2D>();
        assertThrows(IllegalArgumentException.class, () -> new LinearRssiPositionEstimator2D(wrongSources));
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new LinearRssiPositionEstimator2D(null,
                fingerprint));
        assertThrows(IllegalArgumentException.class, () -> new LinearRssiPositionEstimator2D(wrongSources,
                fingerprint));
        assertThrows(IllegalArgumentException.class, () -> new LinearRssiPositionEstimator2D(sources,
                (RssiFingerprint<WifiAccessPoint, RssiReading<WifiAccessPoint>>) null));
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new LinearRssiPositionEstimator2D(null, fingerprint,
                this));
        assertThrows(IllegalArgumentException.class, () -> new LinearRssiPositionEstimator2D(wrongSources, fingerprint,
                this));
        assertThrows(IllegalArgumentException.class, () -> new LinearRssiPositionEstimator2D(sources, null,
                this));
    }

    @Test
    void testGetSetSources() throws LockedException {
        final var estimator = new LinearRssiPositionEstimator2D();
    ...
    void testEstimateNoErrorHomogeneous() throws LockedException, NotReadyException, PositionEstimationException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new LinearRssiPositionEstimator2D(sources, fingerprint, this);
    ...
    private static void checkLocked(final LinearRssiPositionEstimator2D estimators) {
