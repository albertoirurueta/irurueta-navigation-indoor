...
public class LMedSRobustRangingAndRssiPositionEstimator2DTest implements
    ...
    public void testConstructor() {
        // empty constructor
        LMedSRobustRangingAndRssiPositionEstimator2D estimator =
                new LMedSRobustRangingAndRssiPositionEstimator2D();
        ...
        estimator = null;
        try {
            estimator = new LMedSRobustRangingAndRssiPositionEstimator2D(
        ...
        estimator = null;
        try {
            estimator = new LMedSRobustRangingAndRssiPositionEstimator2D(null, fingerprint);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = null;
        try {
            estimator = new LMedSRobustRangingAndRssiPositionEstimator2D(null,
                    fingerprint, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
    ...
    public void testGetSetStopThreshold() throws LockedException {
        final LMedSRobustRangingAndRssiPositionEstimator2D estimator =
                new LMedSRobustRangingAndRssiPositionEstimator2D();
    ...
    public void testGetSetPreliminarySubsetSize() throws LockedException {
        final LMedSRobustRangingAndRssiPositionEstimator2D estimator =
                spy(new LMedSRobustRangingAndRssiPositionEstimator2D());
    ...
    public void testEstimate() throws LockedException, RobustEstimatorException, NotReadyException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final LMedSRobustRangingAndRssiPositionEstimator2D estimator =
                    new LMedSRobustRangingAndRssiPositionEstimator2D(sources, fingerprint, this);
    ...
    private double receivedPower(final double equivalentTransmittedPower,
        ...
        final double k = Math.pow(SPEED_OF_LIGHT / (4.0 * Math.PI *
                        LMedSRobustRangingAndRssiPositionEstimator2DTest.FREQUENCY),
                pathLossExponent);
        return equivalentTransmittedPower * k /
                Math.pow(distance, pathLossExponent);
    }

    private void checkLocked(final LMedSRobustRangingAndRssiPositionEstimator2D estimator) {
        try {
