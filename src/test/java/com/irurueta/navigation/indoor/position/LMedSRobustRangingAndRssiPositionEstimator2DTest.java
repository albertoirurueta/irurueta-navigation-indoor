...
class LMedSRobustRangingAndRssiPositionEstimator2DTest implements
        RobustRangingAndRssiPositionEstimatorListener<Point2D> {

    private static final Logger LOGGER = Logger.getLogger(
            LMedSRobustRangingAndRssiPositionEstimator2DTest.class.getName());
    ...
    void testConstructor() {
        // empty constructor
        var estimator = new LMedSRobustRangingAndRssiPositionEstimator2D();
        ...
        estimator = new LMedSRobustRangingAndRssiPositionEstimator2D(sources);
        ...
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustRangingAndRssiPositionEstimator2D(
        ...
        estimator = new LMedSRobustRangingAndRssiPositionEstimator2D(fingerprint);
        ...
        estimator = new LMedSRobustRangingAndRssiPositionEstimator2D(sources, fingerprint);
        ...
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustRangingAndRssiPositionEstimator2D(sources,
                (RangingAndRssiFingerprint<WifiAccessPoint, RangingAndRssiReading<WifiAccessPoint>>) null));

        // constructor with listener
        estimator = new LMedSRobustRangingAndRssiPositionEstimator2D(this);
        ...
        estimator = new LMedSRobustRangingAndRssiPositionEstimator2D(sources, this);
        ...
        estimator = new LMedSRobustRangingAndRssiPositionEstimator2D(fingerprint, this);
        ...
        estimator = new LMedSRobustRangingAndRssiPositionEstimator2D(sources, fingerprint, this);
    ...
    void testGetSetStopThreshold() throws LockedException {
        final var estimator = new LMedSRobustRangingAndRssiPositionEstimator2D();
    ...
    void testGetSetPreliminarySubsetSize() throws LockedException {
        final var estimator = spy(new LMedSRobustRangingAndRssiPositionEstimator2D());
    ...
    void testEstimate() throws LockedException, RobustEstimatorException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new LMedSRobustRangingAndRssiPositionEstimator2D(sources, fingerprint, this);
    ...
    public void onEstimateStart(final RobustRangingAndRssiPositionEstimator<Point2D> estimator) {
        estimateStart++;
        checkLocked((LMedSRobustRangingAndRssiPositionEstimator2D) estimator);
    }
    ...
    private static double receivedPower(final double equivalentTransmittedPower, final double distance,
        ...
        final var k = Math.pow(SPEED_OF_LIGHT / (4.0 * Math.PI
                        * LMedSRobustRangingAndRssiPositionEstimator2DTest.FREQUENCY), pathLossExponent);
        return equivalentTransmittedPower * k / Math.pow(distance, pathLossExponent);
    }

    private static void checkLocked(final LMedSRobustRangingAndRssiPositionEstimator2D estimator) {
