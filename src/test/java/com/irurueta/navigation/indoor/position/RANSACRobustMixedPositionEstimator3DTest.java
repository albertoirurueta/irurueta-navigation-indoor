...
class RANSACRobustMixedPositionEstimator3DTest implements RobustMixedPositionEstimatorListener<Point3D> {

    private static final Logger LOGGER = Logger.getLogger(RANSACRobustMixedPositionEstimator3DTest.class.getName());
    ...
    void testConstructor() {
        // empty constructor
        var estimator = new RANSACRobustMixedPositionEstimator3D();
        ...
        estimator = new RANSACRobustMixedPositionEstimator3D(sources);
        ...
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustMixedPositionEstimator3D(
                (List<WifiAccessPointLocated3D>) null));
        final var wrongSources = new ArrayList<WifiAccessPointLocated3D>();
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustMixedPositionEstimator3D(wrongSources));

        // constructor with fingerprints
        final var fingerprint = new Fingerprint<WifiAccessPoint, Reading<WifiAccessPoint>>();
        estimator = new RANSACRobustMixedPositionEstimator3D(fingerprint);
        ...
        estimator = new RANSACRobustMixedPositionEstimator3D(sources, fingerprint);
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustMixedPositionEstimator3D(null,
                fingerprint));
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustMixedPositionEstimator3D(wrongSources,
                fingerprint));
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustMixedPositionEstimator3D(sources,
                (Fingerprint<WifiAccessPoint, Reading<WifiAccessPoint>>) null));

        // constructor with listener
        estimator = new RANSACRobustMixedPositionEstimator3D(this);
        ...
        estimator = new RANSACRobustMixedPositionEstimator3D(sources, this);
        ...
        estimator = new RANSACRobustMixedPositionEstimator3D(fingerprint, this);
        ...
        estimator = new RANSACRobustMixedPositionEstimator3D(sources, fingerprint, this);
        ...
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustMixedPositionEstimator3D(wrongSources,
                fingerprint, this));
        assertThrows(IllegalArgumentException.class, () -> new RANSACRobustMixedPositionEstimator3D(sources, null,
                this));
    }

    @Test
    void testGetSetThreshold() throws LockedException {
        final var estimator = new RANSACRobustMixedPositionEstimator3D();
    ...
    void testGetSetInitialPosition() throws LockedException {
        final var solver = new RANSACRobustMixedPositionEstimator3D();
    ...
    void testGetSetPreliminarySubsetSize() throws LockedException {
        final var estimator = spy(new RANSACRobustMixedPositionEstimator3D());
    ...
    void testEstimate() throws LockedException, RobustEstimatorException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            for (var i = 0; i < numSources; i++) {
                ...
                readings.add(new RangingAndRssiReading<>(accessPoint, Math.max(0.0, distance + errorRanging),
                        rssi + errorRssi, RANGING_STD, Math.sqrt(RX_POWER_VARIANCE)));
                ...
                readings.add(new RangingReading<>(accessPoint, Math.max(0.0, distance + errorRanging), RANGING_STD));
                ...
                readings.add(new RssiReading<>(accessPoint, rssi + errorRssi, Math.sqrt(RX_POWER_VARIANCE)));
            }

            final var fingerprint = new Fingerprint<>(readings);

            final var estimator = new RANSACRobustMixedPositionEstimator3D(sources, fingerprint, this);
    ...
    @Test
    void testEstimateLinearSolverUsedInhomogeneousPreliminaryRefined() throws LockedException, RobustEstimatorException,
    ...
    public void onEstimateStart(final RobustMixedPositionEstimator<Point3D> estimator) {
        estimateStart++;
        checkLocked((RANSACRobustMixedPositionEstimator3D) estimator);
    }
    ...
    private static double receivedPower(final double equivalentTransmittedPower, final double distance,
        ...
        final var k = Math.pow(SPEED_OF_LIGHT / (4.0 * Math.PI * RANSACRobustMixedPositionEstimator3DTest.FREQUENCY),
                pathLossExponent);
        return equivalentTransmittedPower * k / Math.pow(distance, pathLossExponent);
    }

    private static void checkLocked(final RANSACRobustMixedPositionEstimator3D estimator) {
