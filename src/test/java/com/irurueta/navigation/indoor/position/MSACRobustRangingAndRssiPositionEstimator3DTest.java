...
class MSACRobustRangingAndRssiPositionEstimator3DTest implements
        RobustRangingAndRssiPositionEstimatorListener<Point3D> {

    private static final Logger LOGGER = Logger.getLogger(
            MSACRobustRangingAndRssiPositionEstimator3DTest.class.getName());
    ...
    void testConstructor() {
        // empty constructor
        var estimator = new MSACRobustRangingAndRssiPositionEstimator3D();
        ...
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustRangingAndRssiPositionEstimator3D(
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustRangingAndRssiPositionEstimator3D(null,
                fingerprint));
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustRangingAndRssiPositionEstimator3D(wrongSources,
                fingerprint));
        assertThrows(IllegalArgumentException.class, () -> new MSACRobustRangingAndRssiPositionEstimator3D(sources,
                (RangingAndRssiFingerprint<WifiAccessPoint, RangingAndRssiReading<WifiAccessPoint>>) null));
    ...
    void testGetSetThreshold() throws LockedException {
        final var estimator = new MSACRobustRangingAndRssiPositionEstimator3D();
    ...
    void testGetSetPreliminarySubsetSize() throws LockedException {
        final var estimator = spy(new MSACRobustRangingAndRssiPositionEstimator3D());
    ...
    void testEstimate() throws LockedException, RobustEstimatorException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new MSACRobustRangingAndRssiPositionEstimator3D(sources, fingerprint, this);
    ...
    private static double receivedPower(final double equivalentTransmittedPower, final double distance,
        ...
        final var k = Math.pow(SPEED_OF_LIGHT / (4.0 * Math.PI
                        * MSACRobustRangingAndRssiPositionEstimator3DTest.FREQUENCY), pathLossExponent);
        return equivalentTransmittedPower * k / Math.pow(distance, pathLossExponent);
    }

    private static void checkLocked(final MSACRobustRangingAndRssiPositionEstimator3D estimator) {
