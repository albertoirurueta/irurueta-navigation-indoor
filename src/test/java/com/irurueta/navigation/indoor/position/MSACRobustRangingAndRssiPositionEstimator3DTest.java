...
public class MSACRobustRangingAndRssiPositionEstimator3DTest implements
    ...
    public void testConstructor() {
        // empty constructor
        MSACRobustRangingAndRssiPositionEstimator3D estimator =
    ...
    private double receivedPower(final double equivalentTransmittedPower,
        ...
        final double k = Math.pow(SPEED_OF_LIGHT / (4.0 * Math.PI *
                        MSACRobustRangingAndRssiPositionEstimator3DTest.FREQUENCY),
                pathLossExponent);
        return equivalentTransmittedPower * k /
                Math.pow(distance, pathLossExponent);
    }

    private void checkLocked(final MSACRobustRangingAndRssiPositionEstimator3D estimator) {
        try {
