...
public class MSACRobustRssiPositionEstimator2DTest implements RobustRssiPositionEstimatorListener<Point2D> {

    private static final Logger LOGGER = Logger.getLogger(
            MSACRobustRssiPositionEstimator2DTest.class.getName());
    ...
    public void testConstructor() {
        // empty constructor
        MSACRobustRssiPositionEstimator2D estimator = new MSACRobustRssiPositionEstimator2D();
        ...
        estimator = new MSACRobustRssiPositionEstimator2D(sources);
        ...
        estimator = null;
        try {
            estimator = new MSACRobustRssiPositionEstimator2D(
        ...
        RssiFingerprint<WifiAccessPoint, RssiReading<WifiAccessPoint>> fingerprint =
                new RssiFingerprint<>();
        estimator = new MSACRobustRssiPositionEstimator2D(fingerprint);
        ...
        estimator = new MSACRobustRssiPositionEstimator2D(sources, fingerprint);
        ...
        estimator = null;
        try {
            estimator = new MSACRobustRssiPositionEstimator2D(null, fingerprint);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        estimator = new MSACRobustRssiPositionEstimator2D(this);
        ...
        estimator = new MSACRobustRssiPositionEstimator2D(sources, this);
        ...
        estimator = new MSACRobustRssiPositionEstimator2D(fingerprint, this);
        ...
        estimator = new MSACRobustRssiPositionEstimator2D(sources, fingerprint, this);
        ...
        estimator = null;
        try {
            estimator = new MSACRobustRssiPositionEstimator2D(null, fingerprint, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
        ...
        try {
            estimator = new MSACRobustRssiPositionEstimator2D(sources, null, this);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        assertNull(estimator);
    ...
    public void testGetSetThreshold() throws LockedException {
        final MSACRobustRssiPositionEstimator2D estimator = new MSACRobustRssiPositionEstimator2D();
    ...
    public void testGetSetInitialPosition() throws LockedException {
        final MSACRobustRssiPositionEstimator2D solver = new MSACRobustRssiPositionEstimator2D();
    ...
    public void testGetSetPreliminarySubsetSize() throws LockedException {
        final MSACRobustRssiPositionEstimator2D estimator = spy(new MSACRobustRssiPositionEstimator2D());
    ...
    public void testEstimate() throws LockedException, RobustEstimatorException, NotReadyException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final MSACRobustRssiPositionEstimator2D estimator =
                    new MSACRobustRssiPositionEstimator2D(sources, fingerprint, this);
    ...
    public void onEstimateStart(final RobustRssiPositionEstimator<Point2D> estimator) {
        estimateStart++;
        checkLocked((MSACRobustRssiPositionEstimator2D) estimator);
    }
    ...
    public void onEstimateNextIteration(
            final RobustRssiPositionEstimator<Point2D> estimator, final int iteration) {
    ...
    public void onEstimateProgressChange(
            final RobustRssiPositionEstimator<Point2D> estimator, final float progress) {
    ...
    private double receivedPower(final double equivalentTransmittedPower,
        ...
        final double k = Math.pow(SPEED_OF_LIGHT / (4.0 * Math.PI * MSACRobustRssiPositionEstimator2DTest.FREQUENCY),
                pathLossExponent);
        return equivalentTransmittedPower * k / Math.pow(distance, pathLossExponent);
    }

    private void checkLocked(final MSACRobustRssiPositionEstimator2D estimator) {
        try {
