...
public class MSACRobustRssiPositionEstimator2DTest implements
    ...
    public void testConstructor() {
        // empty constructor
        MSACRobustRssiPositionEstimator2D estimator =
                new MSACRobustRssiPositionEstimator2D();
    ...
    public void testGetSetInitialPosition() throws LockedException {
        final MSACRobustRssiPositionEstimator2D solver =
                new MSACRobustRssiPositionEstimator2D();
    ...
    public void testGetSetPreliminarySubsetSize() throws LockedException {
        final MSACRobustRssiPositionEstimator2D estimator =
                spy(new MSACRobustRssiPositionEstimator2D());
    ...
    public void testEstimate() throws LockedException, RobustEstimatorException,
        ...
        for (int t = 0; t < TIMES; t++) {
            ...
            final MSACRobustRssiPositionEstimator2D estimator =
                    new MSACRobustRssiPositionEstimator2D(sources, fingerprint,
                            this);
