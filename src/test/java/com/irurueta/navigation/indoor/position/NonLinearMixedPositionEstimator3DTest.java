...
class NonLinearMixedPositionEstimator3DTest implements MixedPositionEstimatorListener<Point3D> {
    ...
    void testConstructor() {
        // empty constructor
        var estimator = new NonLinearMixedPositionEstimator3D();
        ...
        assertThrows(IllegalArgumentException.class, () -> new NonLinearMixedPositionEstimator3D(
                (List<WifiAccessPointLocated3D>) null));
        final var wrongSources = new ArrayList<WifiAccessPointLocated3D>();
        assertThrows(IllegalArgumentException.class, () -> new NonLinearMixedPositionEstimator3D(wrongSources));
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new NonLinearMixedPositionEstimator3D(null,
                fingerprint));
        assertThrows(IllegalArgumentException.class, () -> new NonLinearMixedPositionEstimator3D(wrongSources,
                fingerprint));
        assertThrows(IllegalArgumentException.class, () -> new NonLinearMixedPositionEstimator3D(sources,
                (Fingerprint<WifiAccessPoint, Reading<WifiAccessPoint>>) null));
        ...
        estimator = new NonLinearMixedPositionEstimator3D(sources, fingerprint, this);
        ...
        estimator = new NonLinearMixedPositionEstimator3D(sources, fingerprint, initialPosition);
        ...
        estimator = new NonLinearMixedPositionEstimator3D(initialPosition, this);
        ...
        estimator = new NonLinearMixedPositionEstimator3D(sources, initialPosition, this);
        ...
        estimator = new NonLinearMixedPositionEstimator3D(fingerprint, initialPosition, this);
        ...
        // force IllegalArgumentException
        assertThrows(IllegalArgumentException.class, () -> new NonLinearMixedPositionEstimator3D(
                (Fingerprint<WifiAccessPoint, Reading<WifiAccessPoint>>) null, initialPosition, this));

        // constructor with sources, fingerprint, initial position and listener
        estimator = new NonLinearMixedPositionEstimator3D(sources, fingerprint, initialPosition, this);
    ...
    void testGetSetInitialPosition() throws LockedException {
        final var estimator = new NonLinearMixedPositionEstimator3D();
    ...
    @Test
    void testEstimateRssidNoError() throws LockedException, NotReadyException, PositionEstimationException {
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new NonLinearMixedPositionEstimator3D(sources, fingerprint, this);
    ...
    @Test
    void testEstimateRssidNoErrorWithInitialPosition() throws LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new NonLinearMixedPositionEstimator3D(sources, fingerprint, position, this);
    ...
    @Test
    void testEstimateRangingNoError() throws LockedException, NotReadyException, PositionEstimationException {
        final var randomizer = new UniformRandomizer();
    ...
    @Test
    void testEstimateRangingNoErrorWithInitialPosition() throws LockedException, NotReadyException,
            PositionEstimationException {
        final var randomizer = new UniformRandomizer();
    ...
    @Test
    void testEstimateRangingAndRssiNoError() throws LockedException, NotReadyException, PositionEstimationException {
        final var randomizer = new UniformRandomizer();
    ...
    @Test
    void testEstimateRangingAndNoErrorWithInitialPosition() throws LockedException, NotReadyException,
            PositionEstimationException {
        final var randomizer = new UniformRandomizer();
    ...
    @Test
    void testEstimateMixedNoError() throws LockedException, NotReadyException, PositionEstimationException {
        final var randomizer = new UniformRandomizer();
    ...
    @Test
    void testEstimateMixedNoErrorWithInitialPosition() throws LockedException, NotReadyException,
            PositionEstimationException {
        final var randomizer = new UniformRandomizer();
    ...
    private static void checkLocked(final NonLinearMixedPositionEstimator3D estimator) {
