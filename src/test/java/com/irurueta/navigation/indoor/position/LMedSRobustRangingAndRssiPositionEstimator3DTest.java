...
class LMedSRobustRangingAndRssiPositionEstimator3DTest implements
    ...
    void testConstructor() {
        // empty constructor
        var estimator = new LMedSRobustRangingAndRssiPositionEstimator3D();
        ...
        estimator = new LMedSRobustRangingAndRssiPositionEstimator3D(sources);
        ...
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustRangingAndRssiPositionEstimator3D(
        ...
        estimator = new LMedSRobustRangingAndRssiPositionEstimator3D(fingerprint);
        ...
        estimator = new LMedSRobustRangingAndRssiPositionEstimator3D(sources, fingerprint);
        ...
        assertThrows(IllegalArgumentException.class, () -> new LMedSRobustRangingAndRssiPositionEstimator3D(sources,
                (RangingAndRssiFingerprint<WifiAccessPoint, RangingAndRssiReading<WifiAccessPoint>>) null));

        // constructor with listener
        estimator = new LMedSRobustRangingAndRssiPositionEstimator3D(this);
        ...
        estimator = new LMedSRobustRangingAndRssiPositionEstimator3D(sources, this);
        ...
        estimator = new LMedSRobustRangingAndRssiPositionEstimator3D(fingerprint, this);
        ...
        estimator = new LMedSRobustRangingAndRssiPositionEstimator3D(sources, fingerprint, this);
    ...
    void testGetSetStopThreshold() throws LockedException {
        final var estimator = new LMedSRobustRangingAndRssiPositionEstimator3D();
    ...
    void testGetSetPreliminarySubsetSize() throws LockedException {
        final var estimator = spy(new LMedSRobustRangingAndRssiPositionEstimator3D());
    ...
    void testEstimate() throws LockedException, RobustEstimatorException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            final var estimator = new LMedSRobustRangingAndRssiPositionEstimator3D(sources, fingerprint, this);
    ...
    public void onEstimateStart(final RobustRangingAndRssiPositionEstimator<Point3D> estimator) {
        estimateStart++;
        checkLocked((LMedSRobustRangingAndRssiPositionEstimator3D) estimator);
    }
    ...
    private static double receivedPower(
        ...
        final var k = Math.pow(SPEED_OF_LIGHT / (4.0 * Math.PI
                * LMedSRobustRangingAndRssiPositionEstimator3DTest.FREQUENCY), pathLossExponent);
        return equivalentTransmittedPower * k / Math.pow(distance, pathLossExponent);
    }

    private static void checkLocked(final LMedSRobustRangingAndRssiPositionEstimator3D estimator) {
