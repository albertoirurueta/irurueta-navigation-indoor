...
class FirstOrderNonLinearFingerprintPositionEstimator3DTest implements FingerprintPositionEstimatorListener<Point3D> {

    private static final Logger LOGGER = Logger.getLogger(
            FirstOrderNonLinearFingerprintPositionEstimator3DTest.class.getName());
    ...
    void testConstructor() {
        ...
        var estimator = new FirstOrderNonLinearFingerprintPositionEstimator3D();
        ...
        estimator = new FirstOrderNonLinearFingerprintPositionEstimator3D(this);
        ...
        estimator = new FirstOrderNonLinearFingerprintPositionEstimator3D(locatedFingerprints, fingerprint, sources);
        ...
        final var wrongLocatedFingerprints =
                new ArrayList<RssiFingerprintLocated3D<RadioSource, RssiReading<RadioSource>>>();
        assertThrows(IllegalArgumentException.class, () -> new FirstOrderNonLinearFingerprintPositionEstimator3D(
    ...
    void testGetSetLocatedFingerprints() throws LockedException {
        final var estimator = new FirstOrderNonLinearFingerprintPositionEstimator3D();
    ...
    void testEstimateWithoutErrorWithoutBiasAndWithoutInitialPosition() throws LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            var estimator = new FirstOrderNonLinearFingerprintPositionEstimator3D(locatedFingerprints, fingerprint,
                    sources, this);
        ...
        for (var time = 0; time < TIMES; time++) {
            ...
            for (var t = 0; t < TIMES; t++) {
                ...
                for (final var source : sources) {
                    ...
                    final var receivedRssi = Utils.powerTodBm(receivedPower(Utils.dBmToPower(transmittedPowerdBm),
                            distance, LinearFingerprintPositionEstimator3D.DEFAULT_PATH_LOSS_EXPONENT)) + RSSI_BIAS;
                    final var reading = new RssiReading<>((RadioSource) source, receivedRssi);
                    readings.add(reading);
                }
                ...
                // create estimator with means removed only on finder
                estimator = new FirstOrderNonLinearFingerprintPositionEstimator3D(locatedFingerprints, fingerprint,
                        sources, this);
                estimator.setUseNoMeanNearestFingerprintFinder(true);
                estimator.setMeansFromFingerprintReadingsRemoved(false);
            ...
            if (bestNum != numBestIsNoMeansEstimatedPosition) {
                continue;
            }
    ...
    void testEstimateWithErrorWithBiasAndWithoutInitialPosition() throws LockedException, NotReadyException,
        ...
        assertTrue(bestNum == numBestIsNoMeanRssiPosition || bestNum == numBestIsNoMeansEstimatedPosition
    ...
    void testEstimateWithoutErrorWithoutBiasAndWithInitialPosition() throws LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            // create estimator with means removed on finder and fingerprints
            var linearEstimator = new LinearFingerprintPositionEstimator3D(locatedFingerprints, fingerprint, sources);
            ...
            var nonLinearEstimator = new FirstOrderNonLinearFingerprintPositionEstimator3D(locatedFingerprints,
            ...
            // create estimator with means removed only on finder
            linearEstimator = new LinearFingerprintPositionEstimator3D(locatedFingerprints, fingerprint, sources);
            linearEstimator.setUseNoMeanNearestFingerprintFinder(true);
            ...
            nonLinearEstimator = new FirstOrderNonLinearFingerprintPositionEstimator3D(locatedFingerprints, fingerprint,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            for (var i = 0; i < numSources; i++) {
                ...
                final var accessPoint = new WifiAccessPointWithPowerAndLocated3D("bssid" + i, FREQUENCY,
                        ...
                        LinearFingerprintPositionEstimator3D.DEFAULT_PATH_LOSS_EXPONENT, pathLossStd, position,
                        positionCovariance);
                sources.add(accessPoint);
            }
    ...
    void testEstimateWithErrorWithBiasAndWithVariancePropagation() throws LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            // create linear estimator to obtain initial position
            final var linearEstimator = new LinearFingerprintPositionEstimator3D(locatedFingerprints, fingerprint,
                    sources);
        ...
        assertTrue(bestNum == numBestIsNoMeanRssiPosition || bestNum == numBestIsNoMeanFinderEstimatedPosition
                || bestNum == numBestIsNoMeanReadingsEstimatedPosition || bestNum == numBestIsNoMeansEstimatedPosition);
        assertTrue(bestPos == 0 || bestPos == 2 || bestPos == 3 || bestPos == 4);
    }

    @Override
    public void onEstimateStart(final FingerprintPositionEstimator<Point3D> estimator) {
        estimateStart++;
        checkLocked((FirstOrderNonLinearFingerprintPositionEstimator3D) estimator);
    }
    ...
    private void checkLocked(final FirstOrderNonLinearFingerprintPositionEstimator3D estimator) {
