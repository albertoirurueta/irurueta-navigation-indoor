...
class SecondOrderNonLinearFingerprintPositionEstimator2DTest
    ...
    void testConstructor() {
        ...
        var estimator = new SecondOrderNonLinearFingerprintPositionEstimator2D();
        ...
        estimator = new SecondOrderNonLinearFingerprintPositionEstimator2D(locatedFingerprints, fingerprint, sources);
        ...
        final var wrongLocatedFingerprints =
                new ArrayList<RssiFingerprintLocated2D<RadioSource, RssiReading<RadioSource>>>();
        assertThrows(IllegalArgumentException.class, () -> new SecondOrderNonLinearFingerprintPositionEstimator2D(
    ...
    void testGetSetLocatedFingerprints() throws LockedException {
        final var estimator = new SecondOrderNonLinearFingerprintPositionEstimator2D();
    ...
    void testEstimateWithoutErrorWithoutBiasAndWithoutInitialPosition() throws LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            var estimator = new SecondOrderNonLinearFingerprintPositionEstimator2D(locatedFingerprints, fingerprint,
                    sources, this);
            ...
            estimator = new SecondOrderNonLinearFingerprintPositionEstimator2D(locatedFingerprints, fingerprint,
                    sources, this);
            estimator.setUseNoMeanNearestFingerprintFinder(true);
    ...
    void testEstimateWithoutErrorWithoutBiasAndWithInitialPosition() throws LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            var nonLinearEstimator = new SecondOrderNonLinearFingerprintPositionEstimator2D(locatedFingerprints,
            ...
            nonLinearEstimator = new SecondOrderNonLinearFingerprintPositionEstimator2D(locatedFingerprints,
                    fingerprint, sources, initialPosition, this);
            nonLinearEstimator.setUseNoMeanNearestFingerprintFinder(true);
    ...
    @Test
    void testEstimateWithErrorWithBiasAndWithInitialPosition() throws LockedException,
