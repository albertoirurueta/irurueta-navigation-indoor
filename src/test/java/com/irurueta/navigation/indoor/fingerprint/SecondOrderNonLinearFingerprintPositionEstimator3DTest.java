...
class SecondOrderNonLinearFingerprintPositionEstimator3DTest implements FingerprintPositionEstimatorListener<Point3D> {

    private static final Logger LOGGER = Logger.getLogger(
            SecondOrderNonLinearFingerprintPositionEstimator3DTest.class.getName());
    ...
    void testConstructor() {
        ...
        var estimator = new SecondOrderNonLinearFingerprintPositionEstimator3D();
        ...
        estimator = new SecondOrderNonLinearFingerprintPositionEstimator3D(locatedFingerprints, fingerprint, sources);
        ...
        final var wrongLocatedFingerprints =
                new ArrayList<RssiFingerprintLocated3D<RadioSource, RssiReading<RadioSource>>>();
        assertThrows(IllegalArgumentException.class, () -> new SecondOrderNonLinearFingerprintPositionEstimator3D(
    ...
    void testGetSetLocatedFingerprints() throws LockedException {
        final var estimator = new SecondOrderNonLinearFingerprintPositionEstimator3D();
    ...
    void testEstimateWithoutErrorWithoutBiasAndWithoutInitialPosition() throws LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            var estimator = new SecondOrderNonLinearFingerprintPositionEstimator3D(locatedFingerprints, fingerprint,
                    sources, this);
            ...
            estimator = new SecondOrderNonLinearFingerprintPositionEstimator3D(locatedFingerprints, fingerprint,
                    sources, this);
            estimator.setUseNoMeanNearestFingerprintFinder(true);
    ...
    void testEstimateWithoutErrorWithoutBiasAndWithInitialPosition() throws LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            var nonLinearEstimator = new SecondOrderNonLinearFingerprintPositionEstimator3D(locatedFingerprints,
            ...
            nonLinearEstimator = new SecondOrderNonLinearFingerprintPositionEstimator3D(locatedFingerprints,
                    fingerprint, sources, initialPosition, this);
            nonLinearEstimator.setUseNoMeanNearestFingerprintFinder(true);
    ...
    void testEstimateCompareInitialPosition() throws LockedException, NotReadyException, FingerprintEstimationException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            nonLinearEstimator = new SecondOrderNonLinearFingerprintPositionEstimator3D(locatedFingerprints,
                    fingerprint, sources, position, this);
