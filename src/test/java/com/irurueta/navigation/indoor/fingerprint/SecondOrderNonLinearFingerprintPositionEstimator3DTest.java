...
public class SecondOrderNonLinearFingerprintPositionEstimator3DTest
    ...
    public void testConstructor() {
        ...
        Assert.assertEquals(NonLinearFingerprintPositionEstimatorType.SECOND_ORDER, estimator.getType());
