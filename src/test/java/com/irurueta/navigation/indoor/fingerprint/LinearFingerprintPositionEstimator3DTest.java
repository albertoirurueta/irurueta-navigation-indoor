...
class LinearFingerprintPositionEstimator3DTest implements FingerprintPositionEstimatorListener<Point3D> {

    private static final Logger LOGGER = Logger.getLogger(LinearFingerprintPositionEstimator3DTest.class.getName());
    ...
    void testConstructor() {
        ...
        var estimator = new LinearFingerprintPositionEstimator3D();
        ...
        estimator = new LinearFingerprintPositionEstimator3D(this);
        ...
        estimator = new LinearFingerprintPositionEstimator3D(locatedFingerprints, fingerprint, sources);
        ...
        final var wrongLocatedFingerprints =
                new ArrayList<RssiFingerprintLocated3D<RadioSource, RssiReading<RadioSource>>>();
        assertThrows(IllegalArgumentException.class, () -> new LinearFingerprintPositionEstimator3D(
                wrongLocatedFingerprints, fingerprint, sources));
        assertThrows(IllegalArgumentException.class, () -> new LinearFingerprintPositionEstimator3D(
                null, fingerprint, sources));
        assertThrows(IllegalArgumentException.class, () -> new LinearFingerprintPositionEstimator3D(locatedFingerprints,
                null, sources));
        assertThrows(IllegalArgumentException.class, () -> new LinearFingerprintPositionEstimator3D(locatedFingerprints,
                fingerprint, null));

        // test constructor with located fingerprints, fingerprint, sources and listener
        estimator = new LinearFingerprintPositionEstimator3D(locatedFingerprints, fingerprint, sources, this);
    ...
    void testGetSetLocatedFingerprints() throws LockedException {
        final var estimator = new LinearFingerprintPositionEstimator3D();
    ...
    void testEstimateWithoutErrorAndWithoutBias() throws LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            var estimator = new LinearFingerprintPositionEstimator3D(locatedFingerprints, fingerprint, sources,
                    this);
    ...
    void testEstimateWithoutErrorAndWithoutBiasOneRadioSource() throws LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            assertNotNull(estimator.getNearestFingerprints());
            assertEquals(3, estimator.getNearestFingerprints().size());
    ...
    public void onEstimateStart(final FingerprintPositionEstimator<Point3D> estimator) {
        estimateStart++;
        checkLocked((LinearFingerprintPositionEstimator3D) estimator);
    }
    ...
    private void checkLocked(final LinearFingerprintPositionEstimator3D estimator) {
