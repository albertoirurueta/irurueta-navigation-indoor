...
public class LinearFingerprintPositionEstimator3DTest implements FingerprintPositionEstimatorListener<Point3D> {

    private static final Logger LOGGER = Logger.getLogger(
            LinearFingerprintPositionEstimator3DTest.class.getName());
    ...
    public void testConstructor() {
        ...
        LinearFingerprintPositionEstimator3D estimator = new LinearFingerprintPositionEstimator3D();
        ...
        estimator = null;
        try {
            estimator = new LinearFingerprintPositionEstimator3D(
        ...
        try {
            estimator = new LinearFingerprintPositionEstimator3D(null,
                    fingerprint, sources);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
        try {
            estimator = new LinearFingerprintPositionEstimator3D(locatedFingerprints,
                    null, sources);
            fail("IllegalArgumentException expected but not thrown");
        } catch (final IllegalArgumentException ignore) {
        }
    ...
    public void testGetSetLocatedFingerprints() throws LockedException {
        final LinearFingerprintPositionEstimator3D estimator = new LinearFingerprintPositionEstimator3D();
    ...
    @Test
    public void testEstimateWithBias() throws LockedException, NotReadyException,
            FingerprintEstimationException {
        int numBestIsNoMeanRssiPosition = 0;
        int numBestIsRssiPosition = 0;
        int numBestIsNoMeansEstimatedPosition = 0;
    ...
    @Test
    public void testEstimateWithError() throws LockedException, NotReadyException,
            FingerprintEstimationException {
        int numBestIsNoMeanRssiPosition = 0;
        int numBestIsRssiPosition = 0;
        int numBestIsNoMeansEstimatedPosition = 0;
    ...
    @Test
    public void testEstimateWithErrorAndWithBias() throws LockedException, NotReadyException,
            FingerprintEstimationException {
        int numBestIsNoMeanRssiPosition = 0;
        int numBestIsRssiPosition = 0;
        int numBestIsNoMeansEstimatedPosition = 0;
