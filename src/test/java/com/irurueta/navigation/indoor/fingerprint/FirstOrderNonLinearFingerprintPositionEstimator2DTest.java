...
class FirstOrderNonLinearFingerprintPositionEstimator2DTest implements
        FingerprintPositionEstimatorListener<Point2D> {

    private static final Logger LOGGER = Logger.getLogger(
            FirstOrderNonLinearFingerprintPositionEstimator2DTest.class.getName());
    ...
    void testConstructor() {
        ...
        var estimator = new FirstOrderNonLinearFingerprintPositionEstimator2D();
        ...
        estimator = new FirstOrderNonLinearFingerprintPositionEstimator2D(this);
        ...
        final var locatedFingerprint = new RssiFingerprintLocated2D<>(readings,
                Point2D.create());

        final var locatedFingerprints = new ArrayList<RssiFingerprintLocated2D<RadioSource,
        ...
        for (var i = 0; i < Point2D.POINT2D_INHOMOGENEOUS_COORDINATES_LENGTH; i++) {
            final var source = new WifiAccessPointLocated2D("bssid" + i, FREQUENCY, Point2D.create());
            sources.add(source);
        }

        // test constructor with located fingerprints, fingerprint and sources
        estimator = new FirstOrderNonLinearFingerprintPositionEstimator2D(locatedFingerprints, fingerprint, sources);
        ...
        assertThrows(IllegalArgumentException.class, () -> new FirstOrderNonLinearFingerprintPositionEstimator2D(
        ...
        assertThrows(IllegalArgumentException.class, () -> new FirstOrderNonLinearFingerprintPositionEstimator2D(null,
    ...
    void testGetSetLocatedFingerprints() throws LockedException {
        final var estimator = new FirstOrderNonLinearFingerprintPositionEstimator2D();
        ...
        final var wrong = new ArrayList<RssiFingerprintLocated<RadioSource, RssiReading<RadioSource>, Point2D>>();
        assertThrows(IllegalArgumentException.class, () -> estimator.setLocatedFingerprints(wrong));
    }
    ...
    void testEstimateWithoutErrorWithoutBiasAndWithoutInitialPosition() throws LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            for (var j = 0; j < numFingerprints; j++) {
                ...
                final var locatedFingerprint = new RssiFingerprintLocated2D<>(
                        readings, position);
                locatedFingerprints.add(locatedFingerprint);
            }
            ...
            var estimator = new FirstOrderNonLinearFingerprintPositionEstimator2D(locatedFingerprints, fingerprint,
                    sources, this);
    ...
    void testEstimateWithErrorWithBiasAndWithoutInitialPosition() throws LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            for (var i = 0; i < numSources; i++) {
                ...
                final var accessPoint = new WifiAccessPointWithPowerAndLocated2D(
            ...
            // build located fingerprints
            final var numFingerprints = randomizer.nextInt(MIN_FINGERPRINTS, MAX_FINGERPRINTS);
            final var locatedFingerprints = new ArrayList<RssiFingerprintLocated2D<RadioSource, RssiReading<RadioSource>>>();
            for (var j = 0; j < numFingerprints; j++) {
                final var x = randomizer.nextDouble(MIN_POS, MAX_POS);
                final var y = randomizer.nextDouble(MIN_POS, MAX_POS);
                final var position = new InhomogeneousPoint2D(x, y);
    ...
    void testEstimateWithoutErrorAndWithoutBiasOneRadioSourceWithoutInitialPosition() throws LockedException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            for (final var source : sources) {
                ...
                final var receivedRssi = Utils.powerTodBm(receivedPower(Utils.dBmToPower(transmittedPowerdBm),
                        distance, LinearFingerprintPositionEstimator2D.DEFAULT_PATH_LOSS_EXPONENT));
                var reading = new RssiReading<>((RadioSource) source, receivedRssi);
                readings.add(reading);
            }
    ...
    void testEstimateWithoutErrorWithoutBiasAndWithInitialPosition() throws LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            var nonLinearEstimator = new FirstOrderNonLinearFingerprintPositionEstimator2D(locatedFingerprints,
            ...
            nonLinearEstimator = new FirstOrderNonLinearFingerprintPositionEstimator2D(locatedFingerprints, fingerprint,
    ...
    void testEstimateWithoutErrorAndWithoutBiasOneRadioSourceWithInitialPosition() throws LockedException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            for (var i = 0; i < numSources; i++) {
                ...
                final var accessPoint = new WifiAccessPointWithPowerAndLocated2D("bssid" + i, FREQUENCY, transmittedPowerdBm, position);
                sources.add(accessPoint);
            }
    ...
    void testEstimateWithErrorWithBiasAndWithVariancePropagation() throws LockedException, NotReadyException,
        ...
        for (var t = 0; t < TIMES; t++) {
            ...
            for (var j = 0; j < numFingerprints; j++) {
                ...
                final var positionStd = randomizer.nextDouble(
    ...
    public void onEstimateStart(final FingerprintPositionEstimator<Point2D> estimator) {
        estimateStart++;
        checkLocked((FirstOrderNonLinearFingerprintPositionEstimator2D) estimator);
    }
    ...
    private void checkLocked(final FirstOrderNonLinearFingerprintPositionEstimator2D estimator) {
        ...
        assertThrows(LockedException.class, () -> estimator.setFingerprintRssiStandardDeviationPropagated(false));
        assertThrows(LockedException.class,
                () -> estimator.setPathlossExponentStandardDeviationPropagated(false));
        assertThrows(LockedException.class, () -> estimator.setFingerprintPositionCovariancePropagated(false));
        assertThrows(LockedException.class, () -> estimator.setRadioSourcePositionCovariancePropagated(false));
