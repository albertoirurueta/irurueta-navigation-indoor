...
class RangingFingerprintLocated2DTest {

    @Test
    void testConstructor() throws AlgebraException {
        // empty constructor
        var fingerprint = new RangingFingerprintLocated2D<>();
        ...
        assertThrows(IllegalArgumentException.class, () -> new RangingFingerprintLocated2D<>(null, position));
        assertThrows(IllegalArgumentException.class, () -> new RangingFingerprintLocated2D<>(readings, null));
        ...
        assertThrows(IllegalArgumentException.class, () -> new RangingFingerprintLocated2D<>(readings, position, m));
    }
    ...
    void testSerializeDeserialize() throws WrongSizeException, IOException, ClassNotFoundException {
        ...
        final var position = new InhomogeneousPoint2D();
        final var cov = new Matrix(2, 2);
        final var fingerprint1 = new RangingFingerprintLocated2D<>(readings, position, cov);
        ...
        final var fingerprint2 =
                SerializationHelper.<RangingFingerprintLocated2D<RadioSource, RangingReading<RadioSource>>>deserialize(
                        bytes);
