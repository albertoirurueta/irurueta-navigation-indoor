...
class RangingAndRssiReadingLocated3DTest {
    private static final double FREQUENCY = 2.4e9;

    @Test
    void testConstructor() throws AlgebraException {
        // test empty constructor
        var reading = new RangingAndRssiReadingLocated3D<WifiAccessPoint>();
        ...
        assertThrows(IllegalArgumentException.class, () -> new RangingAndRssiReadingLocated3D<>(null,
                1.2, -50.0, position));
        assertThrows(IllegalArgumentException.class, () -> new RangingAndRssiReadingLocated3D<>(ap, -1.0,
                -50.0, position));
        assertThrows(IllegalArgumentException.class, () -> new RangingAndRssiReadingLocated3D<>(ap, 1.2,
                -50.0, null));

        // test constructor with access point, distance, rssi, position and number of measurements.
        reading = new RangingAndRssiReadingLocated3D<>(ap, 1.2, -50.0, position, 8,
                7);
        ...
        // deviation
        reading = new RangingAndRssiReadingLocated3D<>(ap, 1.5, -50.0, position, 0.1,
                0.2);
        ...
        assertThrows(IllegalArgumentException.class, () -> new RangingAndRssiReadingLocated3D<>(ap, 1.5,
                -50.0, null, 0.1, 0.2));
        assertThrows(IllegalArgumentException.class, () -> new RangingAndRssiReadingLocated3D<>(ap, 1.5,
        ...
        assertThrows(IllegalArgumentException.class, () -> new RangingAndRssiReadingLocated3D<>(ap, -1.0,
                -50.0, position, cov));
        assertThrows(IllegalArgumentException.class, () -> new RangingAndRssiReadingLocated3D<>(ap, 2.0,
                -50.0, null, cov));
        ...
        reading = new RangingAndRssiReadingLocated3D<>(ap, 2.5, -50.0, position, 0.1,
                0.2, cov);
        ...
        assertThrows(IllegalArgumentException.class, () -> new RangingAndRssiReadingLocated3D<>(ap, 2.5,
    ...
    void testHasSameAccessPoint() {
        ...
        final var reading1 = new RangingAndRssiReadingLocated3D<>(ap1, 1.5, -50.0, position);
        final var reading2 = new RangingAndRssiReadingLocated3D<>(ap1, 1.5, -50.0, position);
        final var reading3 = new RangingAndRssiReadingLocated3D<>(ap2, 1.5, -50.0, position);
    ...
    void testSerializeDeserialize() throws WrongSizeException, IOException, ClassNotFoundException {
        ...
        final var position = new InhomogeneousPoint3D();
        final var cov = new Matrix(3, 3);
        final var reading1 = new RangingAndRssiReadingLocated3D<>(ap, 2.5, -50.0, position,
                0.1, 0.2, cov, 8, 7);
        ...
        final var reading2 = SerializationHelper.<RangingAndRssiReadingLocated3D<WifiAccessPoint>>deserialize(bytes);
