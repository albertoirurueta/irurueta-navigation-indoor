 ...
 */
public class RssiFingerprintLocated2D<S extends RadioSource, R extends RssiReading<S>>
        extends RssiFingerprintLocated<S, R, Point2D> {
     ...
     */
    public RssiFingerprintLocated2D(
