 ...
 */
public class RangingFingerprint<S extends RadioSource, R extends RangingReading<S>> extends Fingerprint<S, R> {
     ...
     */
    public RangingFingerprint(final List<R> readings) {
        super(readings);
    }
}
