 ...
 */
public class RangingAndRssiReadingLocated3D<S extends RadioSource> extends RangingAndRssiReadingLocated<S, Point3D> {
    ...
    public RangingAndRssiReadingLocated3D(
            final S source, final double distance, final double rssi, final Point3D position) {
