 ...
 */
public class RangingAndRssiFingerprintLocated<S extends RadioSource, R extends RangingAndRssiReading<S>,
        P extends Point<?>> extends RangingAndRssiFingerprint<S, R> implements FingerprintLocated<P> {
     ...
     *                                  null.
     */
    public RangingAndRssiFingerprintLocated(final List<R> readings, final P position) {
        super(readings);
     ...
     */
    public RangingAndRssiFingerprintLocated(final List<R> readings, final P position, final Matrix positionCovariance) {
