 ...
 * point.
 */
public class ThirdOrderNonLinearFingerprintPositionEstimator3D extends NonLinearFingerprintPositionEstimator3D {

    /**
     * Constructor.
     */
    public ThirdOrderNonLinearFingerprintPositionEstimator3D() {
    }
    ...
    protected double evaluate(
        ...
        final var value10 = -10.0 / 6.0 * n / ln10 * (-2.0 * diffX1a * d1a4
                - (-diffX1a2 + diffY1a2 + diffZ1a2) * 4.0 * d1a2 * diffX1a) / d1a8;
        final var value11 = -10.0 / 6.0 * n / ln10 * (-2.0 * diffY1a * d1a4
                - (diffX1a2 - diffY1a2 + diffZ1a2) * 4.0 * d1a2 * diffY1a) / d1a8;
        final var value12 = -10.0 / 6.0 * n / ln10 * (-2.0 * diffZ1a * d1a4
                - (diffX1a2 + diffY1a2 - diffZ1a2) * 4.0 * d1a2 * diffZ1a) / d1a8;
        final var value13 = -5.0 * n / ln10 * (2.0 * diffY1a * d1a4
                - (-diffX1a2 + diffY1a2 + diffZ1a2) * 4.0 * d1a2 * diffY1a) / d1a8;
        final var value14 = -5.0 * n / ln10 * (2.0 * diffZ1a * d1a4
                - (-diffX1a2 + diffY1a2 + diffZ1a2) * 4.0 * d1a2 * diffZ1a) / d1a8;
        final var value15 = -5.0 * n / ln10 * (2.0 * diffX1a * d1a4
                - (diffX1a2 - diffY1a2 + diffZ1a2) * 4.0 * d1a2 * diffX1a) / d1a8;
        final var value16 = -5.0 * n / ln10 * (2.0 * diffX1a * d1a4
                - (diffX1a2 + diffY1a2 - diffZ1a2) * 4.0 * d1a2 * diffX1a) / d1a8;
        final var value17 = -5.0 * n / ln10 * (2.0 * diffZ1a * d1a4
                - (diffX1a2 - diffY1a2 + diffZ1a2) * 4.0 * d1a2 * diffZ1a) / d1a8;
        final var value18 = -5.0 * n / ln10 * (2.0 * diffY1a * d1a4
                - (diffX1a2 + diffY1a2 - diffZ1a2) * 4.0 * d1a2 * diffY1a) / d1a8;
        final var value19 = -80.0 * n / ln10 * (diffX1a * diffY1a * diffZ1a * d1a2) / d1a8;
        ...
        derivatives[0] = value1 + 2.0 * value4 * diffXi1 + value7 * diffYi1 + value9 * diffZi1
                + 3.0 * value10 * diffXi12 + 2.0 * value13 * diffXi1 * diffYi1 + 2.0 * value14 * diffXi1 * diffZi1
                + value15 * diffYi12 + value16 * diffZi12 + value19 * diffYi1 * diffZi1;
        ...
        derivatives[1] = value2 + 2.0 * value5 * diffYi1 + value7 * diffXi1 + value8 * diffZi1
                + 3.0 * value11 * diffYi12 + value13 * diffXi12 + 2.0 * value15 * diffXi1 * diffYi1
                + 2.0 * value17 * diffYi1 * diffZi1 + value18 * diffZi12 + value19 * diffXi1 * diffZi1;
        ...
        derivatives[2] = value3 + 2.0 * value6 * diffZi1 + value8 * diffYi1
                + value9 * diffXi1 + 3.0 * value12 * diffZi12 + value14 * diffXi12 + 2.0 * value16
                * diffXi1 * diffZi1 + value17 * diffYi12 + 2.0 * value18 * diffYi1 * diffZi1
    ...
    protected Double propagateVariances(
        ...
        try {
            final var dist = Utils.propagateVariancesToRssiVarianceThirdOrderNonLinear3D(fingerprintRssi,
