...
public class LMedSRobustRangingAndRssiRadioSourceEstimator3D<S extends RadioSource> extends
     ...
     *                                   (expressed in dBm's)
     */
    public LMedSRobustRangingAndRssiRadioSourceEstimator3D(final Double initialTransmittedPowerdBm) {
