...
public class PROSACRobustRangingRadioSourceEstimator2D<S extends RadioSource> extends
     ...
     */
    public PROSACRobustRangingRadioSourceEstimator2D(final List<? extends RangingReadingLocated<S, Point2D>> readings) {
        super(readings);
    }
     ...
     *                        source position.
     */
    public PROSACRobustRangingRadioSourceEstimator2D(final Point2D initialPosition) {
     ...
     */
    public PROSACRobustRangingRadioSourceEstimator2D(final double[] qualityScores) {
        super();
     ...
     *                                  of quality scores is less than required minimum.
     */
    public PROSACRobustRangingRadioSourceEstimator2D(final double[] qualityScores, final Point2D initialPosition) {
        super(initialPosition);
        internalSetQualityScores(qualityScores);
    }
