...
public class PROSACRobustRangingAndRssiRadioSourceEstimator3D<S extends RadioSource> extends
     ...
     *                        source position.
     */
    public PROSACRobustRangingAndRssiRadioSourceEstimator3D(final Point3D initialPosition) {
     ...
     *                                   (expressed in dBm's)
     */
    public PROSACRobustRangingAndRssiRadioSourceEstimator3D(final Double initialTransmittedPowerdBm) {
     ...
     */
    public PROSACRobustRangingAndRssiRadioSourceEstimator3D(final double[] qualityScores) {
        super();
