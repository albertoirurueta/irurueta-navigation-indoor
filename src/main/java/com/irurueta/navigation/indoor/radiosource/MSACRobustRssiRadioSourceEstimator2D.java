...
public class MSACRobustRssiRadioSourceEstimator2D<S extends RadioSource> extends RobustRssiRadioSourceEstimator2D<S> {
     ...
     */
    public MSACRobustRssiRadioSourceEstimator2D(final List<? extends RssiReadingLocated<S, Point2D>> readings) {
        super(readings);
    }
     ...
     */
    public MSACRobustRssiRadioSourceEstimator2D(final RobustRssiRadioSourceEstimatorListener<S, Point2D> listener) {
        super(listener);
    }
     ...
     *                        source position.
     */
    public MSACRobustRssiRadioSourceEstimator2D(final Point2D initialPosition) {
     ...
     *                                   (expressed in dBm's)
     */
    public MSACRobustRssiRadioSourceEstimator2D(final Double initialTransmittedPowerdBm) {
     ...
     *                                   (expressed in dBm's).
     */
    public MSACRobustRssiRadioSourceEstimator2D(final Point2D initialPosition, final Double initialTransmittedPowerdBm) {
    ...
    public void estimate() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        final var innerEstimator = new MSACRobustEstimator<>(new MSACRobustEstimatorListener<Solution<Point2D>>() {
            ...
            public void onEstimateNextIteration(
                ...
                if (listener != null) {
                    listener.onEstimateNextIteration(MSACRobustRssiRadioSourceEstimator2D.this, iteration);
                }
            }
            ...
            public void onEstimateProgressChange(
                ...
                if (listener != null) {
                    listener.onEstimateProgressChange(MSACRobustRssiRadioSourceEstimator2D.this, progress);
                }
            }
        });
