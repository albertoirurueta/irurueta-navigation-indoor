...
public class RANSACRobustRangingAndRssiRadioSourceEstimator3D<S extends RadioSource> extends
     ...
     *                        source position.
     */
    public RANSACRobustRangingAndRssiRadioSourceEstimator3D(final Point3D initialPosition) {
     ...
     *                                   (expressed in dBm's)
     */
    public RANSACRobustRangingAndRssiRadioSourceEstimator3D(final Double initialTransmittedPowerdBm) {
