...
public class MSACRobustRangingRadioSourceEstimator3D<S extends RadioSource> extends
     ...
     */
    public MSACRobustRangingRadioSourceEstimator3D(final List<? extends RangingReadingLocated<S, Point3D>> readings) {
        super(readings);
    }
     ...
     *                        source position.
     */
    public MSACRobustRangingRadioSourceEstimator3D(final Point3D initialPosition) {
    ...
    public void estimate() throws LockedException, NotReadyException, RobustEstimatorException {
        ...
        final var innerEstimator = new MSACRobustEstimator<>(new MSACRobustEstimatorListener<Solution<Point3D>>() {
            ...
            public void onEstimateNextIteration(
                ...
                if (listener != null) {
                    listener.onEstimateNextIteration(MSACRobustRangingRadioSourceEstimator3D.this, iteration);
                }
            }

            @Override
            public void onEstimateProgressChange(
                    final RobustEstimator<Solution<Point3D>> robustEstimator, final float progress) {
                if (listener != null) {
                    listener.onEstimateProgressChange(MSACRobustRangingRadioSourceEstimator3D.this, progress);
                }
            }
        });
