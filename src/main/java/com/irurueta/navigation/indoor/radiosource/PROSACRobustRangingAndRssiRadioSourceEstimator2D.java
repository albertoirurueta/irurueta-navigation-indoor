...
public class PROSACRobustRangingAndRssiRadioSourceEstimator2D<S extends RadioSource> extends
     ...
     * Constructor.
     */
    public PROSACRobustRangingAndRssiRadioSourceEstimator2D() {
        super();
    }
     ...
     *                        source position.
     */
    public PROSACRobustRangingAndRssiRadioSourceEstimator2D(final Point2D initialPosition) {
     ...
     *                                   (expressed in dBm's)
     */
    public PROSACRobustRangingAndRssiRadioSourceEstimator2D(final Double initialTransmittedPowerdBm) {
     ...
     */
    public PROSACRobustRangingAndRssiRadioSourceEstimator2D(final double[] qualityScores) {
        super();
            ...
            public void onEstimateNextIteration(
                ...
                if (listener != null) {
                    listener.onEstimateNextIteration(
                            PROSACRobustRangingAndRssiRadioSourceEstimator2D.this, iteration);
                }
            }
