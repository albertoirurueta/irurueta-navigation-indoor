...
public class PROSACRobustRssiRadioSourceEstimator3D<S extends RadioSource> extends
    ...
    public PROSACRobustRssiRadioSourceEstimator3D(
            final double[] qualityScores,
            final List<? extends RssiReadingLocated<S, Point3D>> readings,
            final Point3D initialPosition, Double initialTransmittedPowerdBm,
            final double initialPathLossExponent) {
        super(readings, initialPosition, initialTransmittedPowerdBm,
                initialPathLossExponent);
        internalSetQualityScores(qualityScores);
                            ...
                            public void onEstimateNextIteration(
                                ...
                                if (mListener != null) {
                                    mListener.onEstimateNextIteration(
                                            PROSACRobustRssiRadioSourceEstimator3D.this,
                                            iteration);
                                }
                            }
