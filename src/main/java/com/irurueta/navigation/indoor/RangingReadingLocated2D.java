...
public class RangingReadingLocated2D<S extends RadioSource> extends RangingReadingLocated<S, Point2D> {
     ...
     *                                  or position is null.
     */
    public RangingReadingLocated2D(final S source, final double distance, final Point2D position) {
     ...
     */
    public RangingReadingLocated2D(
            final S source, final double distance, final Point2D position, final int numAttemptedMeasurements,
     ...
     */
    public RangingReadingLocated2D(
            final S source, final double distance, final Point2D position, final Double distanceStandardDeviation) {
     ...
     */
    public RangingReadingLocated2D(
            final S source, final double distance, final Point2D position, final Matrix positionCovariance) {
     ...
     * Empty constructor.
     */
    protected RangingReadingLocated2D() {
        super();
    }
}
