...
public class RANSACRobustRssiPositionEstimator2D extends RobustRssiPositionEstimator2D {
     ...
     */
    public RANSACRobustRssiPositionEstimator2D(final List<? extends RadioSourceLocated<Point2D>> sources) {
        super();
        init();
     ...
     */
    public RANSACRobustRssiPositionEstimator2D(final RobustRssiPositionEstimatorListener<Point2D> listener) {
        super(listener);
        init();
    }
