...
/**
 * Linearly estimates 2D position using located radio sources and their ranging readings at
 * unknown locations.
 ...
 * locations are known.
 */
public class LinearRangingPositionEstimator2D extends LinearRangingPositionEstimator<Point2D> {

    /**
     * Constructor.
     */
    public LinearRangingPositionEstimator2D() {
        super();
        initialize();
    }
     ...
     *                                  minimum.
     */
    public LinearRangingPositionEstimator2D(final List<? extends RadioSourceLocated<Point2D>> sources) {
        super();
        initialize();
     ...
     */
    public LinearRangingPositionEstimator2D(final RangingPositionEstimatorListener<Point2D> listener) {
        super(listener);
        initialize();
    }
