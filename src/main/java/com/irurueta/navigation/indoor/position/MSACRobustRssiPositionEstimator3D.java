...
public class MSACRobustRssiPositionEstimator3D extends RobustRssiPositionEstimator3D {
     ...
     */
    public MSACRobustRssiPositionEstimator3D(final List<? extends RadioSourceLocated<Point3D>> sources) {
        super();
        init();
     ...
     */
    public MSACRobustRssiPositionEstimator3D(final RobustRssiPositionEstimatorListener<Point3D> listener) {
        super(listener);
        init();
    }
