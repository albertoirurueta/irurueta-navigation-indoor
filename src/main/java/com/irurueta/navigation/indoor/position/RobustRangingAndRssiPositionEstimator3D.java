...
public abstract class RobustRangingAndRssiPositionEstimator3D extends
     ...
     * Constructor.
     */
    protected RobustRangingAndRssiPositionEstimator3D() {
        super();
     ...
     */
    public static RobustRangingAndRssiPositionEstimator3D create(final RobustEstimatorMethod method) {
        return switch (method) {
            case RANSAC -> new RANSACRobustRangingAndRssiPositionEstimator3D();
            case LMEDS -> new LMedSRobustRangingAndRssiPositionEstimator3D();
            case MSAC -> new MSACRobustRangingAndRssiPositionEstimator3D();
            case PROSAC -> new PROSACRobustRangingAndRssiPositionEstimator3D();
            default -> new PROMedSRobustRangingAndRssiPositionEstimator3D();
        };
    }
    ...
    public static RobustRangingAndRssiPositionEstimator3D create(
        ...
        return switch (method) {
            case RANSAC -> new RANSACRobustRangingAndRssiPositionEstimator3D(sources);
            case LMEDS -> new LMedSRobustRangingAndRssiPositionEstimator3D(sources);
            case MSAC -> new MSACRobustRangingAndRssiPositionEstimator3D(sources);
            case PROSAC -> new PROSACRobustRangingAndRssiPositionEstimator3D(sources);
            default -> new PROMedSRobustRangingAndRssiPositionEstimator3D(sources);
        };
    }
    ...
    public static RobustRangingAndRssiPositionEstimator3D create(
        ...
        return switch (method) {
            case RANSAC -> new RANSACRobustRangingAndRssiPositionEstimator3D(fingerprint);
            case LMEDS -> new LMedSRobustRangingAndRssiPositionEstimator3D(fingerprint);
            case MSAC -> new MSACRobustRangingAndRssiPositionEstimator3D(fingerprint);
            case PROSAC -> new PROSACRobustRangingAndRssiPositionEstimator3D(fingerprint);
            default -> new PROMedSRobustRangingAndRssiPositionEstimator3D(fingerprint);
        };
    }
    ...
    public static RobustRangingAndRssiPositionEstimator3D create(
            ...
            final RobustEstimatorMethod method) {
        return switch (method) {
            case RANSAC -> new RANSACRobustRangingAndRssiPositionEstimator3D(sources, fingerprint);
            case LMEDS -> new LMedSRobustRangingAndRssiPositionEstimator3D(sources, fingerprint);
            case MSAC -> new MSACRobustRangingAndRssiPositionEstimator3D(sources, fingerprint);
            case PROSAC -> new PROSACRobustRangingAndRssiPositionEstimator3D(sources, fingerprint);
            default -> new PROMedSRobustRangingAndRssiPositionEstimator3D(sources, fingerprint);
        };
    }
     ...
     */
    public static RobustRangingAndRssiPositionEstimator3D create(
            final RobustRangingAndRssiPositionEstimatorListener<Point3D> listener, final RobustEstimatorMethod method) {
        return switch (method) {
            case RANSAC -> new RANSACRobustRangingAndRssiPositionEstimator3D(listener);
            case LMEDS -> new LMedSRobustRangingAndRssiPositionEstimator3D(listener);
            case MSAC -> new MSACRobustRangingAndRssiPositionEstimator3D(listener);
            case PROSAC -> new PROSACRobustRangingAndRssiPositionEstimator3D(listener);
            default -> new PROMedSRobustRangingAndRssiPositionEstimator3D(listener);
        };
    }
    ...
    public static RobustRangingAndRssiPositionEstimator3D create(
            ...
            final RobustRangingAndRssiPositionEstimatorListener<Point3D> listener, final RobustEstimatorMethod method) {
        return switch (method) {
            case RANSAC -> new RANSACRobustRangingAndRssiPositionEstimator3D(sources, listener);
            case LMEDS -> new LMedSRobustRangingAndRssiPositionEstimator3D(sources, listener);
            case MSAC -> new MSACRobustRangingAndRssiPositionEstimator3D(sources, listener);
            case PROSAC -> new PROSACRobustRangingAndRssiPositionEstimator3D(sources, listener);
            default -> new PROMedSRobustRangingAndRssiPositionEstimator3D(sources, listener);
        };
    }
    ...
    public static RobustRangingAndRssiPositionEstimator3D create(
            ...
            final RobustRangingAndRssiPositionEstimatorListener<Point3D> listener, final RobustEstimatorMethod method) {
        return switch (method) {
            case RANSAC -> new RANSACRobustRangingAndRssiPositionEstimator3D(fingerprint, listener);
            case LMEDS -> new LMedSRobustRangingAndRssiPositionEstimator3D(fingerprint, listener);
            case MSAC -> new MSACRobustRangingAndRssiPositionEstimator3D(fingerprint, listener);
            case PROSAC -> new PROSACRobustRangingAndRssiPositionEstimator3D(fingerprint, listener);
            default -> new PROMedSRobustRangingAndRssiPositionEstimator3D(fingerprint, listener);
        };
    }
    ...
    public static RobustRangingAndRssiPositionEstimator3D create(
            ...
            final RobustRangingAndRssiPositionEstimatorListener<Point3D> listener, final RobustEstimatorMethod method) {
        return switch (method) {
            case RANSAC -> new RANSACRobustRangingAndRssiPositionEstimator3D(sources, fingerprint, listener);
            case LMEDS -> new LMedSRobustRangingAndRssiPositionEstimator3D(sources, fingerprint, listener);
            case MSAC -> new MSACRobustRangingAndRssiPositionEstimator3D(sources, fingerprint, listener);
            case PROSAC -> new PROSACRobustRangingAndRssiPositionEstimator3D(sources, fingerprint, listener);
            default -> new PROMedSRobustRangingAndRssiPositionEstimator3D(sources, fingerprint, listener);
        };
    }
    ...
    public static RobustRangingAndRssiPositionEstimator3D create(
        ...
        return switch (method) {
            ...
            case LMEDS -> new LMedSRobustRangingAndRssiPositionEstimator3D();
            case MSAC -> new MSACRobustRangingAndRssiPositionEstimator3D();
            case PROSAC -> new PROSACRobustRangingAndRssiPositionEstimator3D(sourceQualityScores,
                    fingerprintReadingQualityScores);
            default -> new PROMedSRobustRangingAndRssiPositionEstimator3D(sourceQualityScores,
                    fingerprintReadingQualityScores);
        };
    }
