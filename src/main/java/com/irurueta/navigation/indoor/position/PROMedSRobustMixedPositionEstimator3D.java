 ...
 */
public class PROMedSRobustMixedPositionEstimator3D extends RobustMixedPositionEstimator3D {
     ...
     * Constructor.
     */
    public PROMedSRobustMixedPositionEstimator3D() {
        super();
        init();
    }
     ...
     */
    public PROMedSRobustMixedPositionEstimator3D(final List<? extends RadioSourceLocated<Point3D>> sources) {
        super();
        init();
     ...
     */
    public PROMedSRobustMixedPositionEstimator3D(final RobustMixedPositionEstimatorListener<Point3D> listener) {
        super(listener);
        init();
    }
