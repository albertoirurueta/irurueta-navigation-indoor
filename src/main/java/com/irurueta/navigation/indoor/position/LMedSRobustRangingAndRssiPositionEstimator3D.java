...
/**
 * Robustly estimates 3D position using located radio sources and their ranging+RSSI
 * readings at unknown locations and using LMedS algorithm to discard outliers.
 ...
 */
public class LMedSRobustRangingAndRssiPositionEstimator3D extends RobustRangingAndRssiPositionEstimator3D {

    /**
     * Constructor.
     */
    public LMedSRobustRangingAndRssiPositionEstimator3D() {
        super();
        init();
    }
    ...
    public double getStopThreshold() {
        return ((LMedSRobustLateration3DSolver) mLaterationSolver).
                getStopThreshold();
    }
    ...
    public void setStopThreshold(final double stopThreshold) throws LockedException {
        ((LMedSRobustLateration3DSolver) mLaterationSolver).
     ...
     */
    private void init() {
        mLaterationSolver = new LMedSRobustLateration3DSolver(
