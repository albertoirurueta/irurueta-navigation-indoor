...
/**
 * Linearly estimates position using located radio sources and their RSSI readings at
 * unknown locations.
 ...
 */
public abstract class LinearRssiPositionEstimator<P extends Point<P>> extends RssiPositionEstimator<P> {
     ...
     * Constructor.
     */
    protected LinearRssiPositionEstimator() {
        super();
        init();
    }
     ...
     */
    protected LinearRssiPositionEstimator(final RssiPositionEstimatorListener<P> listener) {
        super(listener);
        init();
    }
    ...
    private void init() {
        laterationSolverListener = new LaterationSolverListener<>() {
            ...
            public void onSolveStart(final LaterationSolver<P> solver) {
                if (listener != null) {
                    listener.onEstimateStart(LinearRssiPositionEstimator.this);
                }
            }
            ...
            public void onSolveEnd(final LaterationSolver<P> solver) {
                if (listener != null) {
                    listener.onEstimateEnd(LinearRssiPositionEstimator.this);
                }
            }
        };
    }
