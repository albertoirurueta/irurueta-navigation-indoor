...
public class PROMedSRobustRssiPositionEstimator3D extends RobustRssiPositionEstimator3D {
     ...
     */
    public PROMedSRobustRssiPositionEstimator3D(final List<? extends RadioSourceLocated<Point3D>> sources) {
        super();
        init();
     ...
     */
    public PROMedSRobustRssiPositionEstimator3D(final RobustRssiPositionEstimatorListener<Point3D> listener) {
        super(listener);
        init();
    }
