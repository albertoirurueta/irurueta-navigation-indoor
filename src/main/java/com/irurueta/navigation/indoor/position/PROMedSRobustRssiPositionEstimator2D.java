 ...
 */
public class PROMedSRobustRssiPositionEstimator2D extends RobustRssiPositionEstimator2D {
     ...
     * Constructor.
     */
    public PROMedSRobustRssiPositionEstimator2D() {
        super();
        init();
    }
     ...
     */
    public PROMedSRobustRssiPositionEstimator2D(final List<? extends RadioSourceLocated<Point2D>> sources) {
        super();
        init();
     ...
     */
    public PROMedSRobustRssiPositionEstimator2D(final RobustRssiPositionEstimatorListener<Point2D> listener) {
        super(listener);
        init();
    }
