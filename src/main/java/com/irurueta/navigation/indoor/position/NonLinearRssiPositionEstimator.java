...
/**
 * Estimates position non-linearly using located radio sources and their RSSI readings at
 * unknown locations.
...
public abstract class NonLinearRssiPositionEstimator<P extends Point<?>> extends
     ...
     */
    public NonLinearRssiPositionEstimator(final RssiPositionEstimatorListener<P> listener) {
        super(listener);
        init();
    }
     ...
     */
    public NonLinearRssiPositionEstimator(final P initialPosition) {
        this();
