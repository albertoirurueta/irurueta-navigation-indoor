...
/**
 * Estimates 2D position non-linearly using located radio sources and their ranging+RSSI
...
public class NonLinearRangingAndRssiPositionEstimator2D extends
     ...
     */
    public NonLinearRangingAndRssiPositionEstimator2D(final Point2D initialPosition) {
