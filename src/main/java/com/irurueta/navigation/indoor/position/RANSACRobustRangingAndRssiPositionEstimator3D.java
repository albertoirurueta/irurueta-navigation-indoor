 ...
 */
public class RANSACRobustRangingAndRssiPositionEstimator3D extends RobustRangingAndRssiPositionEstimator3D {
     ...
     */
    public RANSACRobustRangingAndRssiPositionEstimator3D(final List<? extends RadioSourceLocated<Point3D>> sources) {
        super();
        init();
