 ...
 */
public class RANSACRobustMixedPositionEstimator3D extends RobustMixedPositionEstimator3D {
     ...
     */
    public RANSACRobustMixedPositionEstimator3D(final List<? extends RadioSourceLocated<Point3D>> sources) {
        super();
        init();
     ...
     */
    public RANSACRobustMixedPositionEstimator3D(final RobustMixedPositionEstimatorListener<Point3D> listener) {
        super(listener);
        init();
    }
