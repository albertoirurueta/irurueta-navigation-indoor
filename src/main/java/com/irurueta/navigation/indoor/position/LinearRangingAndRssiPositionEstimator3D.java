...
/**
 * Linearly estimates 3D position using located radio sources and their RSSI+ranging
 ...
 * locations are known.
 */
public class LinearRangingAndRssiPositionEstimator3D extends LinearRangingAndRssiPositionEstimator<Point3D> {

    /**
     * Constructor.
     */
    public LinearRangingAndRssiPositionEstimator3D() {
        super();
        initialize();
    }
     ...
     *                                  minimum.
     */
    public LinearRangingAndRssiPositionEstimator3D(final List<? extends RadioSourceLocated<Point3D>> sources) {
        super();
        initialize();
     ...
     */
    public LinearRangingAndRssiPositionEstimator3D(final RangingAndRssiPositionEstimatorListener<Point3D> listener) {
        super(listener);
        initialize();
    }
