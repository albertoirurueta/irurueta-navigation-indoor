...
public abstract class RobustRssiPositionEstimator3D extends RobustRssiPositionEstimator<Point3D> {
     ...
     */
    protected RobustRssiPositionEstimator3D(final RobustRssiPositionEstimatorListener<Point3D> listener) {
        super(listener);
        preliminarySubsetSize = getMinRequiredSources();
    }
     ...
     */
    public static RobustRssiPositionEstimator3D create(final RobustEstimatorMethod method) {
        return switch (method) {
            case RANSAC -> new RANSACRobustRssiPositionEstimator3D();
            case LMEDS -> new LMedSRobustRssiPositionEstimator3D();
            case MSAC -> new MSACRobustRssiPositionEstimator3D();
            case PROSAC -> new PROSACRobustRssiPositionEstimator3D();
            default -> new PROMedSRobustRssiPositionEstimator3D();
        };
    }
    ...
    public static RobustRssiPositionEstimator3D create(
        ...
        return switch (method) {
            case RANSAC -> new RANSACRobustRssiPositionEstimator3D(sources);
            case LMEDS -> new LMedSRobustRssiPositionEstimator3D(sources);
            case MSAC -> new MSACRobustRssiPositionEstimator3D(sources);
            case PROSAC -> new PROSACRobustRssiPositionEstimator3D(sources);
            default -> new PROMedSRobustRssiPositionEstimator3D(sources);
        };
    }
    ...
    public static RobustRssiPositionEstimator3D create(
        ...
        return switch (method) {
            case RANSAC -> new RANSACRobustRssiPositionEstimator3D(fingerprint);
            case LMEDS -> new LMedSRobustRssiPositionEstimator3D(fingerprint);
            case MSAC -> new MSACRobustRssiPositionEstimator3D(fingerprint);
            case PROSAC -> new PROSACRobustRssiPositionEstimator3D(fingerprint);
            default -> new PROMedSRobustRssiPositionEstimator3D(fingerprint);
        };
    }
    ...
    public static RobustRssiPositionEstimator3D create(
            ...
            final RobustEstimatorMethod method) {
        return switch (method) {
            case RANSAC -> new RANSACRobustRssiPositionEstimator3D(sources, fingerprint);
            case LMEDS -> new LMedSRobustRssiPositionEstimator3D(sources, fingerprint);
            case MSAC -> new MSACRobustRssiPositionEstimator3D(sources, fingerprint);
            case PROSAC -> new PROSACRobustRssiPositionEstimator3D(sources, fingerprint);
            default -> new PROMedSRobustRssiPositionEstimator3D(sources, fingerprint);
        };
    }
     ...
     */
    public static RobustRssiPositionEstimator3D create(
            final RobustRssiPositionEstimatorListener<Point3D> listener, final RobustEstimatorMethod method) {
        return switch (method) {
            case RANSAC -> new RANSACRobustRssiPositionEstimator3D(listener);
            case LMEDS -> new LMedSRobustRssiPositionEstimator3D(listener);
            case MSAC -> new MSACRobustRssiPositionEstimator3D(listener);
            case PROSAC -> new PROSACRobustRssiPositionEstimator3D(listener);
            default -> new PROMedSRobustRssiPositionEstimator3D(listener);
        };
    }
    ...
    public static RobustRssiPositionEstimator3D create(
            ...
            final RobustRssiPositionEstimatorListener<Point3D> listener, final RobustEstimatorMethod method) {
        return switch (method) {
            case RANSAC -> new RANSACRobustRssiPositionEstimator3D(sources, listener);
            case LMEDS -> new LMedSRobustRssiPositionEstimator3D(sources, listener);
            case MSAC -> new MSACRobustRssiPositionEstimator3D(sources, listener);
            case PROSAC -> new PROSACRobustRssiPositionEstimator3D(sources, listener);
            default -> new PROMedSRobustRssiPositionEstimator3D(sources, listener);
        };
    }
    ...
    public static RobustRssiPositionEstimator3D create(
            ...
            final RobustRssiPositionEstimatorListener<Point3D> listener, final RobustEstimatorMethod method) {
        return switch (method) {
            case RANSAC -> new RANSACRobustRssiPositionEstimator3D(fingerprint, listener);
            case LMEDS -> new LMedSRobustRssiPositionEstimator3D(fingerprint, listener);
            case MSAC -> new MSACRobustRssiPositionEstimator3D(fingerprint, listener);
            case PROSAC -> new PROSACRobustRssiPositionEstimator3D(fingerprint, listener);
            default -> new PROMedSRobustRssiPositionEstimator3D(fingerprint, listener);
        };
    }
    ...
    public static RobustRssiPositionEstimator3D create(
            ...
            final RobustRssiPositionEstimatorListener<Point3D> listener, final RobustEstimatorMethod method) {
        return switch (method) {
            case RANSAC -> new RANSACRobustRssiPositionEstimator3D(sources, fingerprint, listener);
            case LMEDS -> new LMedSRobustRssiPositionEstimator3D(sources, fingerprint, listener);
            case MSAC -> new MSACRobustRssiPositionEstimator3D(sources, fingerprint, listener);
            case PROSAC -> new PROSACRobustRssiPositionEstimator3D(sources, fingerprint, listener);
            default -> new PROMedSRobustRssiPositionEstimator3D(sources, fingerprint, listener);
        };
    }
    ...
    public static RobustRssiPositionEstimator3D create(
        ...
        return switch (method) {
            ...
            case LMEDS -> new LMedSRobustRssiPositionEstimator3D();
            case MSAC -> new MSACRobustRssiPositionEstimator3D();
            case PROSAC -> new PROSACRobustRssiPositionEstimator3D(sourceQualityScores,
                    fingerprintReadingQualityScores);
            default -> new PROMedSRobustRssiPositionEstimator3D(sourceQualityScores, fingerprintReadingQualityScores);
        };
    }
    ...
    public static RobustRssiPositionEstimator3D create(
        ...
        return switch (method) {
            ...
            case LMEDS -> new LMedSRobustRssiPositionEstimator3D(sources);
            case MSAC -> new MSACRobustRssiPositionEstimator3D(sources);
            case PROSAC -> new PROSACRobustRssiPositionEstimator3D(sourceQualityScores, fingerprintReadingQualityScores,
                    sources);
            default -> new PROMedSRobustRssiPositionEstimator3D(sourceQualityScores, fingerprintReadingQualityScores,
                    sources);
        };
     ...
     *                                  provided sources is less than the required minimum.
     */
    public static RobustRssiPositionEstimator3D create(final List<? extends RadioSourceLocated<Point3D>> sources) {
     ...
     * @return a robust 3D position estimator.
     */
    public static RobustRssiPositionEstimator3D create(final RobustRssiPositionEstimatorListener<Point3D> listener) {
