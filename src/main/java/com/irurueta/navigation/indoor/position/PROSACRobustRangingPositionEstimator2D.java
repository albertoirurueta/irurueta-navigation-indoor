...
public class PROSACRobustRangingPositionEstimator2D extends RobustRangingPositionEstimator2D {
     ...
     */
    public PROSACRobustRangingPositionEstimator2D(final List<? extends RadioSourceLocated<Point2D>> sources) {
        super();
        init();
     ...
     */
    public PROSACRobustRangingPositionEstimator2D(final RobustRangingPositionEstimatorListener<Point2D> listener) {
        super(listener);
        init();
    }
