...
public class NonLinearMixedPositionEstimator2D extends NonLinearMixedPositionEstimator<Point2D> {
     ...
     *                                  minimum.
     */
    public NonLinearMixedPositionEstimator2D(final List<? extends RadioSourceLocated<Point2D>> sources) {
        super();
        initialize();
     ...
     */
    public NonLinearMixedPositionEstimator2D(final MixedPositionEstimatorListener<Point2D> listener) {
        super(listener);
        initialize();
    }
