...
/**
 * Estimated position using located radio sources and ranging readings at an unknown
...
public abstract class RangingPositionEstimator<P extends Point<?>> extends PositionEstimator<P,
        RangingReading<? extends RadioSource>, RangingPositionEstimatorListener<P>> {
     ...
     */
    protected RangingPositionEstimator(final RangingPositionEstimatorListener<P> listener) {
        super(listener);
    }
}
