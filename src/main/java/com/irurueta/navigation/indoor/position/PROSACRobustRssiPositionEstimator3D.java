...
public class PROSACRobustRssiPositionEstimator3D extends RobustRssiPositionEstimator3D {
     ...
     */
    public PROSACRobustRssiPositionEstimator3D(final List<? extends RadioSourceLocated<Point3D>> sources) {
        super();
        init();
     ...
     */
    public PROSACRobustRssiPositionEstimator3D(final RobustRssiPositionEstimatorListener<Point3D> listener) {
        super(listener);
        init();
    }
