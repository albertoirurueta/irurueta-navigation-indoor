...
/**
 * Estimates 3D position non-linearly using located radio sources and their readings
 ...
 * are known.
 */
public class NonLinearMixedPositionEstimator3D extends NonLinearMixedPositionEstimator<Point3D> {

    /**
     * Constructor.
     */
    public NonLinearMixedPositionEstimator3D() {
        super();
        initialize();
    }
     ...
     *                                  minimum.
     */
    public NonLinearMixedPositionEstimator3D(final List<? extends RadioSourceLocated<Point3D>> sources) {
        super();
        initialize();
     ...
     */
    public NonLinearMixedPositionEstimator3D(final MixedPositionEstimatorListener<Point3D> listener) {
        super(listener);
        initialize();
    }
     ...
     */
    public NonLinearMixedPositionEstimator3D(final Point3D initialPosition) {
     ...
     */
    public NonLinearMixedPositionEstimator3D(
            final Point3D initialPosition, final MixedPositionEstimatorListener<Point3D> listener) {
