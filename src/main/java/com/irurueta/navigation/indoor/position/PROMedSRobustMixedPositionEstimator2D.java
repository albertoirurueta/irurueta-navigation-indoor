...
public class PROMedSRobustMixedPositionEstimator2D extends RobustMixedPositionEstimator2D {
     ...
     */
    public PROMedSRobustMixedPositionEstimator2D(final List<? extends RadioSourceLocated<Point2D>> sources) {
        super();
        init();
     ...
     */
    public PROMedSRobustMixedPositionEstimator2D(final RobustMixedPositionEstimatorListener<Point2D> listener) {
        super(listener);
        init();
    }
