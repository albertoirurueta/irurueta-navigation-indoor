...
/**
 * Estimates 2D position non-linearly using located radio sources and their RSSI readings at
 * unknown locations.
 ...
 * are known.
 */
public class NonLinearRssiPositionEstimator2D extends NonLinearRssiPositionEstimator<Point2D> {

    /**
     * Constructor.
     */
    public NonLinearRssiPositionEstimator2D() {
        super();
        initialize();
    }
     ...
     *                                  minimum.
     */
    public NonLinearRssiPositionEstimator2D(final List<? extends RadioSourceLocated<Point2D>> sources) {
        super();
        initialize();
     ...
     */
    public NonLinearRssiPositionEstimator2D(final RssiPositionEstimatorListener<Point2D> listener) {
        super(listener);
        initialize();
    }
     ...
     */
    public NonLinearRssiPositionEstimator2D(final Point2D initialPosition) {
     ...
     */
    public NonLinearRssiPositionEstimator2D(
            final Point2D initialPosition, final RssiPositionEstimatorListener<Point2D> listener) {
